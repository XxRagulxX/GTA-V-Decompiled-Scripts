	...
	if (Global_114931.f_14148[iLocal_56 /*104*/].f_24 == 1)
	{
		if (Global_21605 == 0)
		{
			if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, Global_21598))
			{
				...
				{
					Global_114931.f_14148[iLocal_56 /*104*/].f_99[0] = 0;
					Global_114931.f_14148[iLocal_56 /*104*/].f_99[1] = 0;
					Global_114931.f_14148[iLocal_56 /*104*/].f_99[2] = 0;
				}
				else
				{
					Global_114931.f_14148[iLocal_56 /*104*/].f_99[Global_21627] = 0;
				}
	...
	for (i = 0; i < 34; i = i + 1)
	{
		...
		while (num < 35)
		{
			...
			if (unk[num] == 0)
			{
				...
				{
					if (Global_114931.f_14148[num /*104*/].f_99[Global_21627] == 1)
					{
		...
		{
			if (Global_114931.f_14148[num2 /*104*/].f_99[Global_21627] == 1)
			{
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_21608, "SET_DATA_SLOT");
		...
		if (Global_114931.f_14148[i /*104*/].f_24 != 0)
			if (Global_114931.f_14148[i /*104*/].f_99[Global_21627] == 1)
