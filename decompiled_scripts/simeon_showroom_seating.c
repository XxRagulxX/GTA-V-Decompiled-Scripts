...
BOOL func_5(int iParam0) // Position - 0x5F1 (1521)
{
...
BOOL func_37(BOOL bParam0) // Position - 0x1566 (5478)
{
...
BOOL func_38(Ped pedParam0) // Position - 0x1651 (5713)
{
	int weaponHash;
...
BOOL func_39() // Position - 0x16AE (5806)
{
...
BOOL func_40() // Position - 0x16D0 (5840)
{
...
BOOL func_41(var uParam0) // Position - 0x16EA (5866)
{
	return func_61(&(uParam0->f_7), 9);
}

void func_42(var uParam0) // Position - 0x16FC (5884)
{
	var animDict;
	var animnName;
...
void func_43(var uParam0) // Position - 0x17AF (6063)
{
	var animDict;
...
BOOL func_44() // Position - 0x1819 (6169)
{
	return IS_BIT_SET(Global_1951218.f_3, 25);
}

BOOL func_45(float fParam0, float fParam1, float fParam2) // Position - 0x182A (6186)
{
	float num;
	float num2;
...
void func_46(var uParam0) // Position - 0x18B0 (6320)
{
	int weaponHash;
...
void func_47() // Position - 0x1944 (6468)
{
	Global_24447.f_6 = 1;
	return;
}

void func_48(BOOL bParam0) // Position - 0x1952 (6482)
{
	if (bParam0)
		if (func_49())
...
BOOL func_49() // Position - 0x1977 (6519)
{
	return IS_BIT_SET(Global_2685155.f_2, 11);
}

void func_50() // Position - 0x1988 (6536)
{
	MISC::SET_BIT(&Global_9503, 4);
	return;
}

void func_51(int iParam0) // Position - 0x1998 (6552)
{
	if (func_57())
		return;
...
void func_52(int iParam0) // Position - 0x19CB (6603)
{
	if (func_57())
		return;
...
BOOL func_53() // Position - 0x1A55 (6741)
{
...
void func_54(BOOL bParam0, BOOL bParam1) // Position - 0x1A7C (6780)
{
	if (bParam0)
	{
		if (func_56(0))
...
BOOL func_55() // Position - 0x1AF0 (6896)
{
	return IS_BIT_SET(Global_1965230, 5);
}

BOOL func_56(int iParam0) // Position - 0x1AFE (6910)
{
	if (iParam0 == 1)
...
BOOL func_57() // Position - 0x1B55 (6997)
{
	return IS_BIT_SET(Global_1965230, 19);
}

Vector3 func_58(var uParam0) // Position - 0x1B64 (7012)
{
	var unk;
...
Vector3 func_59(var uParam0) // Position - 0x1BAE (7086)
{
	return uParam0->f_16[uParam0->f_9 /*14*/];
}

void func_60(int* piParam0, int iParam1) // Position - 0x1BC2 (7106)
{
	MISC::SET_BIT(piParam0, iParam1);
	return;
}

BOOL func_61(var uParam0, int iParam1) // Position - 0x1BD2 (7122)
{
	return IS_BIT_SET(*uParam0, iParam1);
}

void func_62(var uParam0, char* sParam1) // Position - 0x1BE0 (7136)
{
	if (uParam0->f_1.f_1 == 2)
	{
		if (func_32())
...
void func_63(var uParam0, char* sParam1) // Position - 0x1F12 (7954)
{
...
void func_64(int iParam0) // Position - 0x21D2 (8658)
{
	int i;
...
int func_65() // Position - 0x2235 (8757)
{
	int num;
...
void func_66(var uParam0) // Position - 0x2242 (8770)
{
...
int func_67(var uParam0) // Position - 0x227A (8826)
{
	int randomIntInRange;
...
int func_68(int iParam0) // Position - 0x2312 (8978)
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_69(int iParam0) // Position - 0x2354 (9044)
{
	switch (iParam0)
	{
		case 2:
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x2392 (9106)
{
	int i;
...
BOOL func_71(int iParam0) // Position - 0x24BD (9405)
{
	if (iParam0 != 5)
		return false;
...
BOOL func_72(Player plParam0) // Position - 0x24D6 (9430)
{
	return func_73(plParam0) == joaat("WEAPON_MINIGUN");
}

int func_73(Player plParam0) // Position - 0x24EA (9450)
{
	return Global_1893070[plParam0 /*615*/].f_592;
}

BOOL func_74(var uParam0) // Position - 0x24FE (9470)
{
	*uParam0(!func_61(&(uParam0->f_7), 5), &uParam0->f_16[uParam0->f_9 /*14*/], uParam0->f_9);
	return StackVal || StackVal;
}

BOOL func_75(var uParam0) // Position - 0x2528 (9512)
{
	var sizeAndPeds;
	int i;
...
BOOL func_76(var uParam0) // Position - 0x259F (9631)
{
	int i;
	Player playerIndex;
...
int func_77(Player plParam0) // Position - 0x2619 (9753)
{
...
Player _INVALID_PLAYER_INDEX() // Position - 0x263A (9786)
{
	return -1;
}

BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x2643 (9795)
{
	Player player;
...
BOOL func_80(var uParam0) // Position - 0x26A3 (9891)
{
	return uParam0->f_7 & 31 > 0;
}

BOOL func_81(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x26B4 (9908)
{
...
BOOL func_82(Ped pedParam0, var uParam1) // Position - 0x2714 (10004)
{
	return ENTITY::IS_ENTITY_IN_ANGLED_AREA(pedParam0, uParam1->f_6.f_1, uParam1->f_6.f_4, uParam1->f_6, false, true, 0);
}

BOOL func_83(var uParam0) // Position - 0x2739 (10041)
{
	int i;
...
void func_84(var uParam0, int iParam1) // Position - 0x27A4 (10148)
{
	uParam0->f_13 = iParam1;
	return;
}

void func_85(int* piParam0, int iParam1) // Position - 0x27B2 (10162)
{
	MISC::CLEAR_BIT(piParam0, iParam1);
	return;
}

void func_86(var uParam0) // Position - 0x27C2 (10178)
{
	if (uParam0->f_13 == 6)
	{
	}
...
float func_87() // Position - 0x2815 (10261)
{
	return 0.13f;
}

void func_88(var uParam0) // Position - 0x2822 (10274)
{
...
void func_89(int* piParam0, int iParam1, BOOL bParam2) // Position - 0x287A (10362)
{
	int offset;
...
BOOL func_91() // Position - 0x28AA (10410)
{
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x28F2 (10482)
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x2976 (10614)
{
	switch (func_95())
	{
		case 0:
...
Hash func_94() // Position - 0x29A9 (10665)
{
...
int func_95() // Position - 0x29CD (10701)
{
	return Global_33832;
}
...
BOOL func_100(Player plParam0) // Position - 0x2A19 (10777)
{
...
BOOL func_101(Player plParam0) // Position - 0x2A52 (10834)
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
BOOL func_102(Player plParam0) // Position - 0x2A83 (10883)
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
BOOL func_103(Player plParam0) // Position - 0x2AB4 (10932)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_104() // Position - 0x2ADA (10970)
{
...
void func_105() // Position - 0x2B12 (11026)
{
	func_106(0, &uLocal_147, 0, 3);
	func_106(1, &uLocal_147, 1, 3);
	func_106(2, &uLocal_147, 2, 3);
	func_106(3, &uLocal_147, 3, 2);
	func_106(4, &uLocal_147, 4, 2);
	func_106(5, &uLocal_147, 5, 2);
	return;
}

void func_106(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2B50 (11088)
{
	var unk;
	float num;
...
Vector3 func_107() // Position - 0x2BE1 (11233)
{
	return 0.45f, -0.5f, 2f;
}

Vector3 func_108(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x2BF4 (11252)
{
	float num;
	float num2;
	float num3;
...
float func_109(int iParam0, float fParam1) // Position - 0x2C38 (11320)
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_110() // Position - 0x2C77 (11383)
{
	return -0.45f, -0.5f, 0f;
}

void func_111(int iParam0, var uParam1, var uParam2) // Position - 0x2C8A (11402)
{
	switch (iParam0)
	{
		case 0:
...
void func_112() // Position - 0x2D71 (11633)
{
	return;
}

int func_113(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2D79 (11641)
{
	int i;
