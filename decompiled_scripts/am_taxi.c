...
void func_91(const char* sParam0) // Position - 0x3806 (14342)
{
...
int func_145(var uParam0) // Position - 0x5371 (21361)
{
	int i;
	int num;
	int num2;
	...
	for (i = 0; i < 65; i = i + 1)
	{
		...
		if (Global_34172[num2 /*23*/].f_19 == uParam0)
			return num;
	}
...
void func_185(var uParam0) // Position - 0x7C8E (31886)
{
	uParam0->f_65 = 0;
...
void func_301(eCharacter echParam0, char* sParam1, BOOL bParam2, var uParam3) // Position - 0x1006D (65645)
{
	eCharacter character;
...
var func_302(Player plParam0) // Position - 0x10108 (65800)
{
...
void func_304(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, const char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11) // Position - 0x10697 (67223)
{
...
void func_330(int iParam0, char* sParam1, BOOL bParam2, var uParam3) // Position - 0x11657 (71255)
{
	int num;
...
int func_359() // Position - 0x11FC2 (73666)
{
...
var func_378() // Position - 0x12CDA (77018)
{
...
void func_495(var uParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, var uParam5) // Position - 0x1726C (94828)
{
	Hash eventData;

	*uParam5 = func_497(&uParam0, &uParam3, &hParam4);
	eventData = 323285304;
	eventData.f_1 = PLAYER::PLAYER_ID();
...
void func_498(var uParam0, int iParam1, var uParam2) // Position - 0x17372 (95090)
{
	int i;
	...
	for (i = 0; func_499(uParam0, iParam1, uParam2) == 0 && i < 6; i = i + 1)
	{
	}
...
int func_499(var uParam0, int iParam1, var uParam2) // Position - 0x173E1 (95201)
{
	int num;
	float outPosition;
	float outPosition2;
	...
	while (true)
	{
		...
		else
		{
			...
			{
				func_500(&Global_1574205, uParam0, iParam1, *uParam0);
...
void func_500(var uParam0, var uParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x17E0F (97807)
{
	float num;
	float num2;
	int i;
...
void func_532(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, BOOL bParam6, float fParam7) // Position - 0x196D8 (104152)
{
	Vector3 vector;
	var unk3;
...
BOOL func_534(var uParam0, BOOL bParam1) // Position - 0x197B9 (104377)
{
	BOOL flag;
	...
	if (Global_2635562.f_26.f_18)
	{
		...
		{
			case 0:
				if (func_518(*uParam0, Global_2635562.f_26.f_10, Global_2635562.f_26.f_16, false, false))
					flag = true;
				break;
		
			case 1:
				if (func_516(*uParam0, Global_2635562.f_26.f_10, Global_2635562.f_26.f_13, false, false))
					flag = true;
				break;
		...
		if (flag)
			if (bParam1)
				*uParam0 = { func_535(*uParam0, Global_2635562.f_26.f_10, Global_2635562.f_26.f_13, Global_2635562.f_26.f_16, Global_2635562.f_26.f_17, 1036831949, false) };
	}
...
BOOL func_539(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, BOOL bParam6, BOOL bParam7) // Position - 0x19DB5 (105909)
{
	int i;
	BOOL flag;
	...
	if (bParam7)
		if (func_493(*uParam3, 1056964608))
			return true;
...
BOOL func_540(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x19E71 (106097)
{
	int num;
	var unk;
	var unk2;
...
BOOL func_542(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x19FFF (106495)
{
	int i;
	var unk;
	...
	for (i = 0; i < 14; i = i + 1)
	{
		if (Global_2640831[i /*17*/].f_9 == 1)
		{
			...
			{
				if (func_529(*uParam0, &Global_2640831[i /*17*/], 1008981770, bParam4, false))
				{
					if (bParam1)
					{
...
int func_543(var uParam0, int iParam1, var uParam2) // Position - 0x1A0DA (106714)
{
	int randomIntInRange;
	int i;
	int num;
...
void func_592(int iParam0) // Position - 0x237CF (145359)
{
	switch (iParam0)
	{
		case 78:
