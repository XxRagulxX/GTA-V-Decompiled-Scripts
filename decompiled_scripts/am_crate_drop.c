...
BOOL func_31(int iParam0) // Position - 0x125D (4701)
{
...
{
	if (func_124(plParam0, true) || func_123(plParam0) || func_103(plParam0, false) || func_122(plParam0) || func_31(0))
		return 1;
	...
	if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(iLocal_121.f_2.f_68[iParam0 /*104*/].f_5[iParam1 /*18*/]))
	{
		if (!IS_BIT_SET(uLocal_480[iParam0], 0 + iParam1))
		{
			if (ENTITY::IS_ENTITY_DEAD(NETWORK::NET_TO_PED(iLocal_121.f_2.f_68[iParam0 /*104*/].f_5[iParam1 /*18*/]), false))
			{
				...
				{
					func_132(0, NETWORK::NET_TO_PED(iLocal_121.f_2.f_68[iParam0 /*104*/].f_5[iParam1 /*18*/]), "XPT_KAIE" /*~g~+~1~ ~a~:~s~ Killed Hostile*/, joaat("XPTYPE_ACTION"), joaat("XPCATEGORY_ACTION_KILLS"), BUILTIN::ROUND(50f * Global_262145.f_3926), 1, -1, 0, false, 0);
...
void func_192(int iParam0) // Position - 0x97A6 (38822)
{
	...
	else
	{
		...
		HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_444[iParam0], "ACD_BLIPR" /*Crate Drop Zone*/);
...
BOOL func_197() // Position - 0x98D3 (39123)
{
	...
	if (IS_BIT_SET(Global_1882797[num /*321*/].f_17, 0) && Global_1882797[num /*321*/].f_27 == 2)
		return true;
...
void func_206(int iParam0) // Position - 0xA47D (42109)
{
	...
	else
	{
		...
		HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_442[iParam0], "ACD_BLIPN" /*Crate*/);
...
void func_213(int iParam0) // Position - 0xA96B (43371)
{
	...
	switch (iLocal_121.f_2.f_1[iParam0 /*66*/].f_30)
	{
		...
		case 8:
			...
			{
				case 0:
					func_226("ACD_TCONT_CXWA" /*Crate Contents:~n~ + $~1~~n~ + ~1~RP~n~ + ~a~~n~ + Body Armor*/, func_296(iLocal_121.f_2.f_1[iParam0 /*66*/].f_33, false), amount, num);
					break;
			
				case 1:
					func_221("ACD_TCONT_CXWAC" /*Crate Contents:~n~ + $~1~~n~ + ~1~RP~n~ + ~a~~n~ + Body Armor~n~ + ~a~*/, func_296(iLocal_121.f_2.f_1[iParam0 /*66*/].f_33, false), &unk5, amount, num);
					break;
...
void func_314(var uParam0) // Position - 0x34748 (214856)
{
	uParam0->f_65 = 0;
	...
	*uParam0 = 0;
	...
	uParam0->f_12 = 0;
	uParam0->f_2 = 0;
	func_315(&(uParam0->f_13));
	func_315(&(uParam0->f_13.f_13));
...
var func_368() // Position - 0x35A6E (219758)
{
	return Global_2685155.f_19;
}

var func_369() // Position - 0x35A7C (219772)
{
