...
void func_21() // Position - 0x712 (1810)
{
	switch (iLocal_60)
	{
		case 0:
			func_62();
			func_61(&uLocal_61, 1, joaat("prop_ld_scrap"), "LETTERS_COLLECT" /*~1~/50 letter scraps collected.*/);
			func_59(&uLocal_61, joaat("NUM_HIDDEN_PACKAGES_0"), 705, 50);
			iLocal_60 = 1;
			bLocal_638 = true;
			break;
...
BOOL func_23(var uParam0, var uParam1) // Position - 0x7DA (2010)
{
	...
	if (uParam0->f_11)
		if (!Global_80623)
			func_24(&(uParam0->f_11), &(uParam0->f_12), &(uParam0->f_9), 1, &iLocal_627, &uLocal_628, "LETTERS_TITLE" /*Scrap Collected~s~*/, "LETTERS_COLLECT" /*~1~/50 letter scraps collected.*/);
