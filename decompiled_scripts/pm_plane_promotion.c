...
void func_1() // Position - 0xC8 (200)
{
	...
	switch (iLocal_64)
	{
		case 0:
			...
			{
				veLocal_258 = Global_113695.f_222[0];
...
void func_25(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE50 (3664)
{
...
void func_82(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5) // Position - 0x3B99 (15257)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_105547.f_4))
	{
		...
		{
			if (func_136(24) != Global_105547.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_133(ENTITY::GET_ENTITY_COORDS(Global_105547.f_4, true), iParam5, &unk, &num))
					{
						fParam0 = { unk };
						fParam3 = num;
					}
				...
				func_83(Global_105547.f_4, fParam0, fParam3, 24, false);
			}
		}
	}
...
void func_84(int iParam0, Vehicle veParam1, int iParam2) // Position - 0x3D3D (15677)
{
	...
	if (!func_116(&Global_79152.f_555[0 /*21*/], iParam0))
		return;
...
void func_85(Vehicle veParam0, int iParam1) // Position - 0x3E54 (15956)
{
	Ped pedInVehicleSeat;
	int i;
	int j;
	...
	func_127(veParam0, &(Global_114990.f_32759.f_5510));
	return;
}

BOOL func_86(Vehicle veParam0) // Position - 0x4058 (16472)
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false) || func_103(veParam0, 0, false) || func_103(veParam0, 1, false) || func_103(veParam0, 2, false) || func_125(veParam0) != 145 || func_102(veParam0) || func_101(veParam0) || func_100(veParam0) || func_99(veParam0) || !func_87(ENTITY::GET_ENTITY_MODEL(veParam0)))
	{
		func_101(veParam0);
		func_101(veParam0);
...
BOOL func_92() // Position - 0x4710 (18192)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_93() // Position - 0x4726 (18214)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_94() // Position - 0x473C (18236)
{
	return false;
}

BOOL func_95() // Position - 0x4745 (18245)
{
	return true;
}

BOOL func_96() // Position - 0x474E (18254)
{
	return true;
}

BOOL func_97() // Position - 0x4757 (18263)
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x4770 (18288)
{
	int profileSetting;
...
BOOL func_99(Vehicle veParam0) // Position - 0x4828 (18472)
{
	Hash entityModel;
...
BOOL func_100(Vehicle veParam0) // Position - 0x486F (18543)
{
	int i;
...
BOOL func_101(Vehicle veParam0) // Position - 0x48AA (18602)
{
	int i;
...
BOOL func_102(Vehicle veParam0) // Position - 0x4926 (18726)
{
	int i;
...
BOOL func_103(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0x4A0E (18958)
{
	int i;
	var garageName;
	int num;
...
BOOL func_104(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x4A7C (19068)
{
...
var func_105() // Position - 0x4B54 (19284)
{
	var unk;
...
void func_106(var uParam0, int iParam1) // Position - 0x4B9A (19354)
{
	if (iParam1 <= 0)
		return;
...
void func_107(var uParam0, int iParam1) // Position - 0x4C20 (19488)
{
...
void func_108(var uParam0, int iParam1) // Position - 0x4C53 (19539)
{
	int num;
	int num2;
...
int func_109(int iParam0, int iParam1) // Position - 0x4CA4 (19620)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_110(int iParam0) // Position - 0x4D46 (19782)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_111(BOOL bParam0, var uParam1, var uParam2) // Position - 0x4D68 (19816)
{
	if (bParam0)
		return uParam1;
...
int func_112(int iParam0) // Position - 0x4D7F (19839)
{
	return iParam0 & 15;
}

void func_113(var uParam0, int iParam1) // Position - 0x4D8C (19852)
{
...
void func_114(var uParam0, int iParam1) // Position - 0x4DC6 (19910)
{
...
void func_115(var uParam0, int iParam1) // Position - 0x4E01 (19969)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_116(var uParam0, int iParam1) // Position - 0x4E3D (20029)
{
	BOOL num;
	int num2;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_126(Global_114990.f_32759.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, false))
	...
	{
		if (!func_126(Global_114990.f_2370.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
	...
	{
		if (!func_126(Global_114990.f_2370.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
...
int func_117(int iParam0, int iParam1) // Position - 0x652B (25899)
{
	int num;
...
void func_118(int iParam0, var uParam1, int iParam2) // Position - 0x656D (25965)
{
	int num;
...
void func_119(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6) // Position - 0x67C9 (26569)
{
	if (func_116(&Global_79152.f_555[0 /*21*/], iParam0))
	{
		...
		{
			func_124(iParam0);
			func_123(uParam1, &Global_114990.f_32759.f_69[Global_79152.f_555[0 /*21*/].f_14 /*78*/]);
...
void func_120(int iParam0, BOOL bParam1) // Position - 0x68C2 (26818)
{
	if (iParam0 == -1)
		return;
...
void func_121(int iParam0, int iParam1, BOOL bParam2) // Position - 0x691F (26911)
{
	if (iParam0 == -1)
		return;
...
BOOL func_122(int iParam0, int iParam1) // Position - 0x695A (26970)
{
	if (iParam0 == -1)
		return false;
...
void func_123(var uParam0, var uParam1) // Position - 0x697A (27002)
{
...
void func_124(int iParam0) // Position - 0x6A46 (27206)
{
	if (iParam0 == -1)
		return;
...
int func_125(Vehicle veParam0) // Position - 0x6ABD (27325)
{
	int i;
...
BOOL func_126(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6B20 (27424)
{
	if (bParam6)
...
void func_127(Vehicle veParam0, var uParam1) // Position - 0x6B67 (27495)
{
	int i;
...
int func_128(int iParam0) // Position - 0x6E12 (28178)
{
	switch (iParam0)
	{
		case 1:
...
int func_129(var uParam0, var uParam1, var uParam2) // Position - 0x6EC2 (28354)
{
	int i;
	int modType;
...
BOOL func_130(int iParam0) // Position - 0x70B5 (28853)
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_131(var uParam0) // Position - 0x70D5 (28885)
{
	int i;
...
void func_132(int iParam0) // Position - 0x7185 (29061)
{
...
BOOL func_133(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5) // Position - 0x71AC (29100)
{
	int num;
...
int func_134(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x72C2 (29378)
{
	int i;
...
BOOL func_135(int iParam0) // Position - 0x7351 (29521)
{
	return IS_BIT_SET(Global_114990.f_7236[iParam0], 0);
}

Vehicle func_136(int iParam0) // Position - 0x7366 (29542)
{
	if (iParam0 == -1)
		return 0;
...
void func_137(Blip* pblParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7382 (29570)
{
	int i;
...
void func_138(int iParam0, Blip* pblParam1) // Position - 0x752D (29997)
{
	switch (iParam0)
	{
		case 0:
...
void func_139(Blip* pblParam0) // Position - 0x7575 (30069)
{
	if (HUD::DOES_BLIP_EXIST(pblParam0->f_5))
		HUD::REMOVE_BLIP(&(pblParam0->f_5));
...
float func_140(float fParam0, float fParam1, float fParam2) // Position - 0x7590 (30096)
{
	if (fParam0 > fParam2)
		return fParam2;
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x75B7 (30135)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

float func_142(Ped pedParam0, Vehicle veParam1, BOOL bParam2) // Position - 0x75CA (30154)
{
	Vector3 entityCoords;
...
Blip func_143(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7628 (30248)
{
	return func_35(veParam0, !bParam1, bParam2);
}

void _SHOW_SUBTITLE_CLEAR_EXISTING(char* sParam0, int iParam1, int iParam2) // Position - 0x763B (30267)
{
	iParam2 = iParam2;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
void func_145() // Position - 0x7654 (30292)
{
	func_153(2);
	func_152();
	return;
...
BOOL func_146() // Position - 0x7665 (30309)
{
...
void func_147() // Position - 0x7687 (30343)
{
	int i;
	float groundZ;
...
int func_148() // Position - 0x78B6 (30902)
{
	return Global_113695.f_20;
}

BOOL func_149(float fParam0, var uParam1, var uParam2) // Position - 0x78C4 (30916)
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x78EE (30958)
{
...
void func_151(int iParam0, int iParam1) // Position - 0x7989 (31113)
{
...
void func_152() // Position - 0x79B0 (31152)
{
	if (ENTITY::DOES_ENTITY_EXIST(veLocal_258))
...
void func_153(int iParam0) // Position - 0x7A43 (31299)
{
