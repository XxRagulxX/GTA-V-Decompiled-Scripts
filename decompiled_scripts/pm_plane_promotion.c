...
void func_25(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE37 (3639)
{
...
void func_85(Vehicle veParam0, int iParam1) // Position - 0x3E3B (15931)
{
	Ped pedInVehicleSeat;
	int i;
	int j;
...
void func_119(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6) // Position - 0x67E4 (26596)
{
	if (func_116(&Global_79095.f_555[0 /*21*/], iParam0))
	{
...
int func_125(Vehicle veParam0) // Position - 0x6AD8 (27352)
{
	int i;
...
int func_134(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x72DD (29405)
{
	int i;
...
void func_151(int iParam0, int iParam1) // Position - 0x798D (31117)
{
