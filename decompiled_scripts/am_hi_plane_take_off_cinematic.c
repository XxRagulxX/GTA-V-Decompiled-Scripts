...
BOOL func_18(int iParam0) // Position - 0xAF6 (2806)
{
...
int func_34() // Position - 0xE24 (3620)
{
...
void func_307() // Position - 0x367FF (223231)
{
	...
	if (randomIntInRange < 50)
		func_308(&uLocal_131, 4105.583f, -4644.602f, 4.1196f, 11.1032f, -0.012f, 107.968f, "HS4_ISD_TAKE_NIMB2", 0, 1, 1, 0);
	else
		func_308(&uLocal_131, 4105.583f, -4644.602f, 4.1196f, 11.1032f, -0.012f, 107.968f, "HS4_ISD_TAKE_NIMB2", 0, 1, 2, 0);

	return;
}

void func_308(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x36897 (223383)
{
...
void func_309(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4) // Position - 0x368C7 (223431)
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_310(var uParam0, int iParam1, char* sParam2) // Position - 0x368F4 (223476)
{
