...
void func_26(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xADC (2780)
{
...
int func_40(int iParam0, Entity eParam1) // Position - 0x1DDE (7646)
{
	Vector3 entityCoords;
	float num;
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (eParam1 == func_41(Global_102232) && eParam1 != 0)
		{
			Global_102232 = 0;
		}
	}
...
Entity func_41(var uParam0) // Position - 0x1EC2 (7874)
{
	return uParam0;
}
...
char* func_58(int iParam0) // Position - 0x91C2 (37314)
{
	switch (iParam0)
	{
