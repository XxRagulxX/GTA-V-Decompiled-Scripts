...
int func_40(int iParam0, Entity eParam1) // Position - 0x1D9A (7578)
{
	Vector3 entityCoords;
	float num;
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (eParam1 == func_41(Global_102175) && eParam1 != 0)
		{
			Global_102175 = 0;
		}
	}
...
Entity func_41(var uParam0) // Position - 0x1E7E (7806)
{
	return uParam0;
}
