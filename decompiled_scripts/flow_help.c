...
void main() // Position - 0x0
{
	...
	while (true)
	{
		if (Global_113810.f_20413.f_145 > 0 || Global_112449)
		{
				...
				if (!Global_112448)
				{
					if (Global_113810.f_20413.f_145 > 0)
					{
						if (func_20(&Global_113810.f_20413[iLocal_35 /*16*/]))
						{
							...
							{
								if (IS_BIT_SET(Global_113810.f_20413[iLocal_35 /*16*/].f_11, _GET_CURRENT_PLAYER_CHARACTER()))
								{
									if (Global_113810.f_20413[iLocal_35 /*16*/].f_12 == Global_113810.f_20413.f_146[_GET_CURRENT_PLAYER_CHARACTER()])
									{
			...
			if (!MISC::ARE_STRINGS_EQUAL(&Global_113810.f_20413[iLocal_35 /*16*/], &uLocal_18) && !MISC::ARE_STRINGS_EQUAL(&Global_113810.f_20413[iLocal_35 /*16*/], ""))
			{
