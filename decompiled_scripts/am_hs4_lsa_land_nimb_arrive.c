...
BOOL func_145(int iParam0) // Position - 0xC389 (50057)
{
	int num;
...
BOOL func_146(int iParam0) // Position - 0xC3AE (50094)
{
	int num;
...
BOOL func_147(int iParam0, int iParam1) // Position - 0xC3CC (50124)
{
