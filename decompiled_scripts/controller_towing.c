...
int func_84() // Position - 0x79D9 (31193)
{
...
void func_144(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xA1BF (41407)
{
...
int func_163(int iParam0) // Position - 0xA92E (43310)
{
