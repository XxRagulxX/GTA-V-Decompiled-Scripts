...
void func_29(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x11AB (4523)
{
...
void func_97(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, const char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11) // Position - 0x4191 (16785)
{
...
void func_98(const char* sParam0) // Position - 0x4244 (16964)
{
...
int func_117(int iParam0) // Position - 0x4D73 (19827)
{
	switch (iParam0)
	{
		case 0:
...
char* func_167(int iParam0) // Position - 0xCFD5 (53205)
{
	switch (iParam0)
	{
