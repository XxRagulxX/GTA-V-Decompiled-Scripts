...
void func_33(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x12AA (4778)
{
...
int func_73(Entity eParam0) // Position - 0x27B3 (10163)
{
	int i;
	...
	for (i = 0; i < 5; i = i + 1)
	{
		if (Global_45919[i /*6*/].f_1 == eParam0)
			return i;
	}
...
int func_74(Entity eParam0) // Position - 0x27E4 (10212)
{
	int i;
	...
	for (i = 0; i < 16; i = i + 1)
	{
		if (eParam0 == Global_45950[i /*5*/].f_1)
...
void func_262(Vehicle veParam0, int iParam1) // Position - 0xE6FA (59130)
{
	Ped pedInVehicleSeat;
	int i;
	int j;
...
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false) || func_285(veParam0, 0, false) || func_285(veParam0, 1, false) || func_285(veParam0, 2, false) || func_284(veParam0) != 145 || func_283(veParam0) || func_282(veParam0) || func_281(veParam0) || func_280(veParam0) || !func_269(ENTITY::GET_ENTITY_MODEL(veParam0)))
	{
		func_282(veParam0);
		func_282(veParam0);
...
int func_284(Vehicle veParam0) // Position - 0xF817 (63511)
{
	int i;
