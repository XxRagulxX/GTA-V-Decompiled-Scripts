...
BOOL func_144(int iParam0) // Position - 0xBC20 (48160)
{
	int num;
...
BOOL func_145(int iParam0) // Position - 0xBC44 (48196)
{
	int num;
...
BOOL func_146(int iParam0, int iParam1) // Position - 0xBC62 (48226)
{
...
void func_303(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, var uParam10, int iParam11) // Position - 0x3569A (218778)
{
...
void func_304(var uParam0, char* sParam1, int iParam2, int iParam3, var uParam4) // Position - 0x356CA (218826)
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_305(var uParam0, int iParam1, char* sParam2) // Position - 0x356F7 (218871)
{
