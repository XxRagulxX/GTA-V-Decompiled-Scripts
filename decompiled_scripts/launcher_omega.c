...
void main() // Position - 0x0 (0)
{
	...
	iLocal_109 = func_300(CHAR_OMEGA);
	iLocal_110 = -1;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_114077[num /*10*/].f_9 != -1)
			{
				...
				func_296(&(Global_114077[num /*10*/].f_9));
			}
		}
	...
	while (true)
	{
		...
		func_215(num);
		func_208(&iLocal_110, &(num.f_9), vector);
	
		if (num == 44)
		{
			func_200(&num, vector, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_111);
			func_199();
		}
		else if (num == 45)
		{
			func_200(&num, vector, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_112);
			func_197(&num);
		}
...
int func_98() // Position - 0x8B4E (35662)
{
	return func_99(PLAYER::PLAYER_ID());
}

int func_99(Player plParam0) // Position - 0x8B5E (35678)
{
	return MISC::GET_BITS_IN_RANGE(Global_2658296[plParam0 /*468*/].f_325.f_3, 28, 31);
}

BOOL func_100(int iParam0) // Position - 0x8B7B (35707)
{
	return func_74(iParam0, 0, false);
}

int func_101(int iParam0) // Position - 0x8B8B (35723)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_102() // Position - 0x8EF5 (36597)
{
	return Global_102563.f_417 > 0;
}

var func_103() // Position - 0x8F06 (36614)
{
	var unk;
...
void func_104(var uParam0, int iParam1) // Position - 0x8F4C (36684)
{
	if (iParam1 <= 0)
		return;
...
void func_105(var uParam0, int iParam1) // Position - 0x8FD2 (36818)
{
...
void func_106(var uParam0, int iParam1) // Position - 0x9005 (36869)
{
	int num;
	int num2;
...
int func_107(int iParam0, int iParam1) // Position - 0x9056 (36950)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_108(int iParam0) // Position - 0x90F8 (37112)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x911A (37146)
{
	if (bParam0)
		return uParam1;
...
int func_110(int iParam0) // Position - 0x9131 (37169)
{
	return iParam0 & 15;
}

void func_111(var uParam0, int iParam1) // Position - 0x913E (37182)
{
...
void func_112(var uParam0, int iParam1) // Position - 0x9178 (37240)
{
...
void func_113(var uParam0, int iParam1) // Position - 0x91B3 (37299)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x91EF (37359)
{
	func_58();
	return Global_114990.f_2370.f_539.f_4321;
}

void func_115(int iParam0) // Position - 0x9208 (37384)
{
	int num;
	var textLabel;
...
BOOL func_116() // Position - 0x926B (37483)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_117() // Position - 0x9281 (37505)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_118(char* sParam0, Any anParam1, int iParam2) // Position - 0x9297 (37527)
{
...
BOOL func_119(BOOL bParam0) // Position - 0x92D9 (37593)
{
...
struct<2> func_120(int iParam0) // Position - 0x9301 (37633)
{
	var unk;
...
void func_121(int iParam0, var uParam1) // Position - 0x974E (38734)
{
	switch (iParam0)
	{
		case 0:
...
int func_123(int iParam0) // Position - 0xAA26 (43558)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_124(Any* panParam0) // Position - 0xAD6C (44396)
{
	int threadId;
...
void func_125(int iParam0) // Position - 0xAE11 (44561)
{
	var name;
...
void func_126(int iParam0) // Position - 0xAEAC (44716)
{
	if (iParam0 < 63)
	{
		func_127();
...
void func_127() // Position - 0xAED2 (44754)
{
	Global_80617 != 6;
...
void func_128(Ped pedParam0) // Position - 0xAF0A (44810)
{
	int num;
	int num2;
	int num3;
...
void func_129(int iParam0) // Position - 0xAF63 (44899)
{
...
int func_130(Ped pedParam0) // Position - 0xAFE6 (45030)
{
	int i;
...
void func_131(int iParam0, int iParam1, int iParam2) // Position - 0xB017 (45079)
{
	func_132(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_132(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB02C (45100)
{
	int num;
...
int func_133() // Position - 0xB0AE (45230)
{
	int i;
...
BOOL func_134(int iParam0, int iParam1, int iParam2) // Position - 0xB0DF (45279)
{
...
int func_135(int iParam0, int iParam1, int iParam2) // Position - 0xB0FA (45306)
{
	int i;
...
int func_136(Ped pedParam0) // Position - 0xB146 (45382)
{
	int i;
...
BOOL func_137(Ped pedParam0) // Position - 0xB18F (45455)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xB1AF (45487)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_139(int iParam0) // Position - 0xB1D0 (45520)
{
	switch (iParam0)
	{
		case 5:
...
void func_140() // Position - 0xB223 (45603)
{
...
BOOL func_141(int iParam0) // Position - 0xB2A0 (45728)
{
	switch (iParam0)
	{
		case 5:
...
void func_142(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB2F3 (45811)
{
	int i;
...
BOOL func_143(int iParam0) // Position - 0xB3E9 (46057)
{
	switch (iParam0)
	{
		case 5:
...
void func_144(BOOL bParam0) // Position - 0xB454 (46164)
{
	Player playerIndex;
...
void func_145(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB493 (46227)
{
	if (bParam0)
	{
...
BOOL func_146() // Position - 0xB5E2 (46562)
{
	return IS_BIT_SET(Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_36.f_18, 14);
}

BOOL func_147(Player plParam0, int iParam1) // Position - 0xB5FC (46588)
{
	BOOL flag;
...
int func_148(int iParam0, BOOL bParam1) // Position - 0xB655 (46677)
{
	int num;
	int num2;
...
BOOL func_149(Player plParam0) // Position - 0xB696 (46742)
{
	Player player;
...
BOOL func_150(Player plParam0) // Position - 0xB6B8 (46776)
{
...
BOOL func_151() // Position - 0xB6F7 (46839)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_152(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB705 (46853)
{
	int num;
...
BOOL func_153() // Position - 0xB738 (46904)
{
...
void func_154(int iParam0) // Position - 0xB75F (46943)
{
	if (iParam0 == 1)
...
BOOL func_155(const char* sParam0) // Position - 0xB782 (46978)
{
...
void func_156() // Position - 0xB7BF (47039)
{
	Global_21906 = 0;
	func_157();
	return;
...
void func_157() // Position - 0xB7CF (47055)
{
...
BOOL func_158() // Position - 0xB826 (47142)
{
...
void func_159() // Position - 0xB848 (47176)
{
	func_165(0);
	func_164();
	func_160();
...
void func_160() // Position - 0xB85D (47197)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_161(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB8B5 (47285)
{
...
void func_162(Vehicle veParam0) // Position - 0xB90C (47372)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_163(BOOL bParam0, BOOL bParam1) // Position - 0xB938 (47416)
{
...
void func_164() // Position - 0xBA89 (47753)
{
...
void func_165(int iParam0) // Position - 0xBADA (47834)
{
	if (func_170())
		return;
...
void func_166(int iParam0) // Position - 0xBB0D (47885)
{
	if (func_170())
		return;
...
void func_167(BOOL bParam0, BOOL bParam1) // Position - 0xBB97 (48023)
{
	if (bParam0)
	{
		if (func_169(0))
...
BOOL func_168() // Position - 0xBC0B (48139)
{
	return IS_BIT_SET(Global_1965230, 5);
}

BOOL func_169(int iParam0) // Position - 0xBC19 (48153)
{
	if (iParam0 == 1)
...
BOOL func_170() // Position - 0xBC70 (48240)
{
	return IS_BIT_SET(Global_1965230, 19);
}

BOOL func_171(int iParam0) // Position - 0xBC7F (48255)
{
...
BOOL func_172(int iParam0) // Position - 0xBCC0 (48320)
{
	int num;
...
void func_173(int iParam0) // Position - 0xBD05 (48389)
{
...
int func_174(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBD37 (48439)
{
	int i;
...
void func_175(int iParam0, int iParam1) // Position - 0xBE6E (48750)
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBEBD (48829)
{
	return func_177(iParam0, Global_44938);
}

BOOL func_177(int iParam0, int iParam1) // Position - 0xBECE (48846)
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_178(int iParam0) // Position - 0xC0B2 (49330)
{
	if (Global_44938 == 15)
		return false;
...
int func_179() // Position - 0xC0D4 (49364)
{
	return func_180(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_180(const char* sParam0, int iParam1) // Position - 0xC0E5 (49381)
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_181() // Position - 0xC12E (49454)
{
	if (Global_102511 == 10 || Global_102511 == 9)
		return true;
...
BOOL func_182(var uParam0, int iParam1) // Position - 0xC152 (49490)
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_183() // Position - 0xC935 (51509)
{
	func_27(&(Global_105547.f_2890), &Global_105547, 0, 1, 1, 0);
	return;
}

BOOL func_184(var uParam0) // Position - 0xC950 (51536)
{
	float num;
...
void func_185(int iParam0, var uParam1) // Position - 0xC9DE (51678)
{
	if (iParam0 == 1)
	{
		if (!func_141(uParam1))
...
BOOL func_186(BOOL bParam0) // Position - 0xCA42 (51778)
{
...
BOOL func_187(Vehicle veParam0) // Position - 0xCAD9 (51929)
{
...
BOOL func_188(int iParam0) // Position - 0xCB03 (51971)
{
	eCharacter character;
...
BOOL func_189() // Position - 0xD220 (53792)
{
	return Global_102550.f_1;
}

BOOL func_190() // Position - 0xD22E (53806)
{
	if (Global_99408 != -1)
...
BOOL func_191() // Position - 0xD251 (53841)
{
...
BOOL func_192() // Position - 0xD26B (53867)
{
	if (Global_80623)
		return true;
...
BOOL func_193() // Position - 0xD295 (53909)
{
	return Global_102563.f_418 > 0;
}

BOOL func_194(int iParam0, int iParam1) // Position - 0xD2A6 (53926)
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_195() // Position - 0xD2DE (53982)
{
	return Global_1575097;
}

BOOL func_196() // Position - 0xD2EA (53994)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_197(var uParam0) // Position - 0xD306 (54022)
{
	var entityCoords;
	float entityCoords2;
	float heading;
	...
	if (MISC::GET_GAME_TIMER() - iLocal_115 > 1250)
	{
...
BOOL func_198(Ped pedParam0, Entity eParam1, float fParam2, BOOL bParam3) // Position - 0xD3EF (54255)
{
...
void func_199() // Position - 0xD411 (54289)
{
	float x;
	float y;
	float width;
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_113, "SET_COLOUR");
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_113, "SET_DISTANCE");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(10f);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	HUD::SET_TEXT_RENDER_ID(iLocal_114);
	x = 0.1f;
	y = 0.24f;
	width = 0.21f;
	height = 0.51f;
	...
	GRAPHICS::DRAW_SCALEFORM_MOVIE(iLocal_113, x, y, width, height, 100, 100, 100, 255, 0);

	if (MISC::GET_GAME_TIMER() - iLocal_115 > 1250)
	{
		AUDIO::PLAY_SOUND_FROM_COORD(iLocal_116, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", false, 0, false);
		iLocal_115 = MISC::GET_GAME_TIMER();
	}
...
int func_200(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, var uParam8) // Position - 0xD503 (54531)
{
	var unk;
...
void func_201(int iParam0) // Position - 0xD625 (54821)
{
	Global_24051 = iParam0;
	return;
}

BOOL func_202(char* sParam0) // Position - 0xD632 (54834)
{
	var string1;
...
struct<6> func_203() // Position - 0xD652 (54866)
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD676 (54902)
{
...
void func_205(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD6B1 (54961)
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD707 (55047)
{
...
float func_207(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD7A2 (55202)
{
...
void func_208(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD7DC (55260)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_209(int iParam0, BOOL bParam1) // Position - 0xD8CD (55501)
{
	if (iParam0 == -1)
		return;
...
int func_210(int iParam0) // Position - 0xD909 (55561)
{
	if (Global_80358 == iParam0)
		if (Global_80359 == -1)
...
void func_211(var uParam0, int iParam1) // Position - 0xD942 (55618)
{
	BOOL flag;
	int i;
...
BOOL func_212() // Position - 0xD9E0 (55776)
{
	return Global_99795;
}

void func_213(var uParam0) // Position - 0xD9EC (55788)
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_214(uParam0);
...
void func_214(var uParam0) // Position - 0xDA03 (55811)
{
	BOOL flag;
	int num;
	int i;
...
void func_215(int iParam0) // Position - 0xDAEB (56043)
{
	if (iParam0 == -1)
		iParam0 = func_179();
...
BOOL func_216(Any* panParam0, BOOL bParam1) // Position - 0xDB13 (56083)
{
	var unk;
	...
	if (func_253(*panParam0) || func_251(*panParam0) || Global_80608 == 1)
		return true;
...
void func_217(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDD83 (56707)
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_218(int iParam0) // Position - 0xE0DB (57563)
{
...
BOOL func_219(var uParam0) // Position - 0xE0FB (57595)
{
...
BOOL func_220(var uParam0) // Position - 0xE113 (57619)
{
...
void func_221(var uParam0) // Position - 0xE138 (57656)
{
	int i;
	int taskSequenceId;
...
void func_222(Object* pobParam0) // Position - 0xE43C (58428)
{
...
void func_223(var uParam0) // Position - 0xE467 (58471)
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE4E7 (58599)
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_225(Ped pedParam0, Vehicle veParam1) // Position - 0xE6A5 (59045)
{
...
BOOL func_226(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE6D5 (59093)
{
	int i;
	int num;
...
BOOL func_227(int iParam0) // Position - 0xE991 (59793)
{
...
BOOL func_228(Ped pedParam0, int iParam1) // Position - 0xE9C5 (59845)
{
	float xSize;
...
BOOL func_229(Ped pedParam0, int iParam1) // Position - 0xEA3B (59963)
{
	return func_230(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_230(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEA53 (59987)
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_231(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xEB14 (60180)
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_232(Ped pedParam0, int iParam1) // Position - 0xEC40 (60480)
{
...
int func_233() // Position - 0xED05 (60677)
{
	int i;
...
BOOL func_234(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xED4F (60751)
{
	var unk;
...
float func_235(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEDE0 (60896)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_236(float fParam0, var uParam1, var uParam2) // Position - 0xEE01 (60929)
{
	float num;
	float num2;
...
void func_237(var uParam0) // Position - 0xEE40 (60992)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_238(Ped pedParam0, Ped pedParam1) // Position - 0xEE5B (61019)
{
	int i;
...
BOOL func_239(Ped pedParam0) // Position - 0xEE9A (61082)
{
...
BOOL func_240(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEEC2 (61122)
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_241(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEFBD (61373)
{
	float entityCoords;
	float num;
...
BOOL func_242(Ped pedParam0, float fParam1) // Position - 0xF0C9 (61641)
{
	var outProjectile;
	var outCoords;
...
BOOL func_243(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF15E (61790)
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_244(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF1EC (61932)
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_245(int iParam0) // Position - 0xF234 (62004)
{
...
void func_246(Vehicle veParam0) // Position - 0xF27E (62078)
{
	int taskSequenceId;
...
BOOL func_247(int iParam0) // Position - 0xF31B (62235)
{
	if (iParam0 == -1)
		iParam0 = func_179();
...
BOOL func_248(int iParam0) // Position - 0xF3B0 (62384)
{
...
BOOL func_249() // Position - 0xF3EF (62447)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_250() // Position - 0xF40C (62476)
{
	if (Global_99408 != -1)
...
BOOL func_251(int iParam0) // Position - 0xF42F (62511)
{
	if (func_252() && Global_102511.f_11 == 6 && iParam0 == func_180(&(Global_102511.f_3), 0))
		return true;

	return false;
}

BOOL func_252() // Position - 0xF463 (62563)
{
...
BOOL func_253(int iParam0) // Position - 0xF4A1 (62625)
{
	if (func_119(false))
...
void func_254() // Position - 0xF4C9 (62665)
{
	iLocal_115 = MISC::GET_GAME_TIMER();
	return;
}

void func_255() // Position - 0xF4D7 (62679)
{
	iLocal_113 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("digiscanner");

	while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_113))
	{
		BUILTIN::WAIT(0);
	}
	...
	if (HUD::IS_NAMED_RENDERTARGET_REGISTERED("digiscanner"))
		iLocal_114 = HUD::GET_NAMED_RENDERTARGET_RENDER_ID("digiscanner");
...
BOOL func_256(var uParam0) // Position - 0xF53F (62783)
{
	switch (*uParam0)
	{
		case 44:
...
BOOL func_257(var uParam0) // Position - 0xF586 (62854)
{
	int num;
	int i;
	BOOL flag;
...
void func_258(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF755 (63317)
{
	func_259(pveParam0);
...
void func_259(Vehicle* pveParam0) // Position - 0xF798 (63384)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_260(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF834 (63540)
{
...
BOOL func_261(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF890 (63632)
{
	Hash model;
...
int func_262(var uParam0, eCharacter echParam1) // Position - 0xF91E (63774)
{
	int num;
...
BOOL func_263(var uParam0) // Position - 0xF964 (63844)
{
	if (func_220(uParam0))
	{
...
BOOL func_264(var uParam0) // Position - 0xF98E (63886)
{
	int i;
...
void func_265(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xF9BF (63935)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_266(var uParam0) // Position - 0xF9FB (63995)
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_267(int iParam0) // Position - 0xFC7F (64639)
{
	var unk;
	eCharacter character;
...
BOOL func_268(int iParam0) // Position - 0xFCD0 (64720)
{
	const char* string2;
...
BOOL func_269(int iParam0) // Position - 0xFD89 (64905)
{
	var unk;
...
BOOL func_270(int iParam0) // Position - 0xFE4A (65098)
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_271(int iParam0, char* sParam1) // Position - 0xFECF (65231)
{
...
BOOL func_272(int iParam0) // Position - 0xFFB1 (65457)
{
...
BOOL func_273(int iParam0) // Position - 0xFFDC (65500)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_274(int iParam0) // Position - 0x1000A (65546)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_275(int iParam0) // Position - 0x10035 (65589)
{
	if (func_248(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_276() // Position - 0x1006A (65642)
{
...
BOOL func_277(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x10084 (65668)
{
	int i;
...
BOOL func_278(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x100E9 (65769)
{
	int num;
	char* str;
...
BOOL func_279(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x10161 (65889)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_280(var uParam0, BOOL bParam1) // Position - 0x101DC (66012)
{
	char* str;
...
void func_281(char* sParam0) // Position - 0x102AC (66220)
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_202(sParam0))
			func_282();
...
void func_282() // Position - 0x102CB (66251)
{
	Global_21906 = 0;
	func_283();
	return;
...
void func_283() // Position - 0x102DB (66267)
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_24051 = 0;
...
int func_284(var uParam0) // Position - 0x102FC (66300)
{
	if (func_220(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_285(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10332 (66354)
{
...
void func_286(var uParam0, BOOL bParam1) // Position - 0x10352 (66386)
{
	func_287(&(uParam0->f_41), bParam1);
	return;
}

void func_287(var uParam0, BOOL bParam1) // Position - 0x10364 (66404)
{
	int i;
...
void func_288(Object* pobParam0, BOOL bParam1) // Position - 0x103A2 (66466)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_289(var uParam0, BOOL bParam1) // Position - 0x103DD (66525)
{
	func_290(&(uParam0->f_35), bParam1);
	return;
}

void func_290(var uParam0, BOOL bParam1) // Position - 0x103EF (66543)
{
	int i;
...
void func_291(Vehicle* pveParam0) // Position - 0x1042C (66604)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_292(var uParam0, int iParam1) // Position - 0x10464 (66660)
{
	func_293(&(uParam0->f_28), iParam1);
	return;
}

void func_293(var uParam0, int iParam1) // Position - 0x10476 (66678)
{
	int i;
...
void func_294(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x104B7 (66743)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_295(Ped* ppedParam0) // Position - 0x10507 (66823)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_296(int iParam0) // Position - 0x10548 (66888)
{
	if (*iParam0 == -1)
		return;
...
void func_297(char* sParam0) // Position - 0x10585 (66949)
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_298(var uParam0) // Position - 0x10597 (66967)
{
	*uParam0 = -1;
...
void func_299() // Position - 0x105CA (67018)
{
...
Hash func_300(eCharacter echParam0) // Position - 0x105E4 (67044)
{
	if (!func_36(echParam0))
