...
BOOL func_149(int iParam0) // Position - 0xC4FC (50428)
{
	int num;
...
BOOL func_150(int iParam0) // Position - 0xC521 (50465)
{
	int num;
...
BOOL func_151(int iParam0, int iParam1) // Position - 0xC53F (50495)
{
