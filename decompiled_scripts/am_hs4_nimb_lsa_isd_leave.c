...
BOOL func_148(int iParam0) // Position - 0xBD91 (48529)
{
	int num;
...
BOOL func_149(int iParam0) // Position - 0xBDB5 (48565)
{
	int num;
...
BOOL func_150(int iParam0, int iParam1) // Position - 0xBDD3 (48595)
{
