...
void func_5() // Position - 0x57D (1405)
{
	...
	switch (Global_21666.f_1)
	{
		case 6:
			...
			if (Global_21654)
			{
				func_36(Global_21647, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205" /*SELECT*/, 0, 0, 0, 0);
				func_36(Global_21647, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206" /*BACK*/, 0, 0, 0, 0);
			}
			else
			{
			...
			else
			{
				if (Global_21900 == 1)
					if (Global_21654)
						func_36(Global_21647, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, "CELL_225" /*NEXT*/, 0, 0, 0, 0);
					else
						func_36(Global_21647, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, 0, 0, 0, 0, 0);
				else if (Global_21654)
					func_36(Global_21647, "SET_SOFT_KEYS", 1f, 1f, 3f, -1f, -1f, "CELL_225" /*NEXT*/, 0, 0, 0, 0);
				else
		...
		case 10:
			...
			{
				func_36(Global_21647, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_202" /*END CALL*/, 0, 0, 0, 0);
		...
		case 9:
			if (Global_21665 == 1)
			{
				...
				{
					func_36(Global_21647, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(4), BUILTIN::TO_FLOAT(0), BUILTIN::TO_FLOAT(2), -1f, -1f, &(Global_118[Global_8817 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, "CELL_217" /*INCOMING CALL*/, "CELL_195" /*Unknown*/, 0);
				}
				else
				{
					func_36(Global_21647, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(4), BUILTIN::TO_FLOAT(0), BUILTIN::TO_FLOAT(2), -1f, -1f, &(Global_2349[Global_8817 /*29*/].f_3), &(Global_2349[Global_8817 /*29*/].f_7), "CELL_217" /*INCOMING CALL*/, &(Global_2349[Global_8817 /*29*/].f_3), 0);
				}
			...
			else if (Global_23040 == 4 || Global_23040 == 3)
			{
				...
				else
				{
					...
					if (func_8(Global_8817, Global_21666) == 0)
					{
						...
						func_36(Global_21647, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(4), BUILTIN::TO_FLOAT(0), BUILTIN::TO_FLOAT(3), -1f, -1f, &(Global_118[Global_8817 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, &unk, "CELL_195" /*Unknown*/, 0);
					}
					else
					{
						func_87(Global_21647, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_6() // Position - 0xB69 (2921)
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_21647))
	{
		...
		{
			if (Global_21654)
				func_36(Global_21647, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, "CELL_203" /*ANSWER*/, 0, 0, 0, 0);
			else
			...
			if (Global_23087)
				...
				func_36(Global_21647, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_204" /*REJECT*/, 0, 0, 0, 0);
			else
				func_36(Global_21647, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, 0, 0, 0, 0, 0);
...
BOOL func_80(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4B30 (19248)
{
	...
	for (i = 0; i < 16; i = i + 1)
	{
		...
		{
			case 72:
				if (Global_114990.f_24913[num3 /*4*/] == 0)
					flag = true;
				break;
		
			case 73:
				if (Global_114990.f_24913[num3 /*4*/] == 1)
					flag = true;
				break;
		
			case 74:
				if (Global_114990.f_24913[num3 /*4*/] == 2)
					flag = true;
				break;
		}
