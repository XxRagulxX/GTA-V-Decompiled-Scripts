...
void func_2() // Position - 0xD7 (215)
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && MISC::GET_GAME_TIMER() - iLocal_74 > 2000 || NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::IS_TIME_MORE_THAN(NETWORK::GET_NETWORK_TIME(), NETWORK::GET_TIME_OFFSET(iLocal_75, 2000)) || bLocal_77)
	{
		...
		for (j = 0; j < num4; j = j + 1)
		{
			...
			func_74(echLocal_76, num3, &statHash, &num2);
			...
			if (func_59(echLocal_76, num3, outValue, &value))
			{
				if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				{
				...
				{
					if (Global_114990.f_2370.f_539.f_2387[echLocal_76] == 0)
						flag2 = false;
				...
				if (value > func_55(echLocal_76, num3, -1))
				{
					if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
					...
					num5 = value;
					num6 = num5 - (num5 % func_53(echLocal_76, num3));
				
					if (num5 % func_53(echLocal_76, num3) >= 0)
						num6 = num6 + func_53(echLocal_76, num3);
				
					if (num5 >= num6)
						num5 = num6;
					else
						num5 = num6 - func_53(echLocal_76, num3);
					...
					if (flag2)
					{
						if (!bLocal_77)
						{
							...
							bLocal_82 = bLocal_82 + (outValue % func_53(echLocal_76, num3));
							iLocal_83 = value;
					...
					if (value >= 100)
					{
						if (func_3(echLocal_76, num3, &statName))
						{
...
BOOL func_9() // Position - 0x841 (2113)
{
	...
	if (Global_2686124.f_2847.f_26 == 1)
		return false;
...
{
	if (func_50(plParam0))
		if (func_50(Global_1893070[plParam0 /*615*/].f_10))
...
int func_61(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x2522 (9506)
{
	switch (echParam0)
	{
		case CHAR_MICHAEL:
...
int func_73(int iParam0, int iParam1) // Position - 0x2800 (10240)
{
	Hash statHash;
	int outValue;
...
BOOL func_87(int iParam0) // Position - 0x34A3 (13475)
{
...
void func_93() // Position - 0x363B (13883)
{
	...
	if (bLocal_79)
	{
		...
		HUD::END_TEXT_COMMAND_THEFEED_POST_STATS(func_95(iLocal_81), func_94(iLocal_81), bLocal_82, iLocal_83 - bLocal_82, false, pedheadshotTxdString, pedheadshotTxdString);
		bLocal_100 = true;
