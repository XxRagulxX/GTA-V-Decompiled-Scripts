...
void func_17(Ped pedParam0, Cam caParam1, int iParam2, int iParam3, int iParam4) // Position - 0x2671
{
	...
	if (!func_34(pedParam0))
	{
		...
		if (num3 == -1)
		{
			...
			if (!(num4 == -1))
				Global_44355[num4 /*5*/].f_4 = Global_44355[num4 /*5*/].f_4 + iParam2;
		}
	}
	else
	{
		...
		if (num5 == -1)
		{
			...
			if (!(num6 == -1))
				Global_44355[num6 /*5*/].f_4 = Global_44355[num6 /*5*/].f_4 + iParam2;
		}
...
void func_19(int iParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4, int iParam5) // Position - 0x27FA
{
	...
	Global_44436[num /*6*/].f_3 = pedParam3;
...
void func_24(Ped pedParam0, int iParam1) // Position - 0x2941
{
	...
	if (num == -1)
	{
		...
		if (!(num2 == -1))
		{
			Global_44329[num2 /*5*/].f_3 = Global_44329[num2 /*5*/].f_3 + iParam1;
			Global_44329[num2 /*5*/].f_2 = Global_44329[num2 /*5*/].f_2 + iParam1;
		}
...
int func_36(Ped pedParam0) // Position - 0x2D4A
{
	...
	return Global_44355[num2 /*5*/].f_4;
}
