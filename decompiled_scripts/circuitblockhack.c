...
void func_92() // Position - 0x1961 (6497)
{
	...
	{
		func_104(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(PLAYER_CONTROL, INPUT_FRONTEND_ACCEPT, true), "CBH_CONFI" /*Confirm*/, &(uLocal_72.f_25), 0);
	
		if (PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
			func_104(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(PLAYER_CONTROL, INPUT_CURSOR_CANCEL, true), "CBH_QUIT" /*Quit*/, &(uLocal_72.f_25), 0);
		else
			func_104(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(PLAYER_CONTROL, INPUT_FRONTEND_CANCEL, true), "CBH_QUIT" /*Quit*/, &(uLocal_72.f_25), 0);
	
		func_103(0, 4, "CBH_MV_UD" /*Move*/, &(uLocal_72.f_25));
		func_103(0, 5, "CBH_MV_LR" /*Select*/, &(uLocal_72.f_25));
	}
