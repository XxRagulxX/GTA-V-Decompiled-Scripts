...
void func_7() // Position - 0x526 (1318)
{
	...
	num = iLocal_97 - MISC::GET_GAME_TIMER();
...
int func_116(Vehicle veParam0, int iParam1, int iParam2) // Position - 0x59E5 (23013)
{
	var script;
...
void func_117(Vehicle veParam0, int iParam1) // Position - 0x5A25 (23077)
{
	Ped pedInVehicleSeat;
	int i;
	int j;
...
int func_140(Vehicle veParam0) // Position - 0x6BFB (27643)
{
	int i;
