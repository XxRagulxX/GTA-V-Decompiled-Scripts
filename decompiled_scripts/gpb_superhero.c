...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x22BD (8893)
{
...
void func_106() // Position - 0x32CA (13002)
{
	...
	iLocal_269 = 15;
	iLocal_270 = 6;
	sLocal_320 = "PBSH_INTERACT" /*Press ~INPUT_CONTEXT~ to talk to Impotent Rage.*/;
