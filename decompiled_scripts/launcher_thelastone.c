...
void main() // Position - 0x0 (0)
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_114077[num /*10*/].f_9 != -1)
			{
				...
				func_281(&(Global_114077[num /*10*/].f_9));
			}
		}
	...
	while (true)
	{
		...
		func_211(num);
		func_204(&iLocal_110, &uLocal_111, &(num.f_9), vector, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
...
int func_98() // Position - 0x8B1D (35613)
{
	return func_99(PLAYER::PLAYER_ID());
}

int func_99(Player plParam0) // Position - 0x8B2D (35629)
{
	return MISC::GET_BITS_IN_RANGE(Global_2658296[plParam0 /*468*/].f_325.f_3, 28, 31);
}

BOOL func_100(int iParam0) // Position - 0x8B4A (35658)
{
	return func_74(iParam0, 0, false);
}

int func_101(int iParam0) // Position - 0x8B5A (35674)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_102() // Position - 0x8EC4 (36548)
{
	return Global_102563.f_417 > 0;
}

var func_103() // Position - 0x8ED5 (36565)
{
	var unk;
...
void func_104(var uParam0, int iParam1) // Position - 0x8F1B (36635)
{
	if (iParam1 <= 0)
		return;
...
void func_105(var uParam0, int iParam1) // Position - 0x8FA1 (36769)
{
...
void func_106(var uParam0, int iParam1) // Position - 0x8FD4 (36820)
{
	int num;
	int num2;
...
int func_107(int iParam0, int iParam1) // Position - 0x9025 (36901)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_108(int iParam0) // Position - 0x90C7 (37063)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x90E9 (37097)
{
	if (bParam0)
		return uParam1;
...
int func_110(int iParam0) // Position - 0x9100 (37120)
{
	return iParam0 & 15;
}

void func_111(var uParam0, int iParam1) // Position - 0x910D (37133)
{
...
void func_112(var uParam0, int iParam1) // Position - 0x9147 (37191)
{
...
void func_113(var uParam0, int iParam1) // Position - 0x9182 (37250)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x91BE (37310)
{
	func_58();
	return Global_114990.f_2370.f_539.f_4321;
}

void func_115(int iParam0) // Position - 0x91D7 (37335)
{
	int num;
	var textLabel;
...
BOOL func_117() // Position - 0x9250 (37456)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_118(char* sParam0, Any anParam1, int iParam2) // Position - 0x9266 (37478)
{
...
BOOL func_119(BOOL bParam0) // Position - 0x92A8 (37544)
{
...
struct<2> func_120(int iParam0) // Position - 0x92D0 (37584)
{
	var unk;
...
void func_121(int iParam0, var uParam1) // Position - 0x971D (38685)
{
	switch (iParam0)
	{
		case 0:
...
int func_123(int iParam0) // Position - 0xA9F5 (43509)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_124(Any* panParam0) // Position - 0xAD3B (44347)
{
	int threadId;
...
void func_125(int iParam0) // Position - 0xADE0 (44512)
{
	var name;
...
void func_126(int iParam0) // Position - 0xAE7B (44667)
{
	if (iParam0 < 63)
	{
		func_127();
...
void func_127() // Position - 0xAEA1 (44705)
{
	Global_80617 != 6;
...
void func_128(Ped pedParam0) // Position - 0xAED9 (44761)
{
	int num;
	int num2;
	int num3;
...
void func_129(int iParam0) // Position - 0xAF32 (44850)
{
...
int func_130(Ped pedParam0) // Position - 0xAFB5 (44981)
{
	int i;
...
void func_131(int iParam0, int iParam1, int iParam2) // Position - 0xAFE6 (45030)
{
	func_132(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_132(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAFFB (45051)
{
	int num;
...
int func_133() // Position - 0xB07D (45181)
{
	int i;
...
BOOL func_134(int iParam0, int iParam1, int iParam2) // Position - 0xB0AE (45230)
{
...
int func_135(int iParam0, int iParam1, int iParam2) // Position - 0xB0C9 (45257)
{
	int i;
...
int func_136(Ped pedParam0) // Position - 0xB115 (45333)
{
	int i;
...
BOOL func_137(Vehicle veParam0) // Position - 0xB15E (45406)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xB17E (45438)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_139(int iParam0) // Position - 0xB19F (45471)
{
	switch (iParam0)
	{
		case 5:
...
void func_140() // Position - 0xB1F2 (45554)
{
...
BOOL func_141(int iParam0) // Position - 0xB26F (45679)
{
	switch (iParam0)
	{
		case 5:
...
void func_142(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB2C2 (45762)
{
	int i;
...
BOOL func_143(int iParam0) // Position - 0xB3B8 (46008)
{
	switch (iParam0)
	{
		case 5:
...
void func_144(BOOL bParam0) // Position - 0xB423 (46115)
{
	Player playerIndex;
...
void func_145(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB462 (46178)
{
	if (bParam0)
	{
...
BOOL func_146() // Position - 0xB5B1 (46513)
{
	return IS_BIT_SET(Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_36.f_18, 14);
}

BOOL func_147(Player plParam0, int iParam1) // Position - 0xB5CB (46539)
{
	BOOL flag;
...
int func_148(int iParam0, BOOL bParam1) // Position - 0xB624 (46628)
{
	int num;
	int num2;
...
BOOL func_149(Player plParam0) // Position - 0xB665 (46693)
{
	Player player;
...
BOOL func_150(Player plParam0) // Position - 0xB687 (46727)
{
...
BOOL func_151() // Position - 0xB6C6 (46790)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_152(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB6D4 (46804)
{
	int num;
...
BOOL func_153() // Position - 0xB707 (46855)
{
...
void func_154(int iParam0) // Position - 0xB72E (46894)
{
	if (iParam0 == 1)
...
BOOL func_155(const char* sParam0) // Position - 0xB751 (46929)
{
...
void func_156() // Position - 0xB78E (46990)
{
	Global_21906 = 0;
	func_157();
	return;
...
void func_157() // Position - 0xB79E (47006)
{
...
BOOL func_158() // Position - 0xB7F5 (47093)
{
...
void func_159() // Position - 0xB817 (47127)
{
	func_165(0);
	func_164();
	func_160();
...
void func_160() // Position - 0xB82C (47148)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_161(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB884 (47236)
{
...
void func_162(Vehicle veParam0) // Position - 0xB8DB (47323)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_163(BOOL bParam0, BOOL bParam1) // Position - 0xB907 (47367)
{
...
void func_164() // Position - 0xBA58 (47704)
{
...
void func_165(int iParam0) // Position - 0xBAA9 (47785)
{
	if (func_170())
		return;
...
void func_166(int iParam0) // Position - 0xBADC (47836)
{
	if (func_170())
		return;
...
void func_167(BOOL bParam0, BOOL bParam1) // Position - 0xBB66 (47974)
{
	if (bParam0)
	{
		if (func_169(0))
...
BOOL func_168() // Position - 0xBBDA (48090)
{
	return IS_BIT_SET(Global_1965230, 5);
}

BOOL func_169(int iParam0) // Position - 0xBBE8 (48104)
{
	if (iParam0 == 1)
...
BOOL func_170() // Position - 0xBC3F (48191)
{
	return IS_BIT_SET(Global_1965230, 19);
}

BOOL func_171(int iParam0) // Position - 0xBC4E (48206)
{
...
BOOL func_172(int iParam0) // Position - 0xBC8F (48271)
{
	int num;
...
void func_173(int iParam0) // Position - 0xBCD4 (48340)
{
...
int func_174(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBD06 (48390)
{
	int i;
...
void func_175(int iParam0, int iParam1) // Position - 0xBE3D (48701)
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBE8C (48780)
{
	return func_177(iParam0, Global_44938);
}

BOOL func_177(int iParam0, int iParam1) // Position - 0xBE9D (48797)
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_178(int iParam0) // Position - 0xC07F (49279)
{
	if (Global_44938 == 15)
		return false;
...
int func_179() // Position - 0xC0A1 (49313)
{
	return func_180(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_180(const char* sParam0, int iParam1) // Position - 0xC0B2 (49330)
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_181() // Position - 0xC0FB (49403)
{
	if (Global_102511 == 10 || Global_102511 == 9)
		return true;
...
BOOL func_182(var uParam0, int iParam1) // Position - 0xC11F (49439)
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_183() // Position - 0xC902 (51458)
{
	func_27(&(Global_105547.f_2890), &Global_105547, 0, 1, 1, 0);
	return;
}

BOOL func_184(var uParam0) // Position - 0xC91D (51485)
{
	float num;
...
void func_185(int iParam0, var uParam1) // Position - 0xC9AB (51627)
{
	if (iParam0 == 1)
	{
		if (!func_141(uParam1))
...
BOOL func_186(BOOL bParam0) // Position - 0xCA0F (51727)
{
...
BOOL func_187(Vehicle veParam0) // Position - 0xCAA6 (51878)
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_188(int iParam0) // Position - 0xCAD0 (51920)
{
	eCharacter character;
...
BOOL func_189() // Position - 0xD1ED (53741)
{
	return Global_102550.f_1;
}

BOOL func_190() // Position - 0xD1FB (53755)
{
	if (Global_99408 != -1)
...
BOOL func_191() // Position - 0xD21E (53790)
{
...
BOOL func_192() // Position - 0xD238 (53816)
{
	if (Global_80623)
		return true;
...
BOOL func_193() // Position - 0xD262 (53858)
{
	return Global_102563.f_418 > 0;
}

BOOL func_194(int iParam0, int iParam1) // Position - 0xD273 (53875)
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_195() // Position - 0xD2AB (53931)
{
	return Global_1575097;
}

BOOL func_196() // Position - 0xD2B7 (53943)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_197(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8) // Position - 0xD2D3 (53971)
{
	var unk;
...
BOOL func_198(char* sParam0) // Position - 0xD395 (54165)
{
	var string1;
...
struct<6> func_199() // Position - 0xD3B5 (54197)
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD3D9 (54233)
{
...
void func_201(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD414 (54292)
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD46A (54378)
{
...
float func_203(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD505 (54533)
{
...
void func_204(var uParam0, var uParam1, const char* sParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11) // Position - 0xD53F (54591)
{
	float num;
	float num2;
	float num3;
...
void func_205(int iParam0, BOOL bParam1) // Position - 0xD65D (54877)
{
	if (iParam0 == -1)
		return;
...
int func_206(int iParam0) // Position - 0xD699 (54937)
{
	if (Global_80358 == iParam0)
		if (Global_80359 == -1)
...
void func_207(var uParam0, int iParam1) // Position - 0xD6D2 (54994)
{
	BOOL flag;
	int i;
...
void func_208(var uParam0) // Position - 0xD770 (55152)
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_209(uParam0);
...
void func_209(var uParam0) // Position - 0xD787 (55175)
{
	BOOL flag;
	int num;
	int i;
...
BOOL func_210() // Position - 0xD86F (55407)
{
	return Global_99795;
}

void func_211(int iParam0) // Position - 0xD87B (55419)
{
	if (iParam0 == -1)
		iParam0 = func_179();
...
BOOL func_212(Any* panParam0, BOOL bParam1) // Position - 0xD8A3 (55459)
{
	var unk;
...
void func_213(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDB13 (56083)
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_214(int iParam0) // Position - 0xDE6B (56939)
{
...
BOOL func_215(var uParam0) // Position - 0xDE8B (56971)
{
...
BOOL func_216(var uParam0) // Position - 0xDEA3 (56995)
{
...
void func_217(var uParam0) // Position - 0xDEC8 (57032)
{
	int i;
	int taskSequenceId;
...
void func_218(Object* pobParam0) // Position - 0xE1CC (57804)
{
...
void func_219(var uParam0) // Position - 0xE1F7 (57847)
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE277 (57975)
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_221(Ped pedParam0, Vehicle veParam1) // Position - 0xE435 (58421)
{
...
BOOL func_222(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE465 (58469)
{
	int i;
	int num;
...
BOOL func_223(int iParam0) // Position - 0xE721 (59169)
{
...
BOOL func_224(Vehicle veParam0, int iParam1) // Position - 0xE755 (59221)
{
	float xSize;
...
BOOL func_225(Vehicle veParam0, int iParam1) // Position - 0xE7CB (59339)
{
	return func_226(veParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_226(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE7E3 (59363)
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_227(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Position - 0xE8A4 (59556)
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_228(Ped pedParam0, int iParam1) // Position - 0xE9D0 (59856)
{
...
int func_229() // Position - 0xEA95 (60053)
{
	int i;
...
BOOL func_230(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xEADF (60127)
{
	var unk;
...
float func_231(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEB70 (60272)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_232(float fParam0, var uParam1, var uParam2) // Position - 0xEB91 (60305)
{
	float num;
	float num2;
...
void func_233(var uParam0) // Position - 0xEBD0 (60368)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_234(Vehicle veParam0, Ped pedParam1) // Position - 0xEBEB (60395)
{
	int i;
...
BOOL func_235(Vehicle veParam0) // Position - 0xEC2A (60458)
{
...
BOOL func_236(Vehicle veParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEC52 (60498)
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_237(Vehicle veParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xED4D (60749)
{
	float entityCoords;
	float num;
...
BOOL func_238(Vehicle veParam0, float fParam1) // Position - 0xEE59 (61017)
{
	var outProjectile;
	var outCoords;
...
BOOL func_239(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEEEE (61166)
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_240(Vehicle veParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEF7C (61308)
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_241(int iParam0) // Position - 0xEFC4 (61380)
{
...
void func_242(Vehicle veParam0) // Position - 0xF00E (61454)
{
	int taskSequenceId;
...
BOOL func_243(int iParam0) // Position - 0xF0AB (61611)
{
	if (iParam0 == -1)
		iParam0 = func_179();
...
BOOL func_244(int iParam0) // Position - 0xF140 (61760)
{
...
BOOL func_245() // Position - 0xF17F (61823)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_246() // Position - 0xF19C (61852)
{
	if (Global_99408 != -1)
...
BOOL func_247(int iParam0) // Position - 0xF1BF (61887)
{
...
BOOL func_248() // Position - 0xF1F3 (61939)
{
...
BOOL func_249(int iParam0) // Position - 0xF231 (62001)
{
	if (func_119(false))
...
BOOL func_250(var uParam0) // Position - 0xF259 (62041)
{
	if (!func_251(uParam0))
		return false;
...
BOOL func_251(var uParam0) // Position - 0xF278 (62072)
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_108)
	{
		...
		case 2:
			flag = true;
			uParam0->f_28[0] = PED::CREATE_PED(PED_TYPE_SPECIAL, hLocal_109, -1299.02f, 4639.86f, 106.66f, 345.7769f, true, true);
...
void func_252(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF464 (62564)
{
	func_253(pveParam0);
...
void func_253(Vehicle* pveParam0) // Position - 0xF4A7 (62631)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_254(var uParam0) // Position - 0xF543 (62787)
{
	int i;
...
BOOL func_255(int iParam0) // Position - 0xF574 (62836)
{
	var unk;
	eCharacter character;
...
BOOL func_256(int iParam0) // Position - 0xF5C5 (62917)
{
	const char* string2;
...
BOOL func_257(int iParam0) // Position - 0xF67E (63102)
{
	var unk;
...
BOOL func_258(int iParam0) // Position - 0xF73F (63295)
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_259(int iParam0, char* sParam1) // Position - 0xF7C4 (63428)
{
...
BOOL func_260(int iParam0) // Position - 0xF8A6 (63654)
{
...
BOOL func_261(int iParam0) // Position - 0xF8D1 (63697)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_262(int iParam0) // Position - 0xF8FC (63740)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_263(int iParam0) // Position - 0xF927 (63783)
{
	if (func_244(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_264() // Position - 0xF95C (63836)
{
...
BOOL func_265(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF976 (63862)
{
	int i;
...
BOOL func_266(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF9DB (63963)
{
	int num;
	char* str;
...
BOOL func_267(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xFA53 (64083)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_268(var uParam0, BOOL bParam1) // Position - 0xFACE (64206)
{
	if (bParam1)
	{
...
int func_269(var uParam0) // Position - 0xFB24 (64292)
{
	if (func_216(uParam0))
	{
...
void func_270(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFB5A (64346)
{
...
void func_271(var uParam0, BOOL bParam1) // Position - 0xFB7A (64378)
{
	func_272(&(uParam0->f_41), bParam1);
	return;
}

void func_272(var uParam0, BOOL bParam1) // Position - 0xFB8C (64396)
{
	int i;
...
void func_273(Object* pobParam0, BOOL bParam1) // Position - 0xFBCA (64458)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_274(var uParam0, BOOL bParam1) // Position - 0xFC05 (64517)
{
	func_275(&(uParam0->f_35), bParam1);
	return;
}

void func_275(var uParam0, BOOL bParam1) // Position - 0xFC17 (64535)
{
	int i;
...
void func_276(Vehicle* pveParam0) // Position - 0xFC54 (64596)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_277(var uParam0, int iParam1) // Position - 0xFC8C (64652)
{
	func_278(&(uParam0->f_28), iParam1);
	return;
}

void func_278(var uParam0, int iParam1) // Position - 0xFC9E (64670)
{
	int i;
...
void func_279(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xFCDF (64735)
{
...
void func_280(Ped* ppedParam0) // Position - 0xFD2F (64815)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_281(int iParam0) // Position - 0xFD70 (64880)
{
	if (*iParam0 == -1)
		return;
...
void func_282(char* sParam0) // Position - 0xFDAD (64941)
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_283(var uParam0) // Position - 0xFDBF (64959)
{
	*uParam0 = -1;
...
void func_284() // Position - 0xFDF2 (65010)
{
