				...
				if (func_233(0))
				{
					if (func_31(func_231(0)))
					{
						for (i = 0; i <= 9; i = i + 1)
						{
							...
							if (func_229(num2))
							{
								if (Global_1654054.f_1352[num2 /*11*/][i] == j + 3 || Global_1654054.f_1186[num2 /*11*/][i] == 1)
								{
									if (func_225(Global_1654054.f_1186[num2 /*11*/][i]))
									{
										func_221(true);
		...
		if (GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("TimerBars"))
		{
			...
			if (bParam32)
			{
				if (iParam34 > 0)
				{
					...
					func_73(uParam2, ehcParam8, ehcParam33, iParam34, Global_1655612.f_884[iParam0 /*2*/]);
				}
			}
...
void func_181(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, const char* sParam7, eHudColour ehcParam8, int iParam9, BOOL bParam10, int iParam11, float fParam12, float fParam13, int iParam14, int iParam15, int iParam16, BOOL bParam17, int iParam18, BOOL bParam19, int iParam20, eHudColour ehcParam21, eHudColour ehcParam22, BOOL bParam23, eHudColour ehcParam24, BOOL bParam25, int iParam26, eHudColour ehcParam27, int iParam28, BOOL bParam29, float fParam30, float fParam31, BOOL bParam32, eHudColour ehcParam33, float fParam34, BOOL bParam35, eHudColour ehcParam36, int iParam37, int iParam38, int iParam39, BOOL bParam40) // Position - 0xBE29
{
	...
	if (func_125())
	{
		...
		if (GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("TimerBars"))
		{
			...
			if (flag)
				if (bParam17)
					func_184(iParam4, iParam5, uParam3, ehcParam8, iParam14, drawOrder, iParam20, &Global_1655612.f_842[iParam0 /*2*/], &Global_1655612.f_863[iParam0 /*2*/], fParam30, fParam31, ehcParam27, iParam28, bParam32, ehcParam33, fParam34, bParam35, ehcParam36, iParam37, bParam40);
				else
					func_182(iParam4, iParam5, uParam3, ehcParam8, iParam14, drawOrder, &Global_1655612.f_842[iParam0 /*2*/], &Global_1655612.f_863[iParam0 /*2*/], iParam18, iParam20, bParam25, iParam26, fParam30, fParam31, ehcParam27, iParam28, bParam32, ehcParam33, fParam34, bParam35, ehcParam36, iParam37, iParam38, bParam40);
...
BOOL func_242() // Position - 0xFE7C
{
	...
	if (func_228() == 0)
		if (Global_2657704[PLAYER::PLAYER_ID() /*463*/].f_232 != 99)
			if (NETWORK::NETWORK_IS_IN_SPECTATOR_MODE() == false && Global_1836590 == 0 && !IS_BIT_SET(Global_2672524.f_1685.f_756, 11) && Global_1853988[PLAYER::PLAYER_ID() /*867*/] != 0)
				return false;
