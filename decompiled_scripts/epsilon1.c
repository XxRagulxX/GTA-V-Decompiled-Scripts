...
BOOL func_44(Ped pedParam0, int iParam1, int iParam2) // Position - 0x19D4 (6612)
{
	...
	else
	{
		...
		Global_80145[1 /*14*/] = { func_97(entityModel, iParam1, unk28[iParam1], -1) };
	
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(pedParam0, func_89(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(pedParam0, func_89(iParam1), Global_80145[1 /*14*/].f_3) > 0)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_89(iParam1), Global_80145[1 /*14*/].f_3, Global_80145[1 /*14*/].f_4, 0);
	}
...
void func_63(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x48BD (18621)
{
	...
	else
	{
		...
		if (epctParam1 == PV_COMP_HEAD)
		{
			...
			if (func_64(ENTITY::GET_ENTITY_MODEL(pedParam0), 14, num, EXTRAMETADATA::GET_HASH_NAME_FOR_PROP(pedParam0, 0, iParam2, iParam3)))
			{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_65(hParam0, iParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_65(hParam0, iParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_65(hParam0, iParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_65(hParam0, iParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
ePedComponentType func_89(int iParam0) // Position - 0x9D03 (40195)
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_90(Hash hParam0, int iParam1) // Position - 0x9DB3 (40371)
{
	int i;
	var unk;
...
struct<17> func_93(Hash hParam0, int iParam1) // Position - 0xA854 (43092)
{
	int i;
	var unk;
...
void func_96(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xC938 (51512)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
struct<14> func_97(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC9A9 (51625)
{
	func_161();
...
BOOL func_162(Ped pedParam0, int iParam1, int iParam2) // Position - 0x20059 (131161)
{
	Hash entityModel;
	int num;
	int i;
	...
	else if (Global_80145[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_89(iParam1)) && Global_80145[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_89(iParam1)))
	{
		return true;
	}
...
void func_172(int iParam0, int iParam1) // Position - 0x20946 (133446)
{
...
void func_244(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28248 (164424)
{
...
int func_359(char* sParam0) // Position - 0x2D759 (186201)
{
...
int func_361(char* sParam0, BOOL bParam1) // Position - 0x2D7D3 (186323)
{
	Hash hashKey;
	int num;
