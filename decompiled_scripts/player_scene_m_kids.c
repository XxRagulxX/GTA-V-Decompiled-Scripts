...
void func_3(Ped pedParam0, int iParam1) // Position - 0x165 (357)
{
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		switch (uLocal_242[iParam1])
		{
				...
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(pedParam0, &uLocal_348, &uLocal_429[iParam1 /*16*/], 2))
				{
					...
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_99222))
					{
						if (!ENTITY::IS_ENTITY_DEAD(iLocal_252[iParam1], false))
						{
							...
							{
								if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_99222) > 0.817f)
								{
						...
						if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_99222) > fLocal_480)
			...
			case 1:
				if (uLocal_248[iParam1] != Global_96898[uLocal_245[iParam1]])
				{
					if (!ENTITY::DOES_ENTITY_EXIST(Global_101638))
					{
						Global_96898[uLocal_245[iParam1]] = 140;
						Global_96914 = uLocal_248[iParam1];
						Global_101638 = pedParam0;
						return;
					}
				
					ENTITY::DOES_ENTITY_EXIST(Global_101638);
				}
				else
				{
		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_99222))
		{
			for (i = 0; i < iLocal_236; i = i + 1)
			{
				if (!PED::IS_PED_INJURED(iLocal_236[i]))
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_236[i], Global_99222, &uLocal_348, &uLocal_429[i /*16*/], 8f, -1000f, 0, 0, 1148846080, 0);
					uLocal_242[i] = 0;
				}
				else
				{
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_252[i], false))
				{
					...
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_252[i], Global_99222, &uLocal_301[i /*16*/], &uLocal_348, 8f, 1090519040, 0, 1148846080);
				}
			}
...
BOOL func_36() // Position - 0x4AD5 (19157)
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_99221))
	{
		...
		{
			if (!PED::IS_PED_INJURED(iLocal_236[i]))
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_236[i], Global_99221, &uLocal_348, &uLocal_396[i /*16*/], 8f, -1000f, 0, 0, 1148846080, 0);
		
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_252[i], false))
			{
				if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_268[i /*16*/]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_252[i], Global_99221, &uLocal_268[i /*16*/], &uLocal_348, 8f, 1090519040, 0, 1148846080);
				}
				else
				{
					if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_252[i]))
		...
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_462))
		{
			...
			if (iLocal_69 == 156)
			{
				_CONVERSATION_INITIALIZE_ACTOR(&uLocal_70, 3, Global_101638, "JIMMY", 0, 1);
...
int func_38(int iParam0, Entity eParam1) // Position - 0x4D8C (19852)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (eParam1 == func_39(Global_101638) && eParam1 != 0)
		{
			Global_101638 = 0;
		}
	}
	...
	switch (iParam1)
	{
		...
		case 9:
			if (iParam2 == 108)
			{
				...
				if (IS_BIT_SET(Global_114370.f_2367.f_539.f_3816[0 /*166*/][num /*11*/][num2 / 32], num2 % 32))
				{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_55(hParam0, iParam2, 14, 3), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_55(hParam0, iParam2, 1, 3), -1842686353, 0);
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 1) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_55(hParam0, iParam2, 14, 4), -1842686353, 1);
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(hParam3, joaat("HAT"), 0) || EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_55(hParam0, iParam2, 1, 4), -1842686353, 0);
					}
					break;
			}
			break;
...
int func_84(int iParam0) // Position - 0x10279 (66169)
{
	switch (iParam0)
	{
		case -1:
...
void func_85(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1034D (66381)
{
	int num;
	int num2;
	Hash outfit;
...
void func_86(int iParam0) // Position - 0x105D4 (67028)
{
	BOOL flag;
	int num;
	var unk;
...
void func_87(int iParam0) // Position - 0x1072B (67371)
{
	BOOL flag;
	int num;
	var unk;
...
void func_88(int iParam0) // Position - 0x10C39 (68665)
{
	BOOL flag;
	int num;
	var unk;
...
void func_89(int iParam0) // Position - 0x10CAE (68782)
{
	BOOL flag;
	int num;
	var unk;
...
void func_90(int iParam0) // Position - 0x10D22 (68898)
{
	BOOL flag;
	int num;
	var unk;
...
void func_91(int iParam0) // Position - 0x10E09 (69129)
{
	BOOL flag;
	int num;
	var unk;
...
void func_92(int iParam0) // Position - 0x1116C (69996)
{
	BOOL flag;
	int num;
	var unk;
...
void func_93(int iParam0) // Position - 0x1137D (70525)
{
	BOOL flag;
	int num;
	var unk;
...
void func_94(int iParam0) // Position - 0x115AD (71085)
{
	BOOL flag;
	int num;
	var unk;
...
void func_95(int iParam0) // Position - 0x116BD (71357)
{
	BOOL flag;
	int num;
	var unk;
...
void func_96(int iParam0) // Position - 0x1205C (73820)
{
	BOOL flag;
	int num;
	var unk;
...
void func_97(int iParam0) // Position - 0x12BCF (76751)
{
	if (iParam0 < 136)
		func_99(iParam0);
	else
...
void func_98(int iParam0) // Position - 0x12C04 (76804)
{
	BOOL flag;
	int num;
	var unk;
...
void func_99(int iParam0) // Position - 0x13808 (79880)
{
	BOOL flag;
	int num;
	var unk;
...
void func_100(int iParam0) // Position - 0x14716 (83734)
{
	BOOL flag;
	int num;
	var unk;
...
void func_101(int iParam0) // Position - 0x14843 (84035)
{
	BOOL flag;
	int num;
	var unk;
...
void func_102(int iParam0, int iParam1) // Position - 0x14941 (84289)
{
	switch (iParam0)
	{
		case 0:
...
void func_103(int iParam0) // Position - 0x14A31 (84529)
{
	BOOL flag;
	int num;
	var unk;
...
void func_104(int iParam0) // Position - 0x15F22 (89890)
{
	BOOL flag;
	int num;
	var unk;
...
void func_105(int iParam0) // Position - 0x16073 (90227)
{
	BOOL flag;
	int num;
	var unk;
...
void func_106(int iParam0) // Position - 0x1657E (91518)
{
	BOOL flag;
	int num;
	var unk;
...
void func_107(int iParam0) // Position - 0x16BEC (93164)
{
	BOOL flag;
	int num;
	var unk;
...
void func_108(int iParam0) // Position - 0x16C60 (93280)
{
	BOOL flag;
	int num;
	var unk;
...
void func_109(int iParam0) // Position - 0x16D30 (93488)
{
	BOOL flag;
	int num;
	var unk;
...
void func_110(int iParam0) // Position - 0x17260 (94816)
{
	BOOL flag;
	int num;
	var unk;
...
void func_111(int iParam0) // Position - 0x173F7 (95223)
{
	BOOL flag;
	int num;
	var unk;
...
void func_112(int iParam0) // Position - 0x17BF5 (97269)
{
	BOOL flag;
	int num;
	var unk;
...
void func_113(int iParam0) // Position - 0x17D05 (97541)
{
	BOOL flag;
	int num;
	var unk;
...
int func_140(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x21ABC (137916)
{
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_79551[1 /*14*/] = { func_70(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_79551[1 /*14*/].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_79551[1 /*14*/] = { func_70(entityModel, 14, unk18[j], -1) };
							func_157(pedParam0, Global_79551[1 /*14*/].f_12, Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4);
							func_163(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_50(i), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_50(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_50(i), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, iParam4);
			...
			{
				Global_79551[1 /*14*/] = { func_70(entityModel, i, func_147(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_79551[1 /*14*/] = { func_70(entityModel, 14, unk59[j], -1) };
			func_157(pedParam0, Global_79551[1 /*14*/].f_12, Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4);
			func_163(14);
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_50(iParam1), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_50(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_50(iParam1), Global_79551[1 /*14*/].f_3, Global_79551[1 /*14*/].f_4, iParam4);
...
BOOL func_141(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x222CD (139981)
{
	...
	{
		if (!func_49(pedParam0, Global_114370.f_2367.f_539[num /*65*/].f_64, Global_114370.f_2367.f_539[num /*65*/].f_63))
		{
...
BOOL func_146(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x22539 (140601)
{
	...
	{
		if (!func_49(pedParam0, Global_114370.f_2367.f_539[num /*65*/].f_61, Global_114370.f_2367.f_539[num /*65*/].f_60) || iParam3 == 1)
		{
...
void func_157(Ped pedParam0, ePedComponentType epctParam1, int iParam2, int iParam3) // Position - 0x241F6 (147958)
{
	...
	else
	{
		...
		if (epctParam1 == PV_COMP_HEAD)
		{
			...
			if (func_158(ENTITY::GET_ENTITY_MODEL(pedParam0), 14, num, EXTRAMETADATA::GET_HASH_NAME_FOR_PROP(pedParam0, 0, iParam2, iParam3)))
			{
...
BOOL func_184(var uParam0) // Position - 0x284DB (165083)
{
	...
	num = Global_114370.f_2367.f_539.f_4323;
	entityCoords = { Global_114370.f_2367.f_539.f_2300[num /*3*/] };
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_114370.f_2367.f_539.f_2310[0];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_188(Global_114370.f_2367.f_539.f_2314[0]), 32);
			return true;
	
		case 6:
			*uParam1 = Global_114370.f_2367.f_539.f_2310[1];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_188(Global_114370.f_2367.f_539.f_2314[1]), 32);
			return true;
	
		case 7:
			*uParam1 = Global_114370.f_2367.f_539.f_2310[2];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_188(Global_114370.f_2367.f_539.f_2314[2]), 32);
			return true;
