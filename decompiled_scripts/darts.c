...
void func_39(int iParam0) // Position - 0x478E (18318)
{
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x6FEC (28652)
{
	uParam0->f_1 = 0;
	return;
}
...
void func_114(Any* panParam0) // Position - 0x750D (29965)
{
	int i;
...
void func_120(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, const char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15) // Position - 0x77FF (30719)
{
	int num;
	int i;
	...
	if (num > -1)
	{
		Global_1679155.f_1 = 1;
		func_32(3, num);
		Global_1679155.f_2872[num] = uParam0;
...
BOOL func_161(var uParam0, int iParam1, BOOL bParam2) // Position - 0xB3E4 (46052)
{
	if (iParam1 == -1)
		return true;
...
void func_162(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB442 (46146)
{
	if (uParam0->f_1 == 0)
	{
...
void func_361(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x1B9C1 (113089)
{
	...
	if (bParam3)
	{
		...
		{
			func_390(Global_24546.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, 0, false, 0);
		...
		if (i == 1 || !Global_24546.f_6331)
		{
			...
			for (j = 0; j <= num43; j = j + 1)
			{
				...
				if (flag && i == 1 && flag2)
				{
					...
					func_388("CommonMenu", "Gradient_Nav", Global_24543 + (iParam5 * 0.5f), num40 + num45 + (0.00277776f * (float)num5) + (num37 * 0.5f), iParam5, num37, 0f, r2, g2, b2, a2, false, 0);
								...
								if (flag2)
								{
									if (!Global_24546.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_24546.f_79[num16 /*6*/]) != 0)
										{
											...
											func_373(flag, Global_24546.f_1616[num16], Global_24546.f_1873[num16], flag7, num46, flag5, flag4);
...
BOOL func_394(BOOL bParam0, BOOL bParam1) // Position - 0x1FD66 (130406)
{
	...
	if (!CAM::IS_SCREEN_FADED_IN() || func_396(8, -1) && func_395() != 65 || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_80566 || Global_24546.f_9243 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_102506.f_1514)
		return false;
...
int func_398(int* piParam0, int iParam1, int iParam2) // Position - 0x1FECE (130766)
{
	...
	if (func_419(0) == 1 && Global_4521271 == iParam1)
	{
		if (!func_444(piParam0))
		{
			func_399(piParam0);
...
void func_404(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x201A4 (131492)
{
	...
	Global_24546.f_9237[0] = iParam1;
	Global_24546.f_9237[1] = iParam2;
...
void func_405(int iParam0, int iParam1, BOOL bParam2) // Position - 0x201D2 (131538)
{
	...
	Global_24546.f_4469[Global_24546.f_5825] = iParam1;
