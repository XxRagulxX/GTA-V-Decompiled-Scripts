	...
	while (true)
	{
		...
		switch (iLocal_25)
		{
			case 0:
				if (uLocal_16[0])
				{
					TEXT_LABEL_ASSIGN_STRING(&Global_22964[1 /*42*/], "CL_C1A" /*Killer photo*/, 16);
					TEXT_LABEL_ASSIGN_STRING(&(Global_22964[1 /*42*/].f_4), "CL_C1A_BR" /*Kill some gang members and take a photo of the corpses.*/, 16);
					Global_22964[1 /*42*/].f_8 = 0;
					Global_22964[1 /*42*/].f_9 = 2;
					TEXT_LABEL_ASSIGN_STRING(&Global_22964[1 /*42*/].f_10[1 /*4*/], "CL_C1A_J1" /*Gang members killed ~1~/~1~*/, 16);
					Global_22964[1 /*42*/].f_37[1] = false;
					Global_22964[1 /*42*/].f_32[1] = 3;
					Global_22964[1 /*42*/].f_27[1] = 0;
					TEXT_LABEL_ASSIGN_STRING(&Global_22964[1 /*42*/].f_10[2 /*4*/], "CL_C1A_J2" /*Photos taken of dead gang members ~1~/~1~*/, 16);
					Global_22964[1 /*42*/].f_37[2] = false;
					Global_22964[1 /*42*/].f_32[2] = 3;
					Global_22964[1 /*42*/].f_27[2] = 0;
				
					for (iLocal_20 = 0; iLocal_20 < Global_22964[1 /*42*/].f_32[1]; iLocal_20 = iLocal_20 + 1)
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(uLocal_21[iLocal_20]))
						{
							if (PED::IS_PED_INJURED(uLocal_21[iLocal_20]))
							{
								if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_21[iLocal_20], PLAYER::PLAYER_PED_ID(), true))
								{
									...
									{
										Global_22964[1 /*42*/].f_27[1] = Global_22964[1 /*42*/].f_27[1] + 1;
										func_2("CL_C1A_J1" /*Gang members killed ~1~/~1~*/, Global_22964[1 /*42*/].f_27[1], Global_22964[1 /*42*/].f_32[1], 2000, 1);
									...
									if (ENTITY::IS_ENTITY_DEAD(uLocal_21[iLocal_20], false))
									{
										if (!Global_32338[iLocal_20])
										{
											...
											{
												Global_22964[1 /*42*/].f_27[2] = Global_22964[1 /*42*/].f_27[2] + 1;
												func_2("CL_C1A_J2" /*Photos taken of dead gang members ~1~/~1~*/, Global_22964[1 /*42*/].f_27[2], Global_22964[1 /*42*/].f_32[2], 2000, 1);
		...
		switch (iLocal_26)
		{
			case 0:
				if (uLocal_16[1])
				{
					TEXT_LABEL_ASSIGN_STRING(&Global_22964[2 /*42*/], "CL_C1B" /*Bike Pro*/, 16);
					TEXT_LABEL_ASSIGN_STRING(&(Global_22964[2 /*42*/].f_4), "CL_C1B_BR" /*Perform various bike stunts.*/, 16);
					Global_22964[2 /*42*/].f_8 = 0;
					Global_22964[2 /*42*/].f_9 = 3;
					TEXT_LABEL_ASSIGN_STRING(&Global_22964[2 /*42*/].f_10[1 /*4*/], "CL_C1B_J1" /*Hold a wheelie for 200m without crashing.*/, 16);
					Global_22964[2 /*42*/].f_37[1] = false;
					Global_22964[2 /*42*/].f_32[1] = -1;
					Global_22964[2 /*42*/].f_27[1] = -1;
					TEXT_LABEL_ASSIGN_STRING(&Global_22964[2 /*42*/].f_10[2 /*4*/], "CL_C1B_J2" /*Successfully perform a stoppie.*/, 16);
					Global_22964[2 /*42*/].f_37[2] = false;
					Global_22964[2 /*42*/].f_32[2] = -1;
					Global_22964[2 /*42*/].f_27[2] = -1;
					TEXT_LABEL_ASSIGN_STRING(&Global_22964[2 /*42*/].f_10[3 /*4*/], "CL_C1B_J3" /*Perform a 360 flip on a bike.*/, 16);
					Global_22964[2 /*42*/].f_37[3] = false;
			...
			case 1:
				!Global_22964[2 /*42*/].f_37[1];
				!Global_22964[2 /*42*/].f_37[2];
				!Global_22964[2 /*42*/].f_37[3];
			
				if (Global_22964[2 /*42*/].f_37[1] == true && Global_22964[2 /*42*/].f_37[2] == true && Global_22964[2 /*42*/].f_37[3] == true)
				{
...
int func_8() // Position - 0x5A3
{
	...
	while (i < 2)
	{
		if (Global_23133[i /*9*/].f_8 == 0 || Global_23133[i /*9*/].f_8 == 1)
			if (!func_9(Global_23133[i /*9*/].f_2, Global_23133[Global_22963 /*9*/].f_2))
				Global_22963 = i;
