	...
	while (true)
	{
		...
		switch (iLocal_44)
		{
			case 0:
				if (uLocal_35[0])
				{
					TEXT_LABEL_ASSIGN_STRING(&Global_24160[1 /*42*/], "CL_C1A" /*Killer photo*/, 16);
					TEXT_LABEL_ASSIGN_STRING(&(Global_24160[1 /*42*/].f_4), "CL_C1A_BR" /*Kill some gang members and take a photo of the corpses.*/, 16);
					Global_24160[1 /*42*/].f_8 = 0;
					Global_24160[1 /*42*/].f_9 = 2;
					TEXT_LABEL_ASSIGN_STRING(&Global_24160[1 /*42*/].f_10[1 /*4*/], "CL_C1A_J1" /*Gang members killed ~1~/~1~*/, 16);
					Global_24160[1 /*42*/].f_37[1] = false;
					Global_24160[1 /*42*/].f_32[1] = 3;
					Global_24160[1 /*42*/].f_27[1] = 0;
					TEXT_LABEL_ASSIGN_STRING(&Global_24160[1 /*42*/].f_10[2 /*4*/], "CL_C1A_J2" /*Photos taken of dead gang members ~1~/~1~*/, 16);
							...
							if (PED::IS_PED_INJURED(uLocal_40[iLocal_39]))
							{
								if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_40[iLocal_39], PLAYER::PLAYER_PED_ID(), true))
								{
									if (!Global_33883[iLocal_39])
									{
										...
										func_2("CL_C1A_J1" /*Gang members killed ~1~/~1~*/, Global_24160[1 /*42*/].f_27[1], Global_24160[1 /*42*/].f_32[1], 2000, 1);
									...
									if (ENTITY::IS_ENTITY_DEAD(uLocal_40[iLocal_39], false))
									{
										if (!Global_33887[iLocal_39])
										{
											if (MOBILE::CELL_CAM_IS_CHAR_VISIBLE_NO_FACE_CHECK(uLocal_40[iLocal_39]) && func_1())
											{
												...
												func_2("CL_C1A_J2" /*Photos taken of dead gang members ~1~/~1~*/, Global_24160[1 /*42*/].f_27[2], Global_24160[1 /*42*/].f_32[2], 2000, 1);
		...
		switch (iLocal_45)
		{
			case 0:
				if (uLocal_35[1])
				{
					TEXT_LABEL_ASSIGN_STRING(&Global_24160[2 /*42*/], "CL_C1B" /*Bike Pro*/, 16);
					TEXT_LABEL_ASSIGN_STRING(&(Global_24160[2 /*42*/].f_4), "CL_C1B_BR" /*Perform various bike stunts.*/, 16);
					Global_24160[2 /*42*/].f_8 = 0;
					Global_24160[2 /*42*/].f_9 = 3;
					TEXT_LABEL_ASSIGN_STRING(&Global_24160[2 /*42*/].f_10[1 /*4*/], "CL_C1B_J1" /*Hold a wheelie for 200m without crashing.*/, 16);
					Global_24160[2 /*42*/].f_37[1] = false;
					Global_24160[2 /*42*/].f_32[1] = -1;
					Global_24160[2 /*42*/].f_27[1] = -1;
					TEXT_LABEL_ASSIGN_STRING(&Global_24160[2 /*42*/].f_10[2 /*4*/], "CL_C1B_J2" /*Successfully perform a stoppie.*/, 16);
					Global_24160[2 /*42*/].f_37[2] = false;
					Global_24160[2 /*42*/].f_32[2] = -1;
					Global_24160[2 /*42*/].f_27[2] = -1;
					TEXT_LABEL_ASSIGN_STRING(&Global_24160[2 /*42*/].f_10[3 /*4*/], "CL_C1B_J3" /*Perform a 360 flip on a bike.*/, 16);
