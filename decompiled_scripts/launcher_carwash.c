	...
	switch (uParam1->f_13)
	{
		case 0:
			...
			if (func_46(uParam1->f_16))
			{
				for (i = 0; i < *uParam0; i = i + 1)
				{
					if (func_43(&uParam0->[i /*24*/]) && uParam0->[i /*24*/])
					{
						uParam1->f_12 = i;
		...
		case 6:
			...
			if (func_18(&uParam0->[uParam1->f_12 /*24*/]) || !func_46(uParam1->f_16))
			{
				func_42(uParam1, 0);
				return false;
			}
		...
		case 3:
			...
			if (func_18(&uParam0->[uParam1->f_12 /*24*/]) || bParam2 == false || !func_46(uParam1->f_16))
			{
				func_42(uParam1, 0);
				return false;
			}
...
void func_58(int iParam0) // Position - 0x1952
{
	...
	if (!func_43(&iLocal_38[iParam0 /*24*/]))
	{
...
{
	func_72(&iLocal_38[0 /*24*/], 1, "Carwash1", func_73(156), 15, "", 0, 4f);
	func_72(&iLocal_38[1 /*24*/], 1, "Carwash2", func_73(157), 15, "", 0, 4f);
	func_70(&iLocal_38[0 /*24*/], -1f, 0f, 0f, 360f);
	func_70(&iLocal_38[1 /*24*/], 0f, -1f, 0f, 360f);
	func_67(&uLocal_87, 0);
