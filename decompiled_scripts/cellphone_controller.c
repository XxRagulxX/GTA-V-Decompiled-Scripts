...
BOOL func_6(var uParam0, int iParam1) // Position - 0x9F1 (2545)
{
...
void func_24() // Position - 0x13B4 (5044)
{
	...
	switch (Global_21666.f_1)
	{
		case 6:
			...
			if (Global_21654)
			{
				func_53(Global_21647, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205" /*SELECT*/, 0, 0, 0, 0);
				func_53(Global_21647, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206" /*BACK*/, 0, 0, 0, 0);
			}
			else
			{
			...
			else
			{
				if (Global_21900 == true)
					if (Global_21654)
						func_53(Global_21647, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, "CELL_225" /*NEXT*/, 0, 0, 0, 0);
					else
						func_53(Global_21647, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, 0, 0, 0, 0, 0);
				else if (Global_21654)
					func_53(Global_21647, "SET_SOFT_KEYS", 1f, 1f, 3f, -1f, -1f, "CELL_225" /*NEXT*/, 0, 0, 0, 0);
				else
		...
		case 10:
			...
			{
				func_53(Global_21647, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_202" /*END CALL*/, 0, 0, 0, 0);
		...
		case 9:
			if (Global_21665 == 1)
			{
				...
				{
					func_53(Global_21647, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(4), BUILTIN::TO_FLOAT(0), BUILTIN::TO_FLOAT(2), -1f, -1f, &(Global_118[Global_8817 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, "CELL_217" /*INCOMING CALL*/, "CELL_195" /*Unknown*/, 0);
				}
				else
				{
					func_53(Global_21647, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(4), BUILTIN::TO_FLOAT(0), BUILTIN::TO_FLOAT(2), -1f, -1f, &(Global_2349[Global_8817 /*29*/].f_3), &(Global_2349[Global_8817 /*29*/].f_7), "CELL_217" /*INCOMING CALL*/, &(Global_2349[Global_8817 /*29*/].f_3), 0);
				}
			...
			else if (Global_23040 == 4 || Global_23040 == 3)
			{
				...
				else
				{
					...
					if (func_27(Global_8817, Global_21666) == 0)
					{
						...
						func_53(Global_21647, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(4), BUILTIN::TO_FLOAT(0), BUILTIN::TO_FLOAT(3), -1f, -1f, &(Global_118[Global_8817 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, &unk, "CELL_195" /*Unknown*/, 0);
					}
					else
					{
						func_56(Global_21647, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_25() // Position - 0x19CD (6605)
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_21647))
	{
		...
		{
			if (Global_21654)
				func_53(Global_21647, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, "CELL_203" /*ANSWER*/, 0, 0, 0, 0);
			else
			...
			if (Global_23087)
				...
				func_53(Global_21647, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_204" /*REJECT*/, 0, 0, 0, 0);
			else
				func_53(Global_21647, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, 0, 0, 0, 0, 0);
...
int func_27(int iParam0, eCharacter echParam1) // Position - 0x1B8C (7052)
{
...
BOOL func_45(var uParam0) // Position - 0x21DD (8669)
{
	int i;
...
BOOL _SEND_TEXT_MESSAGE_FROM_CHARACTER_2(eCharacter echParam0, char* sParam1, int iParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7, var uParam8, var uParam9) // Position - 0x455A (17754)
{
	int num;
	char* str;
	int num2;
...
int func_89(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, BOOL bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x45FC (17916)
{
	int num;
	int num2;
	...
	Global_114990.f_14150[Global_24108 /*104*/].f_26 = uParam8;
	Global_114990.f_14150[Global_24108 /*104*/].f_29 = uParam9;
	Global_114990.f_14150[Global_24108 /*104*/].f_30 = uParam12;
	Global_114990.f_14150[Global_24108 /*104*/].f_31 = uParam11;
...
var func_128(int iParam0, var uParam1) // Position - 0x6652 (26194)
{
	Vector3 vector;
...
BOOL func_154(int iParam0) // Position - 0xA7C5 (42949)
{
