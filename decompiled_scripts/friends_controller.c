...
int func_110(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x4843 (18499)
{
	...
	if (iParam5 == 0)
	{
		Global_80088[1 /*14*/] = { func_162(entityModel, iParam1, iParam2, -1) };
...
{
	Global_80088[1 /*14*/] = { func_162(hParam0, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_226(pedParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_80088[2 /*14*/].f_12 == j)
										if (func_226(pedParam0, 14, k))
											if (!func_116(entityModel, iParam2, 14, k, &unk, &Global_80088[2 /*14*/]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_80088[2 /*14*/] = { func_162(entityModel, i, num, -1) };
					
						if (!func_116(entityModel, iParam2, i, num, &unk, &Global_80088[2 /*14*/]))
							return false;
					}
				}
			}
...
void func_337(eCharacter echParam0, char* sParam1, BOOL bParam2, var uParam3) // Position - 0x28189 (164233)
{
	eCharacter character;
...
var func_338(Player plParam0) // Position - 0x28224 (164388)
{
...
void func_377(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x29B65 (170853)
{
	func_378(sParam0, sParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9);
	return;
}

void func_378(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x29B85 (170885)
{
	int i;
...
var func_383() // Position - 0x29FBE (171966)
{
	var unk;
