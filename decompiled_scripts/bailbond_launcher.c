...
void func_197(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xCC0D (52237)
{
...
float func_242(var uParam0) // Position - 0xEC75 (60533)
{
	if (func_245(uParam0))
		if (func_244(uParam0))
			return uParam0->f_2;
...
BOOL func_244(var uParam0) // Position - 0xED09 (60681)
{
	return IS_BIT_SET(*uParam0, 2);
}

BOOL func_245(var uParam0) // Position - 0xED16 (60694)
{
