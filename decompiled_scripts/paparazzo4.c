...
struct<10> func_79(Hash hParam0, int iParam1) // Position - 0x9A5A (39514)
{
	int i;
	var unk;
...
struct<17> func_82(Hash hParam0, int iParam1) // Position - 0xA4FB (42235)
{
	int i;
	var unk;
...
void func_85(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xC5E0 (50656)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
struct<14> func_86(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC651 (50769)
{
	func_150();
...
BOOL func_151(Ped pedParam0, int iParam1, int iParam2) // Position - 0x20107 (131335)
{
	Hash entityModel;
	int num;
	int i;
...
void func_161(int iParam0, int iParam1) // Position - 0x209F6 (133622)
{
...
void func_252(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28A8A (166538)
{
