...
void main() // Position - 0x0 (0)
{
	...
	sLocal_106 = "idle";
	sLocal_107 = "MM_LETREAD" /*Press ~INPUT_SCRIPT_PAD_RIGHT~ to read the letter.*/;
	sLocal_108 = "MM_LETCANC" /*Press ~INPUT_SCRIPT_PAD_RIGHT~ to stop reading.*/;
...
var func_41(var uParam0) // Position - 0x460F (17935)
{
	return uParam0;
}
