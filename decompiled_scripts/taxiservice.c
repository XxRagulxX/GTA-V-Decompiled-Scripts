		...
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_131))
		{
			if (iLocal_968 != 0)
			{
				...
				if (bLocal_77)
				{
					uLocal_833 = { func_85() };
					func_83(&uLocal_132);
					func_82(0, 75, "TXM_EXIT" /*Exit*/, &uLocal_132, false, 402, false);
				
					if (iLocal_110 > 1)
						func_82(2, 218, "TXM_CDES" /*Change Destination*/, &uLocal_132, false, 402, false);
				
					if (!bLocal_79)
					{
						if (iLocal_110 > 0)
							func_82(2, 176, "TXM_SLCT" /*Choose Destination*/, &uLocal_132, false, 402, false);
					}
					else if (iLocal_968 == 2)
					{
						func_82(2, 177, "TXM_STOP" /*Stop*/, &uLocal_132, false, 402, false);
					
						if (bLocal_78)
							func_82(2, 176, "TXM_SLCT" /*Choose Destination*/, &uLocal_132, false, 402, false);
					
						if (func_81())
							func_82(2, 176, "TXM_SKIP" /*Skip (Extra Cost)*/, &uLocal_132, false, 402, false);
					
						if (!bLocal_83)
							func_82(2, 179, "TXM_HURY" /*Hurry*/, &uLocal_132, false, 402, false);
					}
					else if (iLocal_968 == 3)
					{
						func_82(2, 177, "TXM_STRT" /*Start*/, &uLocal_132, false, 402, false);
	...
	switch (iLocal_970)
	{
		...
		case 3:
			if (Global_80378 == -1)
			{
				...
				iLocal_842 = func_115(blLocal_60);
			
				if (iLocal_842 != -1)
					func_117(iLocal_842, true);
		...
		case 6:
			...
			if (iLocal_842 != -1)
			{
				...
				if (Global_93274[iLocal_842 /*34*/].f_13 == -1 && Global_93274[iLocal_842 /*34*/].f_14 == -1)
					flag2 = false;
			
				if (flag2)
					if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_MICHAEL && !IS_BIT_SET(Global_93274[iLocal_842 /*34*/].f_15, 8) || _GET_CURRENT_PLAYER_CHARACTER() == CHAR_FRANKLIN && !IS_BIT_SET(Global_93274[iLocal_842 /*34*/].f_15, 9) || _GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR && !IS_BIT_SET(Global_93274[iLocal_842 /*34*/].f_15, 10))
						flag2 = false;
			
				if (flag2)
					if (func_110(Global_93274[iLocal_842 /*34*/].f_13, Global_93274[iLocal_842 /*34*/].f_14))
						flag2 = false;
			
				if (flag2)
					CLOCK::ADVANCE_CLOCK_TIME_TO(Global_93274[iLocal_842 /*34*/].f_13, 0, 0);
			}
		...
		case 9:
			...
			{
				if (!Global_99414 && iLocal_842 != -1 && iLocal_842 != 72 && iLocal_842 != 87)
					func_116(iLocal_842);
...
void func_113(int iParam0) // Position - 0x610B (24843)
{
	if (func_114(iParam0))
	{
		Global_99409 = iParam0;
		Global_99413 = true;
		return;
	}
...
BOOL func_114(int iParam0) // Position - 0x612A (24874)
{
	switch (iParam0)
	{
		case 67:
...
int func_115(Blip blParam0) // Position - 0x6189 (24969)
{
	int i;
...
void func_116(int iParam0) // Position - 0x61E3 (25059)
{
	if (Global_99408 != -1)
	{
...
void func_117(int iParam0, BOOL bParam1) // Position - 0x6207 (25095)
{
	if (bParam1)
...
int func_120() // Position - 0x63A2 (25506)
{
	return Global_80625;
}

BOOL func_121(int iParam0) // Position - 0x63AE (25518)
{
	int i;
...
int func_212(var uParam0) // Position - 0xF2FB (62203)
{
	int i;
