...
BOOL func_234(int iParam0, Entity eParam1) // Position - 0xEA0C (59916)
{
	int i;
...
void func_277(int iParam0, Entity eParam1, BOOL bParam2) // Position - 0x145D5 (83413)
{
	int i;
	BOOL flag;
...
void func_426(var uParam0, var uParam1) // Position - 0x201EF (131567)
{
	func_436(uParam0, 0, "HEIST_FINALE", "BOARD6", "FHFAUD", "CRWAUD", 1, 1, 3, 4, uParam1, 96.47825f, -1292.3529f, 29.768753f, 5f, 5.5f, 6f);
...
void func_436(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, var uParam10, float fParam11, float fParam12, float fParam13, float fParam14, float fParam15, float fParam16) // Position - 0x20A56 (133718)
{
	uParam0->f_1 = iParam1;
...
var func_437(var uParam0, var uParam1) // Position - 0x20AC2 (133826)
{
	if (uParam0 > uParam1)
		return uParam0;
