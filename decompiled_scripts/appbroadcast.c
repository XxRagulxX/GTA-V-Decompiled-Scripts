...
void main() // Position - 0x0 (0)
{
	...
	fLocal_41 = 140f;
	fLocal_42 = 180f;
	TEXT_LABEL_ASSIGN_STRING(&uLocal_47, "CELL_212" /*YES*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_51, "CELL_213" /*NO*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_55, "CELL_39" /*Broadcast*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_59, "CELL_MP_300" /*Activate?*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_63, "CELL_MP_301" /*Deactivate?*/, 16);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_67, "CELL_MP_302" /*Unavailable*/, 16);
