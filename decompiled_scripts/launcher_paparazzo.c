...
void func_212(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDCB3 (56499)
{
...
BOOL func_214(Any* panParam0, BOOL bParam1) // Position - 0xDDA4 (56740)
{
	...
	if (func_251(*panParam0) || func_249(*panParam0) || Global_80608 == 1)
		return true;
...
int func_262(var uParam0, eCharacter echParam1) // Position - 0x10045 (65605)
{
	int num;
