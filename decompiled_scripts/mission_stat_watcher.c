			...
			if (Global_63478 || bLocal_636)
			{
				...
				if (!(bLocal_635 == Global_63479))
				{
					...
					if (Global_63488)
					{
						...
						if (num == 69 || num == 70)
							func_96(&uLocal_43, 3, "ACTATAKE_AG", "", Global_113810.f_1.f_126[Global_63489 /*23*/], 0, 0, 0);
						else
							func_96(&uLocal_43, 3, "POTATAKE", "", Global_113810.f_1.f_126[Global_63489 /*23*/], 0, 0, 0);
					
						j = 0;
					
						for (j = 0; j < Global_97043[Global_63489 /*38*/].f_37; j = j + 1)
						{
							if (Global_97043[Global_63489 /*38*/].f_31[j] > 0)
								func_96(&uLocal_43, 3, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(Global_97043[Global_63489 /*38*/].f_25[j]), "", -1 * Global_97043[Global_63489 /*38*/].f_31[j], 0, 0, 0);
						}
					
						if (Global_113810.f_1.f_126[Global_63489 /*23*/].f_2[0] > 0 || num == 74 || num == 75 || num == 69 || num == 70)
							func_96(&uLocal_43, 3, "ACTATAKE_M", "", Global_113810.f_1.f_126[Global_63489 /*23*/].f_2[0], 0, 0, 0);
					
						if (Global_113810.f_1.f_126[Global_63489 /*23*/].f_2[1] > 0 || num == 74 || num == 75)
							func_96(&uLocal_43, 3, "ACTATAKE_F", "", Global_113810.f_1.f_126[Global_63489 /*23*/].f_2[1], 0, 0, 0);
					
						if (Global_113810.f_1.f_126[Global_63489 /*23*/].f_2[2] > 0 || num == 74 || num == 75)
							func_96(&uLocal_43, 3, "ACTATAKE_T", "", Global_113810.f_1.f_126[Global_63489 /*23*/].f_2[2], 0, 0, 0);
						...
						for (j = 0; j < Global_96842[num2 /*19*/]; j = j + 1)
						{
							if (!func_92(Global_113810.f_1.f_12[num2 /*6*/][j]))
								num3 = num3 + Global_113810.f_1.f_126[Global_63489 /*23*/].f_17[j];
							else
								value2 = value2 + Global_113810.f_1.f_126[Global_63489 /*23*/].f_17[j];
						}
...
BOOL func_62() // Position - 0x36C1
{
	...
	{
		if (Global_75581[i /*9*/] > 0)
			if (Global_63710[Global_75581[i /*9*/] /*13*/].f_7 == false)
				return 1;
	}
...
void func_71() // Position - 0x3C86
{
	...
	for (i = 0; i < Global_75580; i = i + 1)
	{
		num3 = Global_75581[i /*9*/];
		flag = !Global_63710[num3 /*13*/].f_7;
		flag2 = Global_63710[num3 /*13*/].f_8;
		unk = Global_63710[num3 /*13*/].f_12;
		unk2 = Global_63710[num3 /*13*/].f_9;
		flag3 = false;
		flag3 = false;
	
		if (func_76(num3, Global_75581[i /*9*/].f_1))
			flag3 = true;
	...
	if (NETWORK::NETWORK_IS_SIGNED_ONLINE())
	{
		if (Global_75730 == false)
		{
			...
			Global_113810.f_9088.f_330[num6 /*6*/].f_4 = Global_75726;
		}
		else
		{
...
int func_74(int iParam0) // Position - 0xB8EA
{
	...
	switch (iParam0)
	{
		...
		case 676:
			for (i = 0; i < 5; i = i + 1)
			{
				if (Global_113810.f_1.f_126[Global_63489 /*23*/].f_11[i] == 1)
					num = num + Global_113810.f_1.f_126[Global_63489 /*23*/].f_17[i];
			}
...
BOOL func_88(var uParam0, int iParam1) // Position - 0xBF5B
{
	...
	num3 = { Global_63710[Global_75581[iParam1 /*9*/] /*13*/] };
	...
	if (!(num3.f_2 == 0))
	{
		num2 = SYSTEM::TO_FLOAT(SYSTEM::FLOOR((SYSTEM::TO_FLOAT(Global_75581[iParam1 /*9*/].f_1) / SYSTEM::TO_FLOAT(num3.f_2)) * 100f));
	...
	if (Global_75581[iParam1 /*9*/].f_3 == 0 || flag)
		if (num3.f_3)
			if (num4 > Global_75581[iParam1 /*9*/].f_1 || num4 < 0 || num4 == -1)
				func_90(Global_75581[iParam1 /*9*/].f_1, Global_75581[iParam1 /*9*/]);
		else if (Global_75581[iParam1 /*9*/].f_1 > num4 || num4 < 0 || num4 == -1)
			func_90(Global_75581[iParam1 /*9*/].f_1, Global_75581[iParam1 /*9*/]);

	num5 = Global_75581[iParam1 /*9*/].f_1;
	...
	str = AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(Global_75581[iParam1 /*9*/]);
	...
	if (Global_75581[iParam1 /*9*/].f_3 != 0)
	{
		...
		func_96(uParam0, 6, str, str2, Global_75581[iParam1 /*9*/].f_1, 0, 3, 0);
	}
	else
	{
		iLocal_630 = 0;
		...
		{
			case 1:
				func_96(uParam0, 8, str, "", Global_75581[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 2:
				func_96(uParam0, 9, str, "", Global_75581[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 3:
				func_96(uParam0, 0, str, "", Global_75581[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
			...
			case 5:
				func_96(uParam0, 11, str, "", SYSTEM::CEIL((SYSTEM::TO_FLOAT(Global_75581[iParam1 /*9*/].f_1) / SYSTEM::TO_FLOAT(num3.f_2)) * 100f), 0, num6, 0);
				break;
			...
			case 8:
				num7 = Global_75581[iParam1 /*9*/].f_1;
			...
			case 9:
				func_96(uParam0, 11, str, "", SYSTEM::ROUND(Global_75581[iParam1 /*9*/].f_2), 0, num6, 0);
				break;
		
			case 10:
			case 15:
			case 16:
				func_96(uParam0, 1, str, "", Global_75581[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 11:
				func_96(uParam0, 11, str, "", Global_75581[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 14:
				func_96(uParam0, 12, str, "", Global_75581[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
		
			case 12:
			case 13:
				func_96(uParam0, 3, str, "", Global_75581[iParam1 /*9*/].f_1, 0, num6, 0);
				break;
...
void func_90(int iParam0, int iParam1) // Position - 0xD60D
{
	...
	statName = Global_63710[iParam1 /*13*/].f_4;
...
void func_98(int iParam0) // Position - 0xD824
{
	...
	num2 = Global_113810.f_1.f_126[iParam0 /*23*/].f_1;
	...
	for (i = 0; i < 5; i = i + 1)
	{
		Global_113810.f_1.f_126[iParam0 /*23*/].f_17[i] = 0;
	}

	i = 0;
	num3 = 0;

	for (i = 0; i < Global_97043[iParam0 /*38*/].f_37; i = i + 1)
	{
		if (Global_97043[iParam0 /*38*/].f_31[i] > 0)
		{
			num3 = num3 + Global_97043[iParam0 /*38*/].f_31[i];
			Global_113810.f_1.f_126[iParam0 /*23*/].f_1 = Global_113810.f_1.f_126[iParam0 /*23*/].f_1 - Global_97043[iParam0 /*38*/].f_31[i];
		}
	}
	...
	if (iParam0 == 2)
	{
		num4 = SYSTEM::FLOOR(SYSTEM::TO_FLOAT(Global_113810.f_1.f_126[iParam0 /*23*/].f_1) * 0.78f);
		func_100(iParam0, 3, num4);
		Global_113810.f_1.f_126[iParam0 /*23*/].f_1 = Global_113810.f_1.f_126[iParam0 /*23*/].f_1 - num4;
		num2 = num2 - num4;
	}

	for (i = 0; i < 5; i = i + 1)
	{
		num5 = Global_113810.f_1.f_12[num /*6*/][i];
	
		switch (Global_113810.f_1.f_126[iParam0 /*23*/].f_11[i])
		{
			case 1:
			case 2:
			case 0:
				Global_113810.f_1.f_126[iParam0 /*23*/].f_17[i] = SYSTEM::CEIL(SYSTEM::TO_FLOAT(Global_96688[num5 /*5*/].f_1) * 0.01f * (float)Global_113810.f_1.f_126[iParam0 /*23*/].f_1);
				break;
		
			case 3:
				Global_113810.f_1.f_126[iParam0 /*23*/].f_17[i] = SYSTEM::CEIL(SYSTEM::TO_FLOAT(Global_96688[num5 /*5*/].f_1) * 0.015f * (float)Global_113810.f_1.f_126[iParam0 /*23*/].f_1);
				break;
		}
	}
	...
	{
		num2 = num2 - Global_113810.f_1.f_126[iParam0 /*23*/].f_17[i];
	}
	...
	switch (iParam0)
	{
		case 0:
			...
			Global_113810.f_1.f_126[0 /*23*/].f_2[1] = SYSTEM::CEIL(0.12f * (float)Global_113810.f_1.f_126[iParam0 /*23*/].f_1);
			num2 = num2 - Global_113810.f_1.f_126[0 /*23*/].f_2[1];
			Global_97033.f_7 = SYSTEM::CEIL(0.14f * (float)Global_113810.f_1.f_126[iParam0 /*23*/].f_1);
			num2 = num2 - Global_97033.f_7;
			Global_97033.f_6 = 14f;
			Global_113810.f_1.f_126[0 /*23*/].f_2[0] = num2;
			break;
		...
		case 2:
			...
			Global_97033.f_7 = SYSTEM::CEIL(0.12f * (float)Global_113810.f_1.f_126[iParam0 /*23*/].f_1);
			num2 = num2 - Global_97033.f_7;
			Global_97033.f_6 = 12f;
			Global_113810.f_1.f_126[2 /*23*/].f_2[0] = num2 / 3;
			Global_113810.f_1.f_126[2 /*23*/].f_2[1] = num2 / 3;
			Global_113810.f_1.f_126[2 /*23*/].f_2[2] = num2 / 3;
			Global_97033.f_6 = 0f;
			break;
		...
		case 3:
			...
			num2 = num2 - Global_97033.f_7;
			Global_97033.f_6 = 12f;
			Global_113810.f_1.f_126[3 /*23*/].f_2[1] = num2;
			break;
		...
		case 4:
			...
			num2 = num2 - Global_97033.f_7;
			Global_97033.f_6 = 12f;
			Global_113810.f_1.f_126[4 /*23*/].f_2[0] = num2 / 3;
			Global_113810.f_1.f_126[4 /*23*/].f_2[1] = num2 / 3;
			Global_113810.f_1.f_126[4 /*23*/].f_2[2] = num2 / 3;
			Global_97033.f_6 = 0f;
			break;
	}

	value = Global_113810.f_1.f_126[iParam0 /*23*/].f_1;

	if (Global_113810.f_1.f_126[iParam0 /*23*/].f_6[0] != -1f)
		Global_113810.f_1.f_126[iParam0 /*23*/].f_6[0] = (SYSTEM::TO_FLOAT(Global_113810.f_1.f_126[iParam0 /*23*/].f_2[0]) / SYSTEM::TO_FLOAT(value)) * 100f;

	if (Global_113810.f_1.f_126[iParam0 /*23*/].f_6[1] != -1f)
		Global_113810.f_1.f_126[iParam0 /*23*/].f_6[1] = (SYSTEM::TO_FLOAT(Global_113810.f_1.f_126[iParam0 /*23*/].f_2[1]) / SYSTEM::TO_FLOAT(value)) * 100f;

	if (Global_113810.f_1.f_126[iParam0 /*23*/].f_6[2] != -1f)
		Global_113810.f_1.f_126[iParam0 /*23*/].f_6[2] = (SYSTEM::TO_FLOAT(Global_113810.f_1.f_126[iParam0 /*23*/].f_2[2]) / SYSTEM::TO_FLOAT(value)) * 100f;
	...
	for (j = 0; j < 3; j = j + 1)
	{
		num6 = num6 + Global_113810.f_1.f_126[iParam0 /*23*/].f_2[j];
	}

	switch (iParam0)
	{
		case 0:
			func_99(810, Global_113810.f_1.f_126[iParam0 /*23*/].f_1, true);
		...
		case 1:
			...
			{
				case 3:
					func_99(610, Global_113810.f_1.f_126[iParam0 /*23*/].f_1, true);
					func_99(611, num6, true);
					break;
			
				case 4:
					func_99(622, Global_113810.f_1.f_126[iParam0 /*23*/].f_1, true);
		...
		case 2:
			func_99(734, Global_113810.f_1.f_126[iParam0 /*23*/].f_1, true);
		...
		case 4:
			...
			{
				case 8:
					func_99(664, Global_113810.f_1.f_126[iParam0 /*23*/].f_1, true);
					func_99(671, num6, true);
					break;
			
				case 9:
					func_99(674, Global_113810.f_1.f_126[iParam0 /*23*/].f_1, true);
...
void func_100(int iParam0, int iParam1, int iParam2) // Position - 0xE1CF
{
	...
	num2 = Global_97043[iParam0 /*38*/].f_37;
	i = 0;

	for (i = 0; i < num2; i = i + 1)
	{
		if (Global_97043[iParam0 /*38*/].f_25[i] == iParam1)
		{
			Global_97043[iParam0 /*38*/].f_25[i] = iParam1;
			Global_97043[iParam0 /*38*/].f_31[i] = num;
			return;
		}
	}
	...
	Global_97043[iParam0 /*38*/].f_31[Global_97043[iParam0 /*38*/].f_37] = num;
	Global_97043[iParam0 /*38*/].f_37 = Global_97043[iParam0 /*38*/].f_37 + 1;
	return;
}
...
void func_102() // Position - 0xE3AF
{
	...
	{
		if (Global_75581[i /*9*/].f_1 == 0)
			if (Global_75581[i /*9*/].f_2 != 0f)
				Global_75581[i /*9*/].f_1 = SYSTEM::FLOOR(Global_75581[i /*9*/].f_2);
	
		num = Global_75581[i /*9*/];
	
		if (num > 0)
		{
			if (Global_63710[num /*13*/] == 9)
				Global_75581[i /*9*/].f_1 = SYSTEM::ROUND(fLocal_632);
		
			if (Global_63710[num /*13*/] == 15)
				Global_75581[i /*9*/].f_1 = iLocal_633;
		}
	}
...
void func_107() // Position - 0xE5B1
{
	...
	for (i = 0; i < Global_75580; i = i + 1)
	{
		if (Global_75581[i /*9*/] >= 0)
		{
			num = Global_63710[Global_75581[i /*9*/] /*13*/];
		
			switch (num)
			{
				case 6:
					if (Global_75581[i /*9*/].f_6 != 0)
					{
						if (Global_75581[i /*9*/].f_7 == 1)
						{
							Global_75581[i /*9*/].f_8 = 0;
							Global_75581[i /*9*/].f_1 = 0;
							Global_75581[i /*9*/].f_7 = 0;
						}
						else if (ENTITY::DOES_ENTITY_EXIST(Global_75581[i /*9*/].f_6))
						{
							if (!ENTITY::IS_ENTITY_DEAD(Global_75581[i /*9*/].f_6, false))
							{
								iLocal_628 = Global_75581[i /*9*/].f_8;
								iLocal_627 = ENTITY::GET_ENTITY_HEALTH(Global_75581[i /*9*/].f_6);
								iLocal_629 = iLocal_628 - iLocal_627;
							
								if (iLocal_629 > 0)
								{
									Global_75581[i /*9*/].f_1 = Global_75581[i /*9*/].f_1 + iLocal_629;
								
									if (Global_75581[i /*9*/].f_1 < 0)
										Global_75581[i /*9*/].f_1 = Global_75581[i /*9*/].f_1 * -1;
								}
							
								Global_75581[i /*9*/].f_8 = iLocal_627;
							}
						}
						else
						{
							Global_75581[i /*9*/].f_6 = 0;
						}
					}
					break;
			
				case 1:
					Global_75581[i /*9*/].f_1 = Global_75581[i /*9*/].f_1 + iLocal_624;
					break;
				...
				case 4:
					if (Global_63493)
						if (Global_63495 == -1 || Global_75581[i /*9*/] == Global_63495)
							if (Global_75581[i /*9*/] == 339 || Global_75581[i /*9*/] == 179 || Global_75581[i /*9*/] == 342 || Global_75581[i /*9*/] == 234)
								Global_75581[i /*9*/].f_1 = Global_75581[i /*9*/].f_1 + SYSTEM::ROUND(MISC::GET_FRAME_TIME() * 1000f);
							else
								Global_75581[i /*9*/].f_1 = Global_75581[i /*9*/].f_1 + iLocal_624;
					break;
				...
				case 5:
					if (flag2)
					{
						if (Global_63497 == -1 || Global_63497 == Global_75581[i /*9*/])
						{
							if (!(Global_63496 == 0))
							{
								if (ENTITY::DOES_ENTITY_EXIST(Global_63496))
								{
									if (!ENTITY::IS_ENTITY_DEAD(Global_63496, false))
									{
										if (ENTITY::IS_ENTITY_A_VEHICLE(Global_63496))
										{
											...
											if (entitySpeed > Global_75581[i /*9*/].f_2)
												Global_75581[i /*9*/].f_2 = entitySpeed;
										}
									}
								}
							}
...
void func_108() // Position - 0xE98C
{
	...
	if (Global_63514 > 0)
	{
		...
		for (i = 0; i < 64; i = i + 1)
		{
			...
			{
				if (!ENTITY::DOES_ENTITY_EXIST(Global_63515[i /*2*/]))
				{
					Global_63515[i /*2*/] = 0;
			...
			case EVENT_ENTITY_DESTROYED:
				...
				if (ENTITY::DOES_ENTITY_EXIST(eventData))
				{
					...
					if (Global_63644 > 0)
					{
						...
						{
							if (Global_63645[j /*2*/] == entityModel)
								num2 = num2 + Global_63645[j /*2*/].f_1;
						}
					}
						...
						if (ENTITY::IS_ENTITY_A_PED(pedSourceOfDeath) && PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()) == ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedSourceOfDeath) || flag2)
						{
							if (ENTITY::IS_ENTITY_A_PED(pedSourceOfDeath))
							{
								...
								if (Global_63514 > 0)
								{
									...
									if (num3 != -1)
									{
										PED::GET_PED_LAST_DAMAGE_BONE(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(Global_63515[num3 /*2*/]), &iLocal_631);
								...
								if (Global_75776 > 0)
								{
									...
									{
										if (Global_75767[j /*2*/] == pedCauseOfDeath)
											func_99(Global_75767[j /*2*/].f_1, 1, false);
									}
								}
							}
							...
							if (Global_75766 > 0)
							{
								...
								while (!flag)
								{
									if (Global_75733[j /*2*/] != 0)
									{
										if (ENTITY::DOES_ENTITY_EXIST(Global_75733[j /*2*/]))
										{
											if (ENTITY::IS_ENTITY_DEAD(Global_75733[j /*2*/], false))
											{
												if (Global_75733[j /*2*/] == eventData)
												{
													func_99(Global_75733[j /*2*/].f_1, 1, false);
													Global_75733[j /*2*/] = 0;
												}
											}
										}
		...
		if (MISC::GET_REPLAY_STAT_MISSION_ID() == 13)
		{
			if (MISC::GET_REPLAY_STAT_MISSION_TYPE() == 37)
			{
				...
				if (replayStatCount2 == 3)
				{
					...
					Global_113810.f_2355[replayStatAtIndex5 /*2*/] = replayStatAtIndex6;
					Global_113810.f_2355[replayStatAtIndex5 /*2*/].f_1 = replayStatAtIndex7;
					func_114();
				}
			}
		}
