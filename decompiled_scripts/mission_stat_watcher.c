...
char* func_35(const char* sParam0) // Position - 0x2BA0 (11168)
{
	return sParam0;
}
...
void func_42(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17) // Position - 0x32AB (12971)
{
	int num;
	int i;
...
int func_112(Entity eParam0) // Position - 0xEED6 (61142)
{
	int i;
