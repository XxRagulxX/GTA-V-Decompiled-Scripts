...
{
	Global_65099 = false;
	Global_65103 = func_7(joaat("SP0_SHOTS"));
	Global_65102 = func_7(joaat("SP0_HITS"));
	Global_65105 = func_7(joaat("SP1_SHOTS"));
	Global_65104 = func_7(joaat("SP1_HITS"));
	Global_65107 = func_7(joaat("SP2_SHOTS"));
	Global_65106 = func_7(joaat("SP2_HITS"));
	return;
}
...
void func_19(int iParam0) // Position - 0xEDF (3807)
{
...
void func_98(int iParam0) // Position - 0xD8D0 (55504)
{
	...
	{
		case 0:
			STATS::STAT_SET_INT(joaat("JEWEL_HEIST_RAW_TAKE"), Global_114990.f_1.f_126[iParam0 /*23*/], true);
			break;
	}
...
void func_103() // Position - 0xE502 (58626)
{
	...
	value = 0;
	value2 = 0;
	value = func_7(joaat("SP0_SHOTS")) - Global_65103;
	value2 = func_7(joaat("SP0_HITS")) - Global_65102;
	value = value + (func_7(joaat("SP1_SHOTS")) - Global_65105);
	value2 = value2 + (func_7(joaat("SP1_HITS")) - Global_65104);
	value = value + (func_7(joaat("SP2_SHOTS")) - Global_65107);
	value2 = value2 + (func_7(joaat("SP2_HITS")) - Global_65106);
	BUILTIN::WAIT(0);
	num = 100f;
...
int func_112(Entity eParam0) // Position - 0xEF3E (61246)
{
	int i;
