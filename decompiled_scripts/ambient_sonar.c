...
BOOL func_96(var uParam0, var uParam1) // Position - 0x37E0 (14304)
{
	...
	if (!Global_80623)
		func_103(&(uParam0->f_11), &(uParam0->f_12), &(uParam0->f_9), 3, &iLocal_410, &uLocal_411, "SUBM_TITLE" /*Waste Collected~s~*/, "SUBM_COLLECT" /*~1~/30 nuclear waste collected.*/);
...
void func_138() // Position - 0x4B17 (19223)
{
	iLocal_410 = 0;
	func_142();
	func_141(&uLocal_59, 3, joaat("prop_rad_waste_barrel_01"), "SUBM_COLLECT" /*~1~/30 nuclear waste collected.*/);
	func_139(&uLocal_59, joaat("NUM_HIDDEN_PACKAGES_3"), 815, 30);
