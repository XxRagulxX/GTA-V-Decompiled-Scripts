...
void func_115(int iParam0, int iParam1) // Position - 0x590E (22798)
{
...
int func_165(var uParam0, int iParam1, int iParam2) // Position - 0x8168 (33128)
{
	...
	{
		if (!func_181(Global_100950[iParam2 /*3*/], 0f, 0f, 0f, false))
		{
			unk.f_11 = 12;
			unk.f_31 = 49;
			unk.f_81 = 2;
...
BOOL func_182(int iParam0, var uParam1, var uParam2) // Position - 0xC387 (50055)
{
	switch (iParam0)
	{
		case 11:
...
void func_194(var uParam0, int iParam1) // Position - 0xCFDF (53215)
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_182(Global_114990.f_18542[i], &unk, &num2))
			{
...
BOOL func_205(int iParam0, Entity eParam1) // Position - 0xD965 (55653)
{
	int i;
...
void func_207(int iParam0, int iParam1) // Position - 0xDB2E (56110)
{
	int num;
...
void func_208(int iParam0) // Position - 0xDC1B (56347)
{
...
void func_209(int iParam0) // Position - 0xDC66 (56422)
{
	Vector3 vector;
	BOOL flag;
	BOOL flag2;
...
BOOL func_212(int iParam0) // Position - 0xE3D3 (58323)
{
	Hash entityModel;
...
int func_221(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x11AE7 (72423)
{
	int i;
	float distanceBetweenCoords;
	float num;
...
var func_238(int iParam0) // Position - 0x12CBE (76990)
{
	return Global_1574538[iParam0];
}

var func_239() // Position - 0x12CCE (77006)
{
...
void func_249(int iParam0, Entity eParam1, BOOL bParam2) // Position - 0x1347E (78974)
{
	int i;
	BOOL flag;
...
void func_304(var uParam0, var uParam1) // Position - 0x168AE (92334)
{
...
void func_314(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, var uParam10, float fParam11, float fParam12, float fParam13, float fParam14, float fParam15, float fParam16) // Position - 0x16EED (93933)
{
	uParam0->f_1 = iParam1;
