...
BOOL func_205(int iParam0, Entity eParam1) // Position - 0xD999 (55705)
{
	int i;
...
void func_249(int iParam0, Entity eParam1, BOOL bParam2) // Position - 0x13444 (78916)
{
	int i;
	BOOL flag;
...
void func_304(var uParam0, var uParam1) // Position - 0x16853 (92243)
{
...
void func_314(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, var uParam10, float fParam11, float fParam12, float fParam13, float fParam14, float fParam15, float fParam16) // Position - 0x16E92 (93842)
{
	uParam0->f_1 = iParam1;
