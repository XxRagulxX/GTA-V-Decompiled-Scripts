...
void main() // Position - 0x0 (0)
{
	...
	iLocal_146 = Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_260.f_39;
	...
	while (true)
	{
		...
		else if (iLocal_146 != -1 && iLocal_146 <= 131)
		{
			uLocal_165 = { func_1() };
...
{
	if (func_6(iLocal_146, -1))
		return func_4(iLocal_146);
	else if (iLocal_146 == 126)
		return func_3();
	else if (iLocal_146 == 130)
		return func_2();
...
BOOL func_40(var uParam0, int iParam1) // Position - 0x19E7 (6631)
{
...
char* func_42(int iParam0) // Position - 0x1A1B (6683)
{
	switch (iParam0)
	{
		case 1:
...
void func_67(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x3021 (12321)
{
	...
	if (bParam3)
	{
		...
		{
			func_103(Global_24546.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, 0, false, 0);
...
void func_74(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x62BB (25275)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
void func_103(int iParam0, char* sParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5, int iParam6) // Position - 0x772F (30511)
{
	int num;
	float num2;
	float num3;
...
BOOL func_111(BOOL bParam0, BOOL bParam1) // Position - 0x7CA5 (31909)
{
	...
	if (!CAM::IS_SCREEN_FADED_IN() || func_113(8, -1) && func_112() != 65 || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_80566 || Global_24546.f_9243 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_102506.f_1514)
		return false;

	return true;
}

int func_112() // Position - 0x7D42 (32066)
{
...
void func_117() // Position - 0x7E95 (32405)
{
	...
	else
	{
		...
		if (iLocal_146 != 126 && iLocal_146 != 130 && iLocal_145 >= 4)
...
void func_131() // Position - 0x88F0 (35056)
{
	...
	for (i = 0; i < num; i = i + 1)
	{
		...
		if (iLocal_146 != 126 && iLocal_146 != 130 && i >= 4)
...
{
	if (iLocal_146 == 126 || iLocal_146 == 130)
		return 20;
...
void func_220(int iParam0, BOOL bParam1) // Position - 0xBE13 (48659)
{
	if (func_5(iParam0) == 97)
	{
...
void func_221(int iParam0) // Position - 0xBE6C (48748)
{
	if (func_6(iLocal_146, -1))
	{
		if (iParam0 != iLocal_155 && iParam0 != -1)
		{
			...
			func_224(iLocal_146, iParam0);
		}
	
		if (iParam0 != -1)
			iLocal_143 = iParam0;
	}
	else if (iLocal_146 == 126 || iLocal_146 == 130)
	{
		if (iParam0 != iLocal_155 && iParam0 != -1)
		{
			if (plLocal_142 == PLAYER::PLAYER_ID() && iLocal_152 != 0)
...
void func_224(int iParam0, int iParam1) // Position - 0xBF9A (49050)
{
	char* radioStation;
...
int func_243() // Position - 0xC975 (51573)
{
	int unk;
...
void func_245() // Position - 0xC9FB (51707)
{
	...
	else if (iLocal_146 != Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_260.f_39)
	{
		func_253(false);
	}
