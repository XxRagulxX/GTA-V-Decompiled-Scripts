...
void func_73() // Position - 0x5EB7 (24247)
{
	...
	sLocal_57 = "LEV_RIDEHLP" /*Press ~INPUT_CONTEXT~ to ride the Leviathan. The cost is $~1~.*/;
	sLocal_57.f_1 = "LEV_BROKEN" /*The Leviathan is closed. Come back later.*/;
	sLocal_57.f_2 = "LEV_NOMONEY" /*You do not have enough money. It costs $~1~ to ride the Leviathan.*/;
	sLocal_57.f_4 = "LEV_WANTED" /*You can't ride the Leviathan while Wanted.*/;
	sLocal_57.f_3 = 0;
	sLocal_57.f_16 = 1;
	sLocal_74 = "BIGW_RIDEHLP" /*Press ~INPUT_CONTEXT~ to ride the Ferris Whale. The cost is $~1~.*/;
	sLocal_74.f_1 = "BIGW_BROKEN" /*The Ferris Whale is closed. Come back later.*/;
	sLocal_74.f_2 = "BIGW_NOMONEY" /*You do not have enough money. It costs $~1~ to ride the Ferris Whale.*/;
	sLocal_74.f_4 = "BIGW_WANTED" /*You can't ride the Ferris Whale while Wanted.*/;
	sLocal_74.f_3 = 0;
	sLocal_57.f_16 = 1;
	return;
}
