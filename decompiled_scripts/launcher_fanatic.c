...
void func_205(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDBC1 (56257)
{
...
int func_263(var uParam0, eCharacter echParam1) // Position - 0x1005E (65630)
{
	int num;
