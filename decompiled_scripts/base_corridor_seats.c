...
BOOL func_71() // Position - 0x182E (6190)
{
	if (Global_1845184 != _INVALID_PLAYER_INDEX())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_corridor_seats", Global_1845184, true, 0))
			return false;
...
void func_72() // Position - 0x187A (6266)
{
	...
	unk[0] = 0;
	unk[1] = 1;
	func_73(5, &uLocal_131, &unk);
	unk[0] = 2;
	unk[1] = 3;
	func_73(6, &uLocal_131, &unk);
	return;
}
...
int func_81(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1C59 (7257)
{
	int i;
...
BOOL func_82(int iParam0) // Position - 0x1D6F (7535)
{
