...
int func_45(int iParam0) // Position - 0x1DC9 (7625)
{
	switch (iParam0)
	{
		case 15:
...
void func_46(var uParam0) // Position - 0x25E8 (9704)
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
	uParam0->f_2 = -1;
...
int func_202(int iParam0) // Position - 0x636C (25452)
{
	int num;
...
void func_203(int iParam0, int iParam1) // Position - 0x63AF (25519)
{
...
void func_204(int iParam0, int iParam1, int iParam2) // Position - 0x63CE (25550)
{
	BOOL flag;
	int num;
	...
	switch (iParam0)
	{
		case 24:
			switch (iParam1)
			{
				...
				case 264:
					if (IS_BIT_SET(func_133(14285, -1), 2) || func_133(14287, -1) > 1)
						flag = true;
					break;
...
int func_284(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13) // Position - 0x13B14 (80660)
{
	int i;
	Hash hashKey;
	...
	if (hashKey != 0)
	{
		for (i = 0; i < Global_1573885; i = i + 1)
		{
			if (!func_103(i))
			{
				if (Global_4526250[i /*26*/].f_25 == hashKey)
				{
					if (MISC::ARE_STRINGS_EQUAL(&(Global_4526250[i /*26*/].f_15.f_3), &(uParam4.f_3)))
					{
						if (uParam4.f_1 == 9999)
						{
							return i;
	...
	{
		if (!func_103(i))
			if (Global_4526250[i /*26*/].f_2 == iParam0 && Global_4526250[i /*26*/].f_15 == uParam4 && Global_4526250[i /*26*/].f_15.f_1 == uParam4.f_1)
...
int func_358(Player plParam0, int iParam1) // Position - 0x15EE2 (89826)
{
	if (func_41(iParam1))
	{
		if (Global_2628568)
...
BOOL func_362(int iParam0, var uParam1, var uParam2, int* piParam3, int iParam4) // Position - 0x15FC5 (90053)
{
	int num;
...
void func_366(int iParam0) // Position - 0x16128 (90408)
{
	Global_2635125.f_2 = iParam0;
	return;
}

int func_367(int iParam0) // Position - 0x16138 (90424)
{
	if (func_372(iParam0))
		return 0;
...
BOOL func_368(int iParam0) // Position - 0x16182 (90498)
{
	return iParam0 == Global_262145.f_9212;
}

BOOL func_369(int iParam0) // Position - 0x16194 (90516)
{
	return iParam0 == Global_262145.f_9206;
}

BOOL func_370(int iParam0) // Position - 0x161A6 (90534)
{
	return iParam0 == Global_262145.f_9200;
}

BOOL func_371(int iParam0) // Position - 0x161B8 (90552)
{
	return iParam0 == Global_262145.f_9193;
}

BOOL func_372(int iParam0) // Position - 0x161CA (90570)
{
...
void func_382(int iParam0) // Position - 0x1711F (94495)
{
	iParam0->f_65 = 0;
...
BOOL func_404(var uParam0) // Position - 0x1850D (99597)
{
	int i;
...
BOOL func_467(int iParam0) // Position - 0x19CEE (105710)
{
