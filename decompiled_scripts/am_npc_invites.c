...
void func_46(var uParam0) // Position - 0x259F (9631)
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
	uParam0->f_2 = -1;
...
int func_202(int iParam0) // Position - 0x62E2 (25314)
{
	int num;

	if (Global_1945595[iParam0 /*8*/] == -1)
	{
		num = func_133(func_274(iParam0), -1);
...
void func_203(int iParam0, int iParam1) // Position - 0x6325 (25381)
{
	Global_1945595[iParam0 /*8*/] = iParam1;
	func_204(func_274(iParam0), iParam1, -1);
	return;
}

void func_204(int iParam0, int iParam1, int iParam2) // Position - 0x6344 (25412)
{
	BOOL flag;
	int num;
	...
	{
		func_273(iParam0, iParam1, iParam2, true);
		return;
	}
	...
	if (!func_271(num, iParam1 == func_133(iParam0, -1)))
	{
		flag = false;
	}
	else
...
int func_284(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13) // Position - 0x1357C (79228)
{
	int i;
	Hash hashKey;
	...
	if (hashKey != 0)
	{
		for (i = 0; i < Global_1573885; i = i + 1)
		{
			if (!func_103(i))
			{
				if (Global_4526171[i /*26*/].f_25 == hashKey)
				{
					if (MISC::ARE_STRINGS_EQUAL(&(Global_4526171[i /*26*/].f_15.f_3), &(uParam4.f_3)))
					{
						if (uParam4.f_1 == 9999)
						{
							return i;
	...
	{
		if (!func_103(i))
			if (Global_4526171[i /*26*/].f_2 == iParam0 && Global_4526171[i /*26*/].f_15 == uParam4 && Global_4526171[i /*26*/].f_15.f_1 == uParam4.f_1)
...
int func_358(Player plParam0, int iParam1) // Position - 0x15944 (88388)
{
	if (func_41(iParam1))
	{
		if (Global_2628568)
...
BOOL func_362(int iParam0, var uParam1, var uParam2, int* piParam3, int iParam4) // Position - 0x15A27 (88615)
{
	var unk;
...
void func_366(int iParam0) // Position - 0x15B8A (88970)
{
	Global_2635125.f_2 = iParam0;
	return;
}

int func_367(int iParam0) // Position - 0x15B9A (88986)
{
	if (func_372(iParam0))
		return 0;
...
BOOL func_368(int iParam0) // Position - 0x15BE4 (89060)
{
	return iParam0 == Global_262145.f_9212;
}

BOOL func_369(int iParam0) // Position - 0x15BF6 (89078)
{
	return iParam0 == Global_262145.f_9206;
}

BOOL func_370(int iParam0) // Position - 0x15C08 (89096)
{
	return iParam0 == Global_262145.f_9200;
}

BOOL func_371(int iParam0) // Position - 0x15C1A (89114)
{
	return iParam0 == Global_262145.f_9193;
}

BOOL func_372(int iParam0) // Position - 0x15C2C (89132)
{
...
void func_382(int iParam0) // Position - 0x16B30 (92976)
{
	iParam0->f_65 = 0;
	...
	*iParam0 = 0;
	...
	iParam0->f_12 = 0;
	iParam0->f_2 = 0;
	func_383(&(iParam0->f_13));
	func_383(&(iParam0->f_13.f_13));
...
BOOL func_393(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x1744A (95306)
{
	...
	switch (*uParam1)
	{
		...
		case 1:
			unk = func_35(PLAYER::PLAYER_ID());
			iLocal_665 = func_394(iParam0, unk, false, 1);
...
int func_394(int iParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0x17533 (95539)
{
	int num;
	int num2;
	...
	num = -1;
	num2 = 2;
	num = func_395(iParam0, uParam1, num2, bParam2, iParam3);
...
int func_395(int iParam0, var uParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x17599 (95641)
{
	int i;
	int num;
	var unk;
	...
	for (i = 0; i < 500; i = i + 1)
	{
		if (func_407(i, iParam0, uParam1, iParam2))
		{
			unk[num] = i;
			num = num + 1;
		}
...
BOOL func_401(var uParam0) // Position - 0x17D4B (97611)
{
	int i;
...
BOOL func_407(int iParam0, int iParam1, var uParam2, int iParam3) // Position - 0x17EC6 (97990)
{
	int num;
	int num2;
	BOOL flag;
	...
	switch (*uParam1)
	{
		...
		case 1:
			if (!bParam2)
			{
				...
				iLocal_665 = func_394(iParam0, unk5, false, 1);
...
BOOL func_433(int iParam0) // Position - 0x18A18 (100888)
{
	...
	unk = func_35(PLAYER::PLAYER_ID());
	return func_434(iParam0, unk) != -1;
}

int func_434(int iParam0, var uParam1) // Position - 0x18A34 (100916)
{
	var unk;
	int num;
	int endRange;
	...
	unk = 25;
	num = 0;
	endRange = func_435(iParam0, uParam1, &unk, &num);
...
int func_435(int iParam0, var uParam1, var uParam2, int* piParam3) // Position - 0x18A6C (100972)
{
	int i;
	int offset;
	int num;
	...
	*piParam3 = 0;
	...
	if (num > 1)
	{
		...
		for (j = 0; j < 5; j = j + 1)
		{
			...
			{
				case 0:
					num2 = Global_262145.f_9188;
					break;
			
				case 1:
					num2 = Global_262145.f_9193;
					break;
			
				case 2:
					num2 = Global_262145.f_9200;
					break;
			
				case 3:
					num2 = Global_262145.f_9206;
					break;
			
				case 4:
					num2 = Global_262145.f_9212;
					break;
			}
			...
			while (flag2)
			{
				...
				{
					if (num2 == Global_2634773[uParam2->[offset2] /*14*/].f_12)
					{
						if (offset2 != offset)
						{
							num3 = uParam2->[offset];
