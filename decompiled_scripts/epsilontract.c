...
void func_1() // Position - 0xCE (206)
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && !func_44(14) && !CAM::IS_SCREEN_FADED_OUT())
	{
		...
		func_2(&bLocal_63, &bLocal_64, &uLocal_65, 4, &uLocal_61, &uLocal_62, "TRACT_TITLE" /*Tract Collected~s~*/, "TRACT_COLLECT" /*~1~/10 Epsilon tracts collected.*/);
	}
...
int func_4(int iParam0) // Position - 0x44B (1099)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (IS_BIT_SET(Global_114990.f_10058.f_108, func_8(func_9(iParam0), i)))
				outValue = outValue + 1;
		}
	}
	else if (iParam0 == 6)
...
int func_13(int iParam0, int iParam1, BOOL bParam2) // Position - 0x67D (1661)
{
	...
	for (i = 0; i < Global_55483[num /*203*/].f_3; i = i + 1)
	{
		...
		if (num3 < 3)
			func_14(Global_55483[num /*203*/].f_4[i], Global_55483[num /*203*/].f_1, true, bParam2, false);
	}
...
void func_14(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x879 (2169)
{
	...
	if (!bParam2)
	{
		...
		num3 = num5;
		unk = { func_25(Global_46183[num5 /*12*/].f_1) };
	...
	else
	{
		...
		if (Global_55483[num6 /*203*/].f_10[Global_55483[num6 /*203*/].f_9 - 1 /*48*/].f_1)
			...
			unk = { func_25(Global_46183[num8 /*12*/].f_1) };
	}
...
void func_20() // Position - 0x15A9 (5545)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114990.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_21(character) && !func_44(14) || Global_113936)
			{
...
int func_42(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x1DDE (7646)
{
	...
	TEXT_LABEL_ASSIGN_STRING(&Global_114990.f_14150[num /*104*/], sParam2, 64);
	Global_114990.f_14150[num /*104*/].f_17 = iParam1;

	if (iParam3 == 0)
		return 0;
	else
		Global_114990.f_14150[num /*104*/].f_24 = iParam3;

	Global_114990.f_14150[num /*104*/].f_25 = iParam4;
	Global_114990.f_14150[num /*104*/].f_26 = iParam5;
	Global_114990.f_14150[num /*104*/].f_29 = iParam6;
	Global_114990.f_14150[num /*104*/].f_30 = iParam8;
	Global_114990.f_14150[num /*104*/].f_31 = iParam7;
	Global_114990.f_14150[num /*104*/].f_28 = 0;
	return 1;
}
...
void func_46() // Position - 0x1F1E (7966)
{
	...
	if (Global_114990.f_18583.f_388)
	{
		uLocal_177[0] = "TRACT_HINT1B" /*Kifflom. The ingratitude and self-centeredness of your actions is unforgivable in my eyes but Kraff is not without mercy. To have a chance of redeeming yourself, you must write the tract, which has already been written...WE WORSHIP KRAFF WHERE THE EARTH REACHES OUT TO THE 9TH PARADIGM.*/;
		iLocal_60 = 300000;
	}
	else
	{
		uLocal_177[0] = "TRACT_HINT1" /*Kifflom, brother. You are now truly one of us and are ready to write the tract, which has already been written...WE WORSHIP KRAFF WHERE THE EARTH REACHES OUT TO THE 9TH PARADIGM.*/;
		iLocal_60 = 16000;
	}

	uLocal_66[0 /*11*/].f_3 = { 501.9415f, 5604.429f, 796.9146f };
	uLocal_66[1 /*11*/].f_3 = { 2658.18f, -1361.14f, -21.63f };
	uLocal_177[1] = "TRACT_HINT2" /*Where the first of the fleet succumbed to the waves, there the message is seeded.*/;
	uLocal_66[2 /*11*/].f_3 = { 24.7139f, 7644.334f, 18.0792f };
	uLocal_177[2] = "TRACT_HINT3" /*When they sail from the North, they will find this offering.*/;
	uLocal_66[3 /*11*/].f_3 = { -263.55f, 4729.6f, 137.37f };
	uLocal_177[3] = "TRACT_HINT4" /*In the core of the mountain, where the blast is not felt, there you shall find it.*/;
	uLocal_66[4 /*11*/].f_3 = { -771.98f, -685.22f, 28.86f };
	uLocal_177[4] = "TRACT_HINT5" /*In the rubble of the old religion, will be the basis for the new.*/;
	uLocal_66[5 /*11*/].f_3 = { -1605.03f, 5256.55f, 1.08f };
	uLocal_177[5] = "TRACT_HINT6" /*Where the first fleet sailed, the new fleet will find its map.*/;
	uLocal_66[6 /*11*/].f_3 = { -1804.5464f, 403.9298f, 112.1966f };
	uLocal_177[6] = "TRACT_HINT7" /*What dwelling is worthy of Kraff? He is humble, yet we exalt him.*/;
	uLocal_66[7 /*11*/].f_3 = { 484.2701f, 5617.175f, 787.4708f };
	uLocal_177[7] = "TRACT_HINT8" /*We are not dinosaurs, nor plants, but a tree in the jet stream may hold Kraff's true word.*/;
	uLocal_66[8 /*11*/].f_3 = { -75.1004f, -819.0673f, 325.3656f };
	uLocal_177[8] = "TRACT_HINT9" /*The tallest obelisk of glass and steel holds no comparison to the word of Kraff.*/;
	uLocal_66[9 /*11*/].f_3 = { -1725.34f, -189.95f, 57.52f };
	uLocal_177[9] = "TRACT_HINT10" /*Where they discard their earthly prisons, there you may find the germ of a higher civilization.*/;
	iLocal_59 = MISC::GET_GAME_TIMER();
