...
BOOL func_46(BOOL bParam0, BOOL bParam1) // Position - 0x17B3 (6067)
{
	...
	if (!CAM::IS_SCREEN_FADED_IN() || func_48(8, -1) && func_47() != 65 || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_80566 || Global_24546.f_9243 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_102506.f_1514)
		return false;

	return true;
}

int func_47() // Position - 0x1850 (6224)
{
...
void func_97(int iParam0, char* sParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5, int iParam6) // Position - 0x65A7 (26023)
{
	int num;
	float num2;
	float num3;
