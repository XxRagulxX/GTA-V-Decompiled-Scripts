...
int func_47() // Position - 0x1825 (6181)
{
...
void func_59(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4) // Position - 0x4C6E (19566)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
BOOL func_93(var uParam0, int iParam1) // Position - 0x6377 (25463)
{
	return IS_BIT_SET(uParam0->f_130[iParam1], 10);
}

void func_94(int iParam0, int iParam1, BOOL bParam2) // Position - 0x638A (25482)
{
	int num;
	float num2;
	float num3;
...
BOOL func_95(int iParam0) // Position - 0x6505 (25861)
{
	return func_96(&(hLocal_870.f_2), iParam0);
}

BOOL func_96(var uParam0, int iParam1) // Position - 0x6518 (25880)
{
	return IS_BIT_SET(uParam0->[iParam1 / 32], iParam1 & 31);
}

void func_97(int iParam0, char* sParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5, int iParam6) // Position - 0x652F (25903)
{
	int num;
	float num2;
	float num3;
...
void func_100(int iParam0, BOOL bParam1) // Position - 0x67A4 (26532)
{
	int num;
...
BOOL func_101(int iParam0) // Position - 0x67F0 (26608)
{
...
BOOL func_102(var uParam0, int iParam1) // Position - 0x6828 (26664)
{
...
void func_113(int iParam0) // Position - 0x6BA0 (27552)
{
	func_114(&(hLocal_870.f_4), iParam0);
	return;
}

void func_114(var uParam0, int iParam1) // Position - 0x6BB3 (27571)
{
	MISC::SET_BIT(&uParam0->[iParam1 / 32], iParam1 & 31);
	return;
}

void func_115(int iParam0) // Position - 0x6BCD (27597)
{
	func_116(&(hLocal_870.f_4), iParam0);
	return;
}

void func_116(var uParam0, int iParam1) // Position - 0x6BE0 (27616)
{
	MISC::CLEAR_BIT(&uParam0->[iParam1 / 32], iParam1 & 31);
	return;
}

BOOL func_117(int iParam0) // Position - 0x6BFA (27642)
{
	return func_96(&(hLocal_870.f_4), iParam0);
}

void func_118(int iParam0) // Position - 0x6C0D (27661)
{
	func_114(&(hLocal_870.f_2), iParam0);
	return;
}

void func_119(int iParam0) // Position - 0x6C20 (27680)
{
