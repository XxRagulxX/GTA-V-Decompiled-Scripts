...
BOOL func_86(int iParam0) // Position - 0x5EF6 (24310)
{
	int num;
...
BOOL func_143(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8) // Position - 0x82F3 (33523)
{
...
void func_157(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x89C3 (35267)
{
...
int func_187(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4) // Position - 0x9C4A (40010)
{
	int i;
