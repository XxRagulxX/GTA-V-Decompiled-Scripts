...
int func_237(int iParam0) // Position - 0x81DB (33243)
{
	if (MISC::IS_AUSSIE_VERSION())
		if (iParam0 == 0)
			return 70;
...
void func_238(int iParam0) // Position - 0x8246 (33350)
{
	var unk;
...
void func_243(var uParam0) // Position - 0x8E8E (36494)
{
	uParam0->f_65 = 0;
...
int func_285() // Position - 0xA73D (42813)
{
	if (func_571())
...
int _GET_PLAYER_CASH(eCharacter echParam0) // Position - 0xA762 (42850)
{
	int outValue;
...
int func_287(Player plParam0) // Position - 0xA7BA (42938)
{
	int num;
...
void func_307(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0xB02E (45102)
{
	...
	if (bParam3)
	{
		...
		{
			func_338(Global_24546.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, 0, false, 0);
...
void func_311(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4) // Position - 0xE296 (58006)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
void func_338(int iParam0, char* sParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5, int iParam6) // Position - 0xF6B1 (63153)
{
	int num;
	float num2;
	float num3;
...
BOOL func_346(BOOL bParam0, BOOL bParam1) // Position - 0xFC27 (64551)
{
	...
	if (!CAM::IS_SCREEN_FADED_IN() || func_31(8, -1) && func_347() != 65 || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_80566 || Global_24546.f_9243 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_102506.f_1514)
		return false;

	return true;
}

int func_347() // Position - 0xFCC4 (64708)
{
...
void func_372(int iParam0, BOOL bParam1) // Position - 0x10614 (67092)
{
	float num;
	float num2;
	var unk;
...
int func_493() // Position - 0x14A6B (84587)
{
...
void func_562() // Position - 0x16376 (90998)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_97, false) && !ENTITY::IS_ENTITY_DEAD(veLocal_97, false))
	{
		if (func_571())
		{
			if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(veLocal_97))
			{
				if (Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_260.f_39 <= 0 && !IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_260.f_37, 11))
				{
