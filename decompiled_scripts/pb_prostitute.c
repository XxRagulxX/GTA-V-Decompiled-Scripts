...
void func_33(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1027 (4135)
{
...
void func_99(var uParam0) // Position - 0x3B13 (15123)
{
	...
	switch (iLocal_312)
	{
		case 0:
			...
			else if (iLocal_313 != 0 && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("PROS_NO_MONEY" /*You need more cash to pick up a prostitute.*/))
			{
				func_65(false);
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x759B (30107)
{
	Player player;
		...
		case 3:
			...
			if (MISC::IS_PC_VERSION())
			{
				if (PAD::IS_USING_CURSOR(FRONTEND_CONTROL))
				{
					...
					if (func_297())
					{
						if (Global_4521350 != iLocal_87)
						{
							AUDIO::PLAY_SOUND_FRONTEND(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
							iLocal_87 = Global_4521350;
...
int func_237(int iParam0) // Position - 0x8229 (33321)
{
	if (MISC::IS_AUSSIE_VERSION())
		if (iParam0 == 0)
			return 70;
...
void func_238(int iParam0) // Position - 0x8294 (33428)
{
	var unk;
...
void _NETSHOPPING_PROCESS_TRANSACTION(Hash hParam0, int iParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x82D6 (33494)
{
	int num;
...
int func_240(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7) // Position - 0x8CF4 (36084)
{
	BOOL flag;
	BOOL flag2;
	int i;
...
void func_241(int iParam0, Hash hParam1, int iParam2, int iParam3, int iParam4) // Position - 0x8EA1 (36513)
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
void func_243(var uParam0) // Position - 0x8F2D (36653)
{
	uParam0->f_65 = 0;
	...
	*uParam0 = 0;
	...
	uParam0->f_12 = 0;
	uParam0->f_2 = 0;
	func_244(&(uParam0->f_13));
	func_244(&(uParam0->f_13.f_13));
...
void func_246(int iParam0, Hash hParam1) // Position - 0x90AB (37035)
{
...
int func_251(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x92B1 (37553)
{
...
void func_264(int iParam0) // Position - 0xA0D9 (41177)
{
	func_282(93, iParam0);
	func_282(29, iParam0);
	func_282(30, iParam0);
...
void func_282(int iParam0, int iParam1) // Position - 0xA6F9 (42745)
{
	int outValue;
...
int func_285() // Position - 0xA7DC (42972)
{
	if (func_573())
...
int _GET_PLAYER_CASH(eCharacter echParam0) // Position - 0xA801 (43009)
{
	int outValue;
...
int func_287(Player plParam0) // Position - 0xA859 (43097)
{
	int num;
...
void func_292(int iParam0, BOOL bParam1, int iParam2) // Position - 0xA8F8 (43256)
{
	int i;
	int num;
...
void func_293() // Position - 0xAA4A (43594)
{
	...
	{
		iLocal_315 = uLocal_306[iLocal_87];
		func_294();
...
void func_307(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0xB0CD (45261)
{
	...
	if (bParam3)
	{
		...
		{
			func_338(Global_24586.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, 0, false, 0);
		...
		if (i == 1 || !Global_24586.f_6331)
		{
			...
			for (j = 0; j <= num43; j = j + 1)
			{
				...
				if (flag && i == 1 && flag2)
				{
					...
					func_333("CommonMenu", "Gradient_Nav", Global_24583 + (iParam5 * 0.5f), num40 + num45 + (0.00277776f * (float)num5) + (num37 * 0.5f), iParam5, num37, 0f, r2, g2, b2, a2, false, 0);
								...
								if (flag2)
								{
									if (!Global_24586.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_24586.f_79[num16 /*6*/]) != 0)
										{
											...
											func_317(flag, Global_24586.f_1616[num16], Global_24586.f_1873[num16], flag7, num46, flag5, flag4);
...
void func_311(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4) // Position - 0xE337 (58167)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
...
int func_324(int iParam0, BOOL bParam1) // Position - 0xEDB5 (60853)
{
	int num;
	int num2;
...
void func_338(int iParam0, char* sParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5, int iParam6) // Position - 0xF752 (63314)
{
	int num;
	float num2;
	float num3;
...
void func_341(int iParam0, BOOL bParam1) // Position - 0xF9C7 (63943)
{
	int num;
...
BOOL func_346(BOOL bParam0, BOOL bParam1) // Position - 0xFCC8 (64712)
{
	...
	if (!CAM::IS_SCREEN_FADED_IN() || func_31(8, -1) && func_347() != 65 || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_80623 || Global_24586.f_9243 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_102563.f_1514)
		return false;

	return true;
}

int func_347() // Position - 0xFD65 (64869)
{
...
void func_369() // Position - 0x10496 (66710)
{
	...
	if (func_285() >= num)
	{
		func_338(iLocal_88, "PROS_DOLLAR" /*$~1~*/, 1, 1, 0, false, 0);
		func_372(num, false);
		uLocal_306[iLocal_88] = 0;
		iLocal_88 = iLocal_88 + 1;
	}

	if (func_285() >= num2 && func_371(veLocal_116))
	{
		func_338(iLocal_88, "PROS_DOLLAR" /*$~1~*/, 1, true, 0, false, 0);
		func_372(num2, false);
		uLocal_306[iLocal_88] = 1;
		iLocal_88 = iLocal_88 + 1;
	}

	if (func_285() >= num3 && func_371(veLocal_116))
	{
		func_338(iLocal_88, "PROS_DOLLAR" /*$~1~*/, 1, true, 0, false, 0);
		func_372(num3, false);
		uLocal_306[iLocal_88] = 2;
		iLocal_88 = iLocal_88 + 1;
	}

	func_338(iLocal_88, "PROS_QUIT" /*Decline Service*/, 0, true, 0, false, 0);
	iLocal_87 = 0;
	func_292(iLocal_87, true, 1);
	func_370();
	iLocal_106 = MISC::GET_GAME_TIMER();
...
void func_372(int iParam0, BOOL bParam1) // Position - 0x106B4 (67252)
{
	float num;
	float num2;
	var unk;
...
BOOL func_391(int* piParam0) // Position - 0x118AB (71851)
{
	switch (piParam0->f_9)
	{
		case 0:
...
void func_395(int* piParam0) // Position - 0x11A80 (72320)
{
	if (piParam0->f_9 != 0)
	{
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*piParam0))
...
void func_452() // Position - 0x13B2D (80685)
{
	if (Global_33984)
	{
		...
		if (!func_510(iLocal_66, 8192))
			if (iLocal_91 == -1)
				_CONTEXT_ADD_HELP_TEXT(&iLocal_91, 5, "PROS_ACCEPT" /*Press ~INPUT_CONTEXT~ or honk your horn to invite the prostitute into the vehicle.*/, 0, 0, 0, 0);
	}
...
int func_493() // Position - 0x14B30 (84784)
{
...
BOOL func_552(int iParam0) // Position - 0x1617A (90490)
{
...
void func_557(var uParam0) // Position - 0x16205 (90629)
{
	...
	if (_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("PROS_ACCEPT" /*Press ~INPUT_CONTEXT~ or honk your horn to invite the prostitute into the vehicle.*/) && !Global_33984)
		HUD::CLEAR_HELP(true);
...
void func_564() // Position - 0x1649C (91292)
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_116, false) && !ENTITY::IS_ENTITY_DEAD(veLocal_116, false))
	{
		if (func_573())
		{
			if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(veLocal_116))
			{
				if (Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_260.f_39 <= 0 && !IS_BIT_SET(Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_260.f_37, 11))
				{
...
BOOL func_576(Player plParam0, BOOL bParam1) // Position - 0x16AC6 (92870)
{
	...
	if (Global_1845347[plParam0 /*884*/] == 2 || Global_1845347[plParam0 /*884*/] == 1 || Global_1845347[plParam0 /*884*/] == 0 || Global_1845347[plParam0 /*884*/] == 3 || Global_1845347[plParam0 /*884*/] == 8)
		return true;
