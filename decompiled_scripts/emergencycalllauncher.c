		...
		case 0:
			if (func_45(130) && func_44(player) != 192 && func_44(player) != 190 && func_44(player) != 191 && func_44(player) != 225 && func_44(player) != 226 && func_44(player) != 227 && !func_34(player))
			{
				...
				if (!Global_33891)
				{
					if (func_32())
					{
						if (func_8(&uLocal_62, 130, "LOCAUD", "LOC_CALLQ", iLocal_234, "CELL_601" /*Which Service?*/, "LOC_CALLA", "LOC_CALLF", "LOC_CALLP", 0, 0, 0, false))
						{
							if (!func_6())
							{
					...
					else if (func_8(&uLocal_62, 130, "LOCAUD", "LOC_CALLQ", iLocal_234, "CELL_601" /*Which Service?*/, "LOC_CALLA", "LOC_CALLF", "LOC_CALLP", 0, 0, 0, false))
					{
						if (!func_6())
						{
							SCRIPT::REQUEST_SCRIPT("emergencycall");
...
void func_31(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xC00 (3072)
{
...
BOOL func_45(int iParam0) // Position - 0xE95 (3733)
{
