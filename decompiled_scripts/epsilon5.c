...
struct<10> func_77(Hash hParam0, int iParam1) // Position - 0x97C2 (38850)
{
	int i;
	var unk;
...
struct<17> func_80(Hash hParam0, int iParam1) // Position - 0xA263 (41571)
{
	int i;
	var unk;
...
void func_83(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xC346 (49990)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
struct<14> func_84(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC3B7 (50103)
{
	func_148();
...
BOOL func_149(Ped pedParam0, int iParam1, int iParam2) // Position - 0x1FA60 (129632)
{
	Hash entityModel;
	int num;
	int i;
...
int func_204(int iParam0, int iParam1, BOOL bParam2) // Position - 0x26E04 (159236)
{
	...
	for (i = 0; i < Global_55483[num /*203*/].f_3; i = i + 1)
	{
		...
		if (num3 < 3)
			func_205(Global_55483[num /*203*/].f_4[i], Global_55483[num /*203*/].f_1, true, bParam2, false);
	}
...
void func_205(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x27000 (159744)
{
	...
	if (!bParam2)
	{
		...
		num3 = num5;
		unk = { func_211(Global_46183[num5 /*12*/].f_1) };
	...
	else
	{
		...
		if (Global_55483[num6 /*203*/].f_10[Global_55483[num6 /*203*/].f_9 - 1 /*48*/].f_1)
			...
			unk = { func_211(Global_46183[num8 /*12*/].f_1) };
	}
...
void func_276(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2A1FE (172542)
{
	...
	if (Global_80617 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_290(Global_80618, Global_80620, iParam10) };
				y == -0.014f;
...
{
	if (!func_301(0) || Global_80633 || Global_80621 == 1 || !CAM::IS_SCREEN_FADED_IN())
		return false;
...
{
	return func_303(iParam0, Global_44938);
}
...
int func_314(var uParam0, eCharacter echParam1) // Position - 0x2B4EA (177386)
{
	int num;
...
int func_338(char* sParam0) // Position - 0x2BC48 (179272)
{
...
int func_339() // Position - 0x2BC9E (179358)
{
	...
	num = func_340(&(Global_102511.f_3), false);
	num2 = 0;
...
int func_340(char* sParam0, BOOL bParam1) // Position - 0x2BCC2 (179394)
{
	Hash hashKey;
	int num;
...
BOOL func_343() // Position - 0x2BD72 (179570)
{
	...
	if (Global_102511.f_11 == 5)
		if (func_338(&(Global_102511.f_3)) > -1)
			return true;
