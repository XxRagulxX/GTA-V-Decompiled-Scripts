...
void main() // Position - 0x0 (0)
{
	...
	fLocal_49 = 180f;
	iLocal_52 = 3;
	iLocal_97 = func_352(CHAR_JOSH);
	hLocal_98 = joaat("felon2");
	uLocal_167 = { -1106.999f, 288.96f, 63.4f };
	uLocal_170 = { 0f, 0f, 12.06f };
	...
	if (func_315())
	{
		...
		while (!func_303(&uLocal_100))
		{
			BUILTIN::WAIT(0);
		}
	
		func_302(&uLocal_100, false, true);
		Global_80608 = 0;
	}

	if (func_301(PLAYER::PLAYER_PED_ID()))
		hLocal_345 = PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_100.f_28[0]))
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_100.f_28[0], hLocal_345);
	...
	while (true)
	{
		...
		BUILTIN::WAIT(0);
		func_284(uLocal_100.f_9, 0, 0, 0, 0, 0);
...
void func_1() // Position - 0x17C (380)
{
	switch (iLocal_162)
	{
		case 0:
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh1leadinout") && STREAMING::HAS_MODEL_LOADED(joaat("p_amb_phone_01")))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(obLocal_164))
				{
					...
					obLocal_164 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), true, false, true);
				}
		...
		case 1:
			...
			if (!bLocal_177)
			{
				if (func_301(uLocal_100.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(obLocal_164))
				{
					iLocal_166 = PED::CREATE_SYNCHRONIZED_SCENE(uLocal_167, uLocal_170, 2);
					TASK::TASK_SYNCHRONIZED_SCENE(uLocal_100.f_28[0], iLocal_166, "rcmjosh1leadinout", "leadout_josh", 8f, -4f, 27, 0, 1000f, 16);
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(obLocal_164, iLocal_166, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
			...
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_166))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_166) > 0.29f)
				{
					if (!bLocal_178)
					{
						_CONVERSATION_INITIALIZE_ACTOR(&uLocal_180, 2, PLAYER::PLAYER_PED_ID(), "Trevor", 0, 1);
						_CONVERSATION_INITIALIZE_ACTOR(&uLocal_180, 5, uLocal_100.f_28[0], "Josh", 0, 1);
					
						if (_CONVERSATION_ADD_LINE(&uLocal_180, "JOSH1AU", "JOSH1_OUT", 8, 0, 0, 0))
						{
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.1068f, 290.4275f, 62.9487f, -1102.038f, 291.34207f, 66.278946f, 2f, false, true, 0))
				{
					...
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_100.f_28[0]))
					{
						TASK::CLEAR_PED_TASKS(uLocal_100.f_28[0]);
						_DEBUG_PRINT("Stopping Josh?");
					}
				
					if (ENTITY::DOES_ENTITY_EXIST(obLocal_164))
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(obLocal_164, -8f, true);
				
					iLocal_179 = 1;
				}
			
				if (func_219(uLocal_100.f_28[0], PLAYER::PLAYER_PED_ID(), true) > 17.5f)
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_100.f_28[0]))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(uLocal_100.f_28[0], -8f, true);
						TASK::CLEAR_PED_TASKS(uLocal_100.f_28[0]);
					}
				...
				if (PED::IS_PED_INJURED(uLocal_100.f_28[0]) || FIRE::IS_ENTITY_ON_FIRE(uLocal_100.f_28[0]) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uLocal_100.f_28[0], true), 5f))
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_100.f_28[0]))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(uLocal_100.f_28[0], -8f, true);
		...
		case 2:
			func_302(&uLocal_100, false, false);
			...
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_100.f_28[0]))
			{
				...
				TASK::TASK_PERFORM_SEQUENCE(uLocal_100.f_28[0], iLocal_163);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_163);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_100.f_28[0], false);
			
				if (iLocal_179 == 0)
					PED::FORCE_PED_MOTION_STATE(uLocal_100.f_28[0], joaat("MotionState_Walk"), false, 0, true);
			}
...
void func_250() // Position - 0x2897C (166268)
{
	...
	if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
	{
		...
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_100.f_28[0]))
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Josh", uLocal_100.f_28[0], 0);
	}
	...
	switch (iLocal_162)
	{
		case 0:
			if (func_266(1, 1093140480, 0))
			{
				...
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_100.f_28[0]))
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_100.f_28[0], "Josh", 0, 0, 0);
		...
		case 1:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
			{
				...
				if (!bLocal_177)
				{
					...
					{
						iLocal_166 = PED::CREATE_SYNCHRONIZED_SCENE(uLocal_167, uLocal_170, 2);
						TASK::TASK_SYNCHRONIZED_SCENE(uLocal_100.f_28[0], iLocal_166, "rcmjosh1leadinout", "leadout_josh", 1000f, -8f, 25, 0, 1000f, 16);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(obLocal_164, iLocal_166, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
						_DEBUG_PRINT("Done Josh leadout anim on Josh exit state");
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(obLocal_164);
						PED::FORCE_PED_MOTION_STATE(uLocal_100.f_28[0], joaat("MotionState_Idle"), false, 1, true);
						bLocal_177 = true;
					}
				}
			}
			...
			if (!CUTSCENE::IS_CUTSCENE_ACTIVE())
			{
				...
				if (!bLocal_177)
				{
					...
					{
						iLocal_166 = PED::CREATE_SYNCHRONIZED_SCENE(uLocal_167, uLocal_170, 2);
						TASK::TASK_SYNCHRONIZED_SCENE(uLocal_100.f_28[0], iLocal_166, "rcmjosh1leadinout", "leadout_josh", 8f, -8f, 25, 0, 1000f, 16);
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(obLocal_164, iLocal_166, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
						_DEBUG_PRINT("Done Josh leadout anim on non active cutscene");
						ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(obLocal_164);
						PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(uLocal_100.f_28[0], false, false);
						bLocal_177 = true;
					}
				}
			...
			if (!func_5(false))
			{
				if (!bLocal_173)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1115.0707f, 279.6581f, 62.421844f, -1092.4285f, 284.13983f, 67.31652f, 15.75f, false, true, 0))
					{
						if (func_301(uLocal_100.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(obLocal_164))
						{
							iLocal_165 = PED::CREATE_SYNCHRONIZED_SCENE(uLocal_167, uLocal_170, 2);
							TASK::TASK_SYNCHRONIZED_SCENE(uLocal_100.f_28[0], iLocal_165, "rcmjosh1leadinout", "leadin_josh", 8f, -8f, 25, 0, 1148846080, 0);
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(obLocal_164, iLocal_165, "leadin_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
							TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_100.f_28[0], -1, 0, 2);
							TASK::TASK_LOOK_AT_ENTITY(uLocal_100.f_28[0], PLAYER::PLAYER_PED_ID(), 4000, SLF_EXTEND_YAW_LIMIT | 8 | 2048, 2);
				...
				else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_165))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_165) > 0.15f)
					{
						if (!bLocal_174)
						{
							if (_CONVERSATION_ADD_LINE(&uLocal_180, "JOSH1AU", "JOSH1_LEADIN", 8, 0, 0, 0))
							{
					...
					if (func_219(PLAYER::PLAYER_PED_ID(), uLocal_100.f_28[0], true) <= 2.5f)
					{
	...
	if (Global_80617 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = { func_286(Global_80618, Global_80620, iParam10) };
				y == -0.014f;
...
{
	if (!func_297(0) || Global_80633 || Global_80621 == 1 || !CAM::IS_SCREEN_FADED_IN())
		return false;
...
{
	return func_299(iParam0, Global_44938);
}
...
void func_305(Vehicle* pveParam0, BOOL bParam1) // Position - 0x2B2EF (176879)
{
	...
	func_306(pveParam0, hLocal_98, unk, num);
...
void func_316() // Position - 0x2B652 (177746)
{
	...
	func_328(&uLocal_100.f_28[0], true, 1, 1);
	func_317(&uLocal_100, 1, false, false);
...
int func_333(char* sParam0) // Position - 0x2BC45 (179269)
{
...
int func_334() // Position - 0x2BC9B (179355)
{
	...
	num = func_335(&(Global_102511.f_3), false);
	num2 = 0;
...
int func_335(char* sParam0, BOOL bParam1) // Position - 0x2BCBF (179391)
{
	Hash hashKey;
	int num;
