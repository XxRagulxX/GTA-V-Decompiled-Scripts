...
void main() // Position - 0x0 (0)
{
	...
	func_52(14);
	func_50();
	func_49(&uLocal_59, 0, joaat("prop_power_cell"), "SSHIP_COLLECT" /*~1~/50 spaceship parts collected.*/);
	func_47(&uLocal_59, joaat("NUM_HIDDEN_PACKAGES_1"), 755, 50);
	...
	while (true)
	{
		...
		if (func_16(&uLocal_59, &iLocal_72) || func_15(107) == 1)
		{
			if (!bLocal_625)
...
BOOL func_16(var uParam0, var uParam1) // Position - 0x86E (2158)
{
	...
	if (!func_6(14) && !CAM::IS_SCREEN_FADED_OUT())
	{
		...
		if (!Global_80623)
			func_17(&(uParam0->f_11), &(uParam0->f_12), &(uParam0->f_9), 0, &iLocal_624, &uLocal_626, "SSHIP_TITLE" /*Part Collected~s~*/, "SSHIP_COLLECT" /*~1~/50 spaceship parts collected.*/);
...
void func_53() // Position - 0x222B (8747)
{
	...
	if (func_58(&(uLocal_59.f_1)) || func_15(107) == 1)
	{
		func_57(107, 1);
		func_55();
		func_54(14);
