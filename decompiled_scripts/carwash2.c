...
int func_118(var uParam0, int iParam1, Hash hParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6, int iParam7) // Position - 0x9921 (39201)
{
	BOOL flag;
	BOOL flag2;
	int i;
...
void func_119(int iParam0, Hash hParam1, int iParam2, int iParam3, int iParam4) // Position - 0x9ACE (39630)
{
	switch (hParam1)
	{
		case joaat("SERVICE_SPEND_BETTING"):
...
int func_129(int iParam0) // Position - 0x9EDE (40670)
{
	if (iParam0 == 1)
...
int func_225(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xD186 (53638)
{
	int i;
	int j;
	int k;
...
void func_228(Hash hParam0, int iParam1, int iParam2) // Position - 0xDA73 (55923)
{
	int num;
	int num2;
...
BOOL func_229(Hash hParam0, int iParam1, int iParam2) // Position - 0xDAFD (56061)
{
	if (hParam0 == joaat("Player_Zero"))
		if (iParam1 == 4)
...
BOOL func_230(Hash hParam0, int iParam1, int iParam2) // Position - 0xDBDB (56283)
{
	Global_79551[1 /*14*/] = { func_273(hParam0, iParam1, iParam2, -1) };
	return IS_BIT_SET(Global_79551[1 /*14*/].f_6, 2);
}

BOOL func_231(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0xDC03 (56323)
{
	var unk;
	int i;
...
BOOL func_232(Hash hParam0, int iParam1, int iParam2) // Position - 0xE207 (57863)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_234(Ped pedParam0, int iParam1, ePedComponentType epctParam2) // Position - 0xE34B (58187)
{
	int i;
	int j;
...
int func_236(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0xE49C (58524)
{
	int num;
...
int func_237(Ped pedParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE7A3 (59299)
{
	int num;
	int num2;
	int num3;
...
BOOL func_238(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4) // Position - 0xF356 (62294)
{
	int num;
...
int func_239(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF63A (63034)
{
	int num;
...
int func_240(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF901 (63745)
{
	int i;
	int num;
...
BOOL func_241(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF938 (63800)
{
	int num;
...
BOOL func_242(Hash hParam0, int iParam1, var uParam2) // Position - 0xF961 (63841)
{
	*uParam2 = -99;
...
int func_243(Hash hParam0, int iParam1, int iParam2, var uParam3) // Position - 0xFC2B (64555)
{
	int num;
...
int func_244(Hash hParam0, int iParam1, int iParam2) // Position - 0xFEB5 (65205)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_246(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x100A7 (65703)
{
	switch (hParam0)
	{
...
Hash func_247(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10175 (65909)
{
	var outProp;
	int componentId;
	int num;
...
int func_250(Ped pedParam0, int iParam1, int iParam2, ePedComponentType epctParam3) // Position - 0x10697 (67223)
{
	Hash entityModel;
...
struct<10> func_255(Hash hParam0, int iParam1) // Position - 0x10A71 (68209)
{
	int i;
	var unk;
...
struct<17> func_258(Hash hParam0, int iParam1) // Position - 0x11512 (70930)
{
	int i;
	var unk;
...
void func_261(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x135F4 (79348)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
BOOL func_262(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x13665 (79461)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
BOOL func_263(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x138E2 (80098)
{
	if (hParam0 == joaat("Player_Zero"))
	{
		if (iParam1 == 6)
...
BOOL func_264(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x13D07 (81159)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_265(Ped pedParam0, ePedComponentType epctParam1) // Position - 0x13FFA (81914)
{
	int pedPropIndex;
...
int func_266(Ped pedParam0, int iParam1) // Position - 0x14042 (81986)
{
...
struct<14> func_273(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x17D37 (97591)
{
	func_336();
