...
int func_145(int iParam0, BOOL bParam1) // Position - 0xFBD8 (64472)
{
	bParam1;
	return func_146(iParam0, 0);
}

int func_146(int iParam0, int iParam1) // Position - 0xFBEC (64492)
{
	int i;
	int value;
	int value2;
...
int func_147(int iParam0) // Position - 0xFCA7 (64679)
{
	int num;
	int num2;
...
int func_148(Player plParam0, BOOL bParam1) // Position - 0x101EE (66030)
{
	bParam1;
	return func_149(plParam0);
}

int func_149(Player plParam0) // Position - 0x10201 (66049)
{
