...
void func_4() // Position - 0x1E2
{
	...
	if (Global_20496 == 0)
	{
		while (num < 5)
		{
			func_7(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(iLocal_113), SYSTEM::TO_FLOAT(0), -1f, -1f, &uLocal_129[num /*6*/], 0, 0, 0, 0);
	...
	if (Global_20496 == 1)
	{
		...
		while (num < 5)
		{
			if (uLocal_129[num2 /*6*/].f_5 > 0)
			{
				...
				{
					func_7(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(iLocal_113), SYSTEM::TO_FLOAT(0), -1f, -1f, &uLocal_129[num2 /*6*/], 0, 0, 0, 0);
...
void func_10() // Position - 0x5B3
{
	...
	if (Global_20478 == 0)
	{
		if (func_9(FRONTEND_CONTROL, Global_20469, 0))
		{
			...
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			func_33(Global_20481, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_5(Global_20481, "SET_HEADER", &uLocal_129[iLocal_115 /*6*/], 0, 0, 0, 0);
...
void func_16() // Position - 0x8CD
{
	...
	else
	{
		...
		{
			func_7(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(value), SYSTEM::TO_FLOAT(0), -1f, -1f, &Global_95605[value /*4*/], 0, 0, 0, 0);
			iLocal_113 = iLocal_113 + 1;
...
void func_20() // Position - 0xCE1
{
	...
	for (i = 0; i < 7; i = i + 1)
	{
		if (Global_91565[i /*5*/] != -1)
		{
			if (Global_95814 < 52)
			{
				num = Global_78960.f_109[Global_91565[i /*5*/] /*4*/];
				TEXT_LABEL_COPY(&Global_95605[Global_95814 /*4*/], { func_24(num) }, 4);
	...
	for (i = 0; i < 63; i = i + 1)
	{
		if (IS_BIT_SET(Global_113810.f_18577[i /*6*/], 0) && IS_BIT_SET(Global_113810.f_18577[i /*6*/], 1) && !IS_BIT_SET(Global_113810.f_18577[i /*6*/], 3))
		{
			if (Global_95814 < 52)
			{
				TEXT_LABEL_COPY(&Global_95605[Global_95814 /*4*/], { func_22(i) }, 4);
				Global_95814 = Global_95814 + 1;
			}
			else
			{
	...
	for (i = 0; i < 20; i = i + 1)
	{
		if (IS_BIT_SET(Global_113810.f_9088.f_99.f_219[0], i))
		{
			if (Global_95814 < 52)
			{
				TEXT_LABEL_ASSIGN_STRING(&Global_95605[Global_95814 /*4*/], func_21(i), 16);
				Global_95814 = Global_95814 + 1;
			}
			else
			{
