...
void func_67(int iParam0, int iParam1, int iParam2) // Position - 0x7E1F (32287)
{
	BOOL flag;
	int num;
...
int func_137(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x1508E (86158)
{
	int num;
...
int func_147(var uParam0) // Position - 0x1555C (87388)
{
	int num;
	int i;
...
int func_152(Hash hParam0, Hash hParam1) // Position - 0x1621A (90650)
{
	...
	unk = Global_2740438.f_991[func_145(hParam0, hParam1)];
	return unk;
}
...
int _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x189A2 (100770)
{
	int profileSetting;
