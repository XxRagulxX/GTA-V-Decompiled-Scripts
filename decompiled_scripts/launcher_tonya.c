...
void func_217(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE88F (59535)
{
...
BOOL func_229(Any* panParam0, BOOL bParam1) // Position - 0xED3F (60735)
{
	...
	if (func_266(*panParam0) || func_264(*panParam0) || Global_80608 == 1)
		return true;
...
BOOL func_269(int iParam0) // Position - 0x10A04 (68100)
{
	int i;
