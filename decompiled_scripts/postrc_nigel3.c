	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			else if (!func_25())
			{
				...
				if (!IS_BIT_SET(Global_114990.f_18583.f_382, 5))
					MISC::SET_BIT(&(Global_114990.f_18583.f_382), 5);
...
void func_20(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x904 (2308)
{
...
void func_24(int iParam0, int iParam1) // Position - 0xA61 (2657)
{
...
void func_27() // Position - 0xADF (2783)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114990.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_28(character) && !func_16(14) || Global_113936)
			{
