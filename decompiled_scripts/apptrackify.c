...
{
	fLocal_23 = Global_4542491[iParam0 /*3*/] - uLocal_18;
	fLocal_24 = SYSTEM::COS((3.14159f / 180f) * uLocal_18) * (Global_4542491[iParam0 /*3*/].f_1 - uLocal_18.f_1);
...
{
	fLocal_27 = SYSTEM::SQRT(SYSTEM::VDIST2(Global_4542491[iParam0 /*3*/], uLocal_18));
	fLocal_28 = Global_4542491[iParam0 /*3*/].f_2 - uLocal_18.f_2;
	return fLocal_27;
}

float func_13(int iParam0) // Position - 0x717
{
	fLocal_26 = SYSTEM::SQRT(((Global_4542491[iParam0 /*3*/] - uLocal_18) * (Global_4542491[iParam0 /*3*/] - uLocal_18)) + ((Global_4542491[iParam0 /*3*/].f_1 - uLocal_18.f_1) * (Global_4542491[iParam0 /*3*/].f_1 - uLocal_18.f_1)));
	return fLocal_26;
}
