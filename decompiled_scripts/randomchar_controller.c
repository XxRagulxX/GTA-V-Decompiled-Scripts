...
int func_62(int iParam0) // Position - 0x3382 (13186)
{
	...
	{
		if (func_68(iParam0, Global_21666) == 1)
		{
			func_67(iParam0, Global_21666, 0);
		
			if (func_66(iParam0, Global_21666) == 0)
			{
				num = Global_21666;
				func_63(iParam0, num);
			}
...
BOOL func_129(int iParam0) // Position - 0x9403 (37891)
{
	int i;
...
int func_131(int iParam0) // Position - 0x9474 (38004)
{
	if (Global_44938 == 15)
		return 0;
