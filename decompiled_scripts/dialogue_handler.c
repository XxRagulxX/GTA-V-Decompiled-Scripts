				...
				else
				{
					if (iLocal_28 == 0)
					{
						...
						else
						{
							...
							{
								func_121(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(4), -1f, -1f, &Global_21987, "CELL_300" /*CHAR_DEFAULT*/, &(Global_117[Global_7685 /*10*/].f_4), "CELL_195" /*Unknown*/, 0);
								func_51(Global_20481, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
							}
							else
							{
					...
					if (func_49(FRONTEND_CONTROL, Global_20469, 0))
					{
						...
						else if (Global_21843 > 0)
						{
							...
							if (IS_BIT_SET(Global_8371, 9))
							{
								...
								{
									uLocal_109[i] = func_44(&Global_22104[i /*6*/]);
									uLocal_140[i] = func_44(&Global_22466[i /*6*/]);
								}
							...
							{
								func_25(&Global_21134, Global_7685, &Global_21921, &Global_21999[0 /*6*/], &Global_22051[0 /*6*/], &Global_21999[1 /*6*/], &Global_22051[1 /*6*/], 9, 0, 0, 0, false);
							}
					...
					if (func_49(FRONTEND_CONTROL, Global_20470, 0) || IS_BIT_SET(Global_8370, 24))
					{
						...
						else if (Global_21843 > 0)
						{
							...
							if (IS_BIT_SET(Global_8371, 9))
							{
								...
								{
									uLocal_171[j] = func_44(&Global_22285[j /*6*/]);
									uLocal_202[j] = func_44(&Global_22647[j /*6*/]);
								}
							...
							{
								func_25(&Global_21134, Global_7685, &Global_21921, &Global_22012[0 /*6*/], &Global_22064[0 /*6*/], &Global_22012[1 /*6*/], &Global_22064[1 /*6*/], 9, 0, 0, 0, false);
							}
	...
	switch (Global_20500.f_1)
	{
		...
		case 9:
			if (Global_20499 == 1)
			{
				...
				{
					func_121(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_117[Global_7685 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, "CELL_217" /*INCOMING CALL*/, "CELL_195" /*Unknown*/, 0);
				}
				else
				{
					func_121(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_2058[Global_7685 /*29*/].f_3), &(Global_2058[Global_7685 /*29*/].f_7), "CELL_217" /*INCOMING CALL*/, &(Global_2058[Global_7685 /*29*/].f_3), 0);
				}
			...
			else if (Global_21845 == 4 || Global_21845 == 3)
			{
				...
				else
				{
					...
					if (func_50(Global_7685, Global_20500) == 0)
					{
						...
						func_121(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_7685 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, &unk, "CELL_195" /*Unknown*/, 0);
					}
					else
					{
						func_51(Global_20481, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_121(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_2058[Global_7685 /*29*/].f_3), &(Global_2058[Global_7685 /*29*/].f_7), &unk, &(Global_2058[Global_7685 /*29*/].f_3), 0);
					}
				}
				...
				if (iParam0 == Global_8377[num /*15*/].f_11)
				{
					if (i == Global_8377[num /*15*/].f_4)
					{
						if (Global_8939[i] == 0)
						{
							...
							if (Global_2694571)
								if (num == 14)
									func_121(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22908), -1f, &Global_8377[num /*15*/], 0, 0, 0, 0);
					...
					if (i == Global_8377[num /*15*/].f_4)
					{
						if (Global_8939[i] == 0)
						{
							...
							if (num == 1)
							{
								...
								func_121(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num /*15*/].f_10), SYSTEM::TO_FLOAT(Global_22913), -1f, &Global_8377[num /*15*/], 0, 0, 0, 0);
							}
							else if (num == 7)
							{
								if (Global_78689)
								{
									...
									func_121(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num /*15*/].f_10), SYSTEM::TO_FLOAT(value2), -1f, &Global_8377[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20500)
									...
									func_121(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num /*15*/].f_10), SYSTEM::TO_FLOAT(value3), -1f, &Global_8377[num /*15*/], 0, 0, 0, 0);
								}
							}
							else if (num == 14)
							{
							...
							else if (Global_8377[num /*15*/].f_10 == 57 && num == 23)
							{
								...
								func_121(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num /*15*/].f_10), SYSTEM::TO_FLOAT(value6), -1f, &Global_8377[num /*15*/], 0, 0, 0, 0);
							}
							else
							{
								func_121(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &Global_8377[num /*15*/], 0, 0, 0, 0);
							}
...
void func_67() // Position - 0x347C
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_20481))
	{
		if (!Global_21853)
		{
			...
			{
				func_121(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_7685 /*10*/].f_4), "CELL_300" /*CHAR_DEFAULT*/, "CELL_219" /*CONNECTED*/, "CELL_195" /*Unknown*/, 0);
			}
			else
			{
				func_121(Global_20481, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_2058[Global_7685 /*29*/].f_3), &(Global_2058[Global_7685 /*29*/].f_7), "CELL_219" /*CONNECTED*/, &(Global_2058[Global_7685 /*29*/].f_3), 0);
			}
		}
...
void func_74() // Position - 0x38D8
{
	...
	while (iLocal_90 < Global_21841)
	{
		...
		{
			uLocal_42 = { Global_21464.f_6[iLocal_90 /*6*/] };
			TEXT_LABEL_APPEND_STRING(&uLocal_42, "A", 24);
			Global_20713[num3 /*6*/] = { Global_21464.f_6[iLocal_90 /*6*/] };
			TEXT_LABEL_APPEND_STRING(&Global_20713[num3 /*6*/], "_", 24);
			TEXT_LABEL_APPEND_INT(&Global_20713[num3 /*6*/], num2, 24);
			uLocal_36 = { Global_20713[num3 /*6*/] };
			...
			if (HUD::DOES_TEXT_LABEL_EXIST(&uLocal_36))
			{
				...
				if (HUD::DOES_TEXT_LABEL_EXIST(&Global_20713[num3 /*6*/]))
				{
					if (MISC::ARE_STRINGS_EQUAL(&Global_20713[num3 /*6*/], &Global_21464.f_187[iLocal_90 /*6*/]))
					{
						num4 > 36 || num5 > 36;
						AUDIO::ADD_LINE_TO_CONVERSATION(num4, &uLocal_48, &Global_20713[num3 /*6*/], num5, num6, false, flag, flag2, flag3, num7, p10, p11, p12);
					}
				}
			...
			else if (HUD::DOES_TEXT_LABEL_EXIST(&uLocal_42))
			{
				...
				p11 = func_76(0);
				p12 = func_75(0);
				AUDIO::ADD_LINE_TO_CONVERSATION(num4, &uLocal_48, &Global_21464.f_6[iLocal_90 /*6*/], num5, num6, true, flag, flag2, flag3, num7, p10, p11, p12);
				TEXT_LABEL_ASSIGN_STRING(&Global_20713[num3 /*6*/], "END", 24);
				iLocal_27 = 1;
			}
			else
			{
...
{
	uLocal_83 = { Global_21464.f_6[iLocal_90 /*6*/] };
...
{
	uLocal_71 = { Global_21464.f_6[iLocal_90 /*6*/] };
...
{
	uLocal_64 = { Global_21464.f_6[iLocal_90 /*6*/] };
...
void func_93() // Position - 0x41D2
{
	...
	while (num3 < 70 && iLocal_27 == 0)
	{
		...
		TEXT_LABEL_APPEND_STRING(&uLocal_42, "A", 24);
		Global_20713[num3 /*6*/] = { Global_21464 };
		TEXT_LABEL_APPEND_STRING(&Global_20713[num3 /*6*/], "_", 24);
		TEXT_LABEL_APPEND_INT(&Global_20713[num3 /*6*/], num2, 24);
		uLocal_36 = { Global_20713[num3 /*6*/] };
		TEXT_LABEL_APPEND_STRING(&uLocal_36, "A", 24);
		...
		if (HUD::DOES_TEXT_LABEL_EXIST(&uLocal_36))
		{
			...
			if (HUD::DOES_TEXT_LABEL_EXIST(&Global_20713[num3 /*6*/]))
			{
				...
				else if (MISC::ARE_STRINGS_EQUAL(&Global_20713[num3 /*6*/], &Global_22843))
				{
					num4 > 36 || num5 > 36;
					AUDIO::ADD_LINE_TO_CONVERSATION(num4, &uLocal_48, &Global_20713[num3 /*6*/], num5, num6, false, flag, flag2, flag3, num7, p10, p11, p12);
					Global_22855 = num3;
...
void func_94() // Position - 0x45EB
{
	...
	for (i = 0; i <= 15; i = i + 1)
	{
		if (Global_21134[i /*10*/].f_7 == 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_21134[i /*10*/]) || Global_21134[i /*10*/] == 0)
				AUDIO::ADD_PED_TO_CONVERSATION(i, Global_21134[i /*10*/], &(Global_21134[i /*10*/].f_1));
	...
	if (Global_4542490 == 1)
	{
		...
		for (i = 0; i <= 19; i = i + 1)
		{
			if (Global_4542309[i /*9*/].f_7 == 1)
				if (ENTITY::DOES_ENTITY_EXIST(Global_4542309[i /*9*/]) || Global_4542309[i /*9*/] == 0)
					AUDIO::ADD_PED_TO_CONVERSATION(Global_4542309[i /*9*/].f_8, Global_4542309[i /*9*/], &(Global_4542309[i /*9*/].f_1));
		}
	}
...
void func_107() // Position - 0x52BE
{
	...
	num = func_108(Global_20453[Global_20445 /*3*/], Global_20446[Global_20445 /*3*/], Global_20460, Global_20431, 350f, false);
