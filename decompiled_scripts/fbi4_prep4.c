...
int func_127(int iParam0) // Position - 0x6FE1 (28641)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_156(Vehicle veParam0) // Position - 0x84EB (34027)
{
	if (PLAYER::PLAYER_ID() != _INVALID_PLAYER_INDEX())
	{
		...
		if (func_160(PLAYER::PLAYER_ID(), true, false) && Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_260.f_39 > 0 || IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_260.f_37, 14) || IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_260.f_37, 11))
			return false;
...
int func_158() // Position - 0x8612 (34322)
{
...
int func_163() // Position - 0x86DA (34522)
{
...
BOOL func_175(Hash hParam0) // Position - 0x931A (37658)
{
	if (hParam0 == 0)
		return false;

	if (!func_176(hParam0, false, -1))
		return false;
...
BOOL func_176(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x94D8 (38104)
{
	int i;
	Hash outData;
...
BOOL func_179(Hash hParam0, int iParam1) // Position - 0x9740 (38720)
{
	int cloudTimeAsInt;
	int num;
	int i;
...
BOOL func_228(int iParam0) // Position - 0xD0D4 (53460)
{
	int num;
...
BOOL func_229(int iParam0) // Position - 0xD0F9 (53497)
{
	int num;
