...
void main() // Position - 0x0 (0)
{
	...
	sLocal_205 = "FBIPRD";
	uLocal_211 = { 0f, 0f, 0f };
	uLocal_214 = { -1335.3142f, -1277.9427f, 3.8649f };
	uLocal_217 = { -1336.3777f, -1279.0555f, 3.855f };
	iLocal_222 = -1;
	sLocal_229 = "FBIPRAU";
	...
	if (func_313())
		func_312(-1339.7863f, -1277.5099f, 3.8874f, 261.2839f, 1, 0);

	if (func_311(false))
	{
		Global_114990.f_2370.f_539.f_2395[0] = -99;
		Global_114990.f_2370.f_539.f_2395[1] = -99;
		Global_114990.f_2370.f_539.f_2395[2] = -99;
		func_274();
	}
...
void func_1() // Position - 0x1D0 (464)
{
	switch (iLocal_98)
	{
		case 0:
			...
			if (!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_204))
			{
				if (MISC::ARE_STRINGS_EQUAL(sLocal_204, "PRE_FKICKOFF"))
				{
					while (MISC::GET_GAME_TIMER() - iLocal_222 < 3000)
					{
						BUILTIN::WAIT(0);
					}
				}
...
void func_4(int iParam0) // Position - 0x28C (652)
{
	...
	if (Global_114990.f_9094 || func_311(false))
	{
		num = func_18();
...
void func_23() // Position - 0x129C (4764)
{
	...
	{
		case 0:
			if (func_97(iLocal_97, bLocal_45))
			{
		...
		case 1:
			if (func_96(PLAYER::PLAYER_PED_ID(), uLocal_217, 2f, true) && func_89(21))
			{
			...
			else
			{
				...
				else if (!func_96(PLAYER::PLAYER_PED_ID(), uLocal_214, 75f, true))
				{
					if (!bLocal_224)
					{
						func_22(&blLocal_209);
					...
					func_86(&blLocal_209, uLocal_217, true, true, "PRD_SHOP");
				}
				else if (func_96(PLAYER::PLAYER_PED_ID(), uLocal_217, 12f, true))
				{
					if (bLocal_224)
					{
						func_22(&blLocal_209);
					...
					func_86(&blLocal_209, uLocal_217, true, true, "PRD_BLIP");
				
					if (HUD::DOES_BLIP_EXIST(blLocal_209))
					{
						HUD::SET_BLIP_COLOUR(blLocal_209, 2);
						HUD::SET_BLIP_ROUTE_COLOUR(blLocal_209, 2);
					}
				}
			}
			break;
		...
		case 2:
			if (MISC::GET_GAME_TIMER() - iLocal_221 > 2000)
			{
				...
				if (func_44(&uLocal_399, &uLocal_395, &uLocal_230))
				{
					func_43(false, -1);
				
					if (Global_114990.f_2370.f_539.f_2395[0] == 38 && Global_114990.f_2370.f_539.f_2395[1] == 33 && Global_114990.f_2370.f_539.f_2395[2] == 54)
						func_42(821);
		...
		case 3:
			Global_114990.f_2370.f_539.f_2395[0] = 38;
			Global_114990.f_2370.f_539.f_2395[1] = 33;
			Global_114990.f_2370.f_539.f_2395[2] = 54;
			func_24(1, 1, 1);
			iLocal_98 = 2;
			break;
	}
...
void func_40(BOOL bParam0, BOOL bParam1) // Position - 0x18E8 (6376)
{
	...
	if (bParam0)
	{
		if (func_311(false) && Global_80609.f_1 == 1 && func_41(Global_80609))
		{
		}
		else
		{
...
int func_52(int iParam0, int iParam1, eCharacter echParam2, eCharacter echParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x1DDE (7646)
{
	...
	if (Global_114990.f_7697.f_136 < 9)
	{
		num = iParam0;
...
Ped func_58(eCharacter echParam0) // Position - 0x21E2 (8674)
{
	...
	return Global_99964[func_59(echParam0)];
}
...
void func_76(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x29D5 (10709)
{
...
BOOL func_97(int iParam0, BOOL bParam1) // Position - 0x32F9 (13049)
{
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_100(1, uLocal_211, 0))
			{
				return true;
			}
			break;
		...
		case 2:
			if (bParam1)
			{
				func_98(PLAYER::PLAYER_PED_ID(), uLocal_217, 261.2839f);
				bLocal_45 = false;
				func_24(1, 1, 1);
			}
			else
...
BOOL func_100(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x3426 (13350)
{
	...
	{
		case 0:
			if (func_101(uParam1, uLocal_211, 1056964608, false) && iParam4 == 0f)
				return true;
			break;
	
		case 1:
			HUD::REQUEST_ADDITIONAL_TEXT(sLocal_205, 0);
			HUD::REQUEST_ADDITIONAL_TEXT(sLocal_229, 6);
...
void func_104() // Position - 0x356D (13677)
{
	switch (iLocal_98)
	{
		...
		case 1:
			if (!bLocal_220)
			{
				if (func_96(PLAYER::PLAYER_PED_ID(), uLocal_214, 60f, true))
				{
					func_109("PRD_GCLOTH", &iLocal_206);
					func_22(&blLocal_209);
					func_86(&blLocal_209, uLocal_217, true, true, "PRD_BLIP");
		...
		case 3:
			func_98(PLAYER::PLAYER_PED_ID(), uLocal_217, 0f);
			func_24(1, 1, 1);
			iLocal_98 = 1;
			break;
	}
...
{
	func_106(iLocal_97);
	iLocal_203 = iLocal_97;

	if (!bParam0)
		iLocal_97 = iLocal_203 + 1;
...
void func_117(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, Hash hParam10, int iParam11, eCharacter echParam12, int iParam13) // Position - 0x39FE (14846)
{
	...
	if (num == 1)
	{
		...
		*uParam0 = func_228(fParam1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_227(fParam1, 0f, 0f, 0f, false))
		{
		...
		func_218(fParam1, 5f, false);
	
		if (func_14(echParam12))
		{
			func_216(echParam12, 0);
...
BOOL func_118(var uParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6, int iParam7) // Position - 0x3B92 (15250)
{
	...
	if (func_14(echParam1))
	{
		...
		model.f_31 = 49;
		model.f_81 = 2;
		func_215(echParam1, &model, iParam7);
		...
		if (Global_114990.f_2370.f_539.f_2407[0 /*295*/][echParam1 /*98*/] == model)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114990.f_2370.f_539.f_2407[0 /*295*/][echParam1 /*98*/]))
			{
				*uParam0 = VEHICLE::CREATE_VEHICLE(Global_114990.f_2370.f_539.f_2407[0 /*295*/][echParam1 /*98*/], vParam2, fParam5, false, false, false);
				...
				if (func_214(&plateText, &plateIndex))
				{
				...
				func_204(uParam0, &(Global_114990.f_2370.f_539.f_2407[0 /*295*/][echParam1 /*98*/].f_31), &(Global_114990.f_2370.f_539.f_2407[0 /*295*/][echParam1 /*98*/].f_81));
		...
		else if (Global_114990.f_2370.f_539.f_2407[1 /*295*/][echParam1 /*98*/] == model)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114990.f_2370.f_539.f_2407[1 /*295*/][echParam1 /*98*/]))
			{
				*uParam0 = VEHICLE::CREATE_VEHICLE(Global_114990.f_2370.f_539.f_2407[1 /*295*/][echParam1 /*98*/], vParam2, fParam5, false, false, false);
				...
				func_204(uParam0, &(Global_114990.f_2370.f_539.f_2407[1 /*295*/][echParam1 /*98*/].f_31), &(Global_114990.f_2370.f_539.f_2407[1 /*295*/][echParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*uParam0, model.f_96);
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(model))
			{
				...
				*uParam0 = VEHICLE::CREATE_VEHICLE(model, vParam2, fParam5, true, true, false);
				...
				func_204(uParam0, &(model.f_31), &(model.f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*uParam0, model.f_96);
...
void func_119(eCharacter echParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x49B8 (18872)
{
	...
	if (func_14(echParam0) && ENTITY::DOES_ENTITY_EXIST(*uParam1) && VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, false))
	{
		...
		{
			func_123(uParam1, &(Global_114990.f_2370.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_31), &(Global_114990.f_2370.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_81));
			...
			if (bParam3)
			{
				...
				Global_114990.f_20127[echParam0 /*43*/].f_31 = func_122(*uParam1);
				...
				func_120(Global_114990.f_2370.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_5, Global_114990.f_2370.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_7, num, true, &(Global_114990.f_20127[echParam0 /*43*/].f_1));
				...
				func_120(Global_114990.f_2370.f_539.f_2407[iParam2 /*295*/][echParam0 /*98*/].f_6, -1, num, false, &(Global_114990.f_20127[echParam0 /*43*/].f_2));
			}
		}
	}
...
BOOL func_124(Vehicle veParam0, BOOL bParam1, var uParam2) // Position - 0x6DD4 (28116)
{
	...
	*uParam2 = 0;
	...
	if (func_171(true))
		if (func_170(veParam0, true) && VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("speedo")))
			return true;

	if (!func_168(entityModel, bParam1, uParam2) && !func_167(PLAYER::PLAYER_ID()) && !func_139(veParam0))
		return false;
...
BOOL func_125(Vehicle veParam0) // Position - 0x6F85 (28549)
{
	int i;
...
BOOL func_126(Player plParam0) // Position - 0x6FC0 (28608)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658296[plParam0 /*468*/].f_325.f_8 != -1)
				return func_127(Global_2658296[plParam0 /*468*/].f_325.f_8) == 32;

	return false;
}

int func_127(int iParam0) // Position - 0x7007 (28679)
{
	switch (iParam0)
	{
		case 0:
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x7570 (30064)
{
	Player player;
...
BOOL func_129(Hash hParam0) // Position - 0x75D0 (30160)
{
...
BOOL func_130(Player plParam0) // Position - 0x75E7 (30183)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658296[plParam0 /*468*/].f_325.f_8 != -1)
				return func_127(Global_2658296[plParam0 /*468*/].f_325.f_8) == 11;

	return false;
}

BOOL func_131(Hash hParam0) // Position - 0x762E (30254)
{
...
BOOL func_132(Vehicle veParam0) // Position - 0x7670 (30320)
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
...
BOOL func_133(Player plParam0) // Position - 0x7738 (30520)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658296[plParam0 /*468*/].f_325.f_8 != -1)
				return func_127(Global_2658296[plParam0 /*468*/].f_325.f_8) == 26;

	return false;
}

BOOL func_134(Player plParam0) // Position - 0x777F (30591)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658296[plParam0 /*468*/].f_325.f_8 != -1)
				return func_127(Global_2658296[plParam0 /*468*/].f_325.f_8) == 13;

	return false;
}

BOOL func_135(Player plParam0) // Position - 0x77C6 (30662)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658296[plParam0 /*468*/].f_325.f_8 != -1)
				return func_127(Global_2658296[plParam0 /*468*/].f_325.f_8) == 7;

	return false;
}

BOOL func_136(Hash hParam0) // Position - 0x780C (30732)
{
	BOOL flag;
...
Hash func_137(BOOL bParam0) // Position - 0x789D (30877)
{
	if (bParam0)
...
BOOL func_138(Player plParam0) // Position - 0x78B7 (30903)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_139(Vehicle veParam0) // Position - 0x78DD (30941)
{
...
BOOL func_140(Vehicle veParam0) // Position - 0x790C (30988)
{
...
BOOL func_141(Vehicle veParam0) // Position - 0x7A74 (31348)
{
	Hash entityModel;
...
BOOL func_142(Hash hParam0) // Position - 0x7AF1 (31473)
{
	switch (hParam0)
	{
		case joaat("mule"):
...
BOOL func_143(Player plParam0) // Position - 0x7B4D (31565)
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;

	if (func_167(plParam0) && Global_2658296[plParam0 /*468*/].f_325.f_11 == plParam0)
		return true;

	return false;
}

BOOL func_144(Vehicle veParam0, BOOL bParam1) // Position - 0x7B86 (31622)
{
	switch (ENTITY::GET_ENTITY_MODEL(veParam0))
	{
...
int func_145(Vehicle veParam0) // Position - 0x7BE1 (31713)
{
	int i;
...
BOOL func_146(Hash hParam0, int iParam1) // Position - 0x7C1A (31770)
{
	if (iParam1 == 0)
...
BOOL func_156(Hash hParam0) // Position - 0x850D (34061)
{
	switch (hParam0)
	{
		case 707880171:
...
BOOL func_157(Vehicle veParam0) // Position - 0x852A (34090)
{
	if (PLAYER::PLAYER_ID() != _INVALID_PLAYER_INDEX())
	{
		...
		if (func_161(PLAYER::PLAYER_ID(), true, false) && Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_260.f_39 > 0 || IS_BIT_SET(Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_260.f_37, 14) || IS_BIT_SET(Global_1845347[PLAYER::PLAYER_ID() /*884*/].f_260.f_37, 11))
			return false;
	
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("Player_Vehicle", INT))
			if (DECORATOR::DECOR_EXIST_ON(veParam0, "Player_Vehicle"))
				if (DECORATOR::DECOR_GET_INT(veParam0, "Player_Vehicle") == NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()))
					if (func_159() != -1 && func_159() < 607)
						if (!func_158(veParam0) || ENTITY::GET_ENTITY_MODEL(veParam0) != Global_1583778[func_159() /*143*/].f_66)
							return true;
...
BOOL func_158(Vehicle veParam0) // Position - 0x8638 (34360)
{
...
int func_159() // Position - 0x8651 (34385)
{
	return Global_2359296[func_160() /*5574*/].f_681.f_2;
}

int func_160() // Position - 0x8669 (34409)
{
	int num;
...
BOOL func_161(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8676 (34422)
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return false;
...
BOOL func_162(Player plParam0) // Position - 0x86DA (34522)
{
...
BOOL func_163() // Position - 0x870B (34571)
{
	return func_164() != -1;
}

int func_164() // Position - 0x8719 (34585)
{
	return Global_2658296[PLAYER::PLAYER_ID() /*468*/].f_325.f_8;
}

BOOL func_165(Player plParam0) // Position - 0x8731 (34609)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658296[plParam0 /*468*/].f_325.f_8 != -1 && Global_2658296[plParam0 /*468*/].f_325.f_11 != _INVALID_PLAYER_INDEX())
				return func_127(Global_2658296[plParam0 /*468*/].f_325.f_8) == 5;

	return false;
}

BOOL func_166(Player plParam0) // Position - 0x8790 (34704)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658296[plParam0 /*468*/].f_325.f_8 != -1 && Global_2658296[plParam0 /*468*/].f_325.f_11 != _INVALID_PLAYER_INDEX())
				return func_127(Global_2658296[plParam0 /*468*/].f_325.f_8) == 8;

	return false;
}

BOOL func_167(Player plParam0) // Position - 0x87F0 (34800)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658296[plParam0 /*468*/].f_325.f_8 != -1)
				return func_127(Global_2658296[plParam0 /*468*/].f_325.f_8) == 9;

	return false;
}

BOOL func_168(Hash hParam0, BOOL bParam1, var uParam2) // Position - 0x8837 (34871)
{
	BOOL flag;
...
BOOL func_169(Hash hParam0) // Position - 0x8C1A (35866)
{
	switch (hParam0)
	{
		case joaat("towtruck"):
...
BOOL func_170(Vehicle veParam0, BOOL bParam1) // Position - 0x8C4F (35919)
{
	if (Global_80362)
...
BOOL func_171(BOOL bParam0) // Position - 0x8CA3 (36003)
{
	if (bParam0)
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
			return false;

	return func_172(PLAYER::PLAYER_ID()) == 0;
}

int func_172(Player plParam0) // Position - 0x8CCA (36042)
{
	if (func_176(plParam0) == 373)
		return func_173(plParam0, 373);

	return -1;
}

int func_173(Player plParam0, int iParam1) // Position - 0x8CEB (36075)
{
...
int func_174(Player plParam0) // Position - 0x8D08 (36104)
{
...
BOOL func_175(Player plParam0, BOOL bParam1) // Position - 0x8D2B (36139)
{
	if (func_33(plParam0))
...
int func_176(Player plParam0) // Position - 0x8D6F (36207)
{
	if (func_33(plParam0))
		if (func_175(plParam0, false))
...
void func_177(Vehicle veParam0, eCharacter echParam1) // Position - 0x8D9B (36251)
{
	...
	func_178(veParam0, &(Global_114990.f_32759.f_5510));
	return;
}

void func_178(Vehicle veParam0, var uParam1) // Position - 0x8F9D (36765)
{
	int i;
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(veParam0);
		...
		for (i = 0; i <= 11; i = i + 1)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, i + 1))
				MISC::SET_BIT(&(uParam1->f_77), func_179(i + 1));
		}
...
int func_179(int iParam0) // Position - 0x9248 (37448)
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_180(int iParam0) // Position - 0x92F8 (37624)
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_181(var uParam0) // Position - 0x9318 (37656)
{
	int i;
...
BOOL func_182(Vehicle veParam0) // Position - 0x93C8 (37832)
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false) || func_199(veParam0, 0, false) || func_199(veParam0, 1, false) || func_199(veParam0, 2, false) || func_198(veParam0) != _CHAR_NULL || func_197(veParam0) || func_196(veParam0) || func_125(veParam0) || func_195(veParam0) || !func_183(ENTITY::GET_ENTITY_MODEL(veParam0)))
	{
		func_196(veParam0);
		func_196(veParam0);
		func_199(veParam0, 0, false);
		func_199(veParam0, 1, false);
		func_199(veParam0, 2, false);
		func_198(veParam0) != _CHAR_NULL;
		return false;
	}
...
BOOL func_183(Hash hParam0) // Position - 0x94A5 (38053)
{
	if (hParam0 == 0)
		return false;

	if (!func_184(hParam0, false, -1))
		return false;
...
BOOL func_184(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x9663 (38499)
{
	int i;
	Hash outData;
	...
	if (hParam0 == joaat("blimp"))
		if (!func_193() && !func_192() && !func_191() && !func_190() && !_IS_EXCLUSIVE_CONTENT_UNLOCKED())
			return false;
...
BOOL func_185(Hash hParam0) // Position - 0x97E8 (38888)
{
	int num;
	var unk;
	var name;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x98B4 (39092)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_187(Hash hParam0, int iParam1) // Position - 0x98CB (39115)
{
	int cloudTimeAsInt;
	int num;
	int i;
...
BOOL func_188() // Position - 0x9A80 (39552)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_189() // Position - 0x9A96 (39574)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_190() // Position - 0x9AAC (39596)
{
	return false;
}

BOOL func_191() // Position - 0x9AB5 (39605)
{
	return true;
}

BOOL func_192() // Position - 0x9ABE (39614)
{
	return true;
}

BOOL func_193() // Position - 0x9AC7 (39623)
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x9AE0 (39648)
{
	int profileSetting;
...
BOOL func_195(Vehicle veParam0) // Position - 0x9B98 (39832)
{
	Hash entityModel;
	...
	if (!func_184(entityModel, false, -1))
		return true;

	return false;
}

BOOL func_196(Vehicle veParam0) // Position - 0x9BDF (39903)
{
	int i;
...
BOOL func_197(Vehicle veParam0) // Position - 0x9C5B (40027)
{
	int i;
...
eCharacter func_198(Vehicle veParam0) // Position - 0x9D43 (40259)
{
	int i;
...
BOOL func_199(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0x9DA6 (40358)
{
	int i;
	var garageName;
	int num;
	...
	for (i = 0; func_200(iParam1, i, &garageName, &num); i = i + 1)
	{
...
BOOL func_200(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x9E14 (40468)
{
...
void func_201(Vehicle veParam0, eCharacter echParam1) // Position - 0x9EEC (40684)
{
	int i;
...
void func_202(var uParam0) // Position - 0x9F6E (40814)
{
	if (!func_203(*uParam0))
...
BOOL func_203(Vehicle veParam0) // Position - 0x9F99 (40857)
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(veParam0, 5);
}

int func_204(var uParam0, var uParam1, var uParam2) // Position - 0x9FA8 (40872)
{
	int i;
	int modType;
	...
	for (i = 0; i < *uParam1; i = i + 1)
	{
		...
		else if (VEHICLE::GET_VEHICLE_MOD(*uParam0, modType) != uParam1->[i] - 1)
		{
			...
			if (uParam1->[i] > 0)
			{
				...
				else if (func_212(*uParam0, modType, uParam1->[i] - 1))
				{
				}
				else
				{
	...
	if (func_209(ENTITY::GET_ENTITY_MODEL(*uParam0)) && VEHICLE::GET_VEHICLE_MOD(*uParam0, 24) != func_207(*uParam0, uParam1->[38] - 1))
		VEHICLE::SET_VEHICLE_MOD(*uParam0, 24, func_207(*uParam0, uParam1->[38] - 1), false);
...
BOOL func_205(Vehicle veParam0) // Position - 0xA1A6 (41382)
{
	int i;
	int modType;
	Hash hashKey;
...
void func_206(var uParam0) // Position - 0xA282 (41602)
{
...
int func_207(Vehicle veParam0, int iParam1) // Position - 0xA2ED (41709)
{
	int value;
	int value2;
	float num;
	...
	if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		value = func_208(veParam0, 38) + 1;
		value2 = func_208(veParam0, 24) + 1;
...
int func_208(Vehicle veParam0, int iParam1) // Position - 0xA3D6 (41942)
{
	int i;
	...
	for (i = VEHICLE::GET_NUM_VEHICLE_MODS(veParam0, iParam1) - 1; i >= 0 && func_212(veParam0, iParam1, i); i = i - 1)
	{
	}
...
BOOL func_209(Hash hParam0) // Position - 0xA438 (42040)
{
	if (func_155(hParam0, 1) && !func_156(hParam0))
		return true;
...
BOOL func_210(Vehicle veParam0) // Position - 0xA46F (42095)
{
	Hash entityModel;
...
BOOL func_211(Hash hParam0) // Position - 0xA4B5 (42165)
{
	switch (hParam0)
	{
		case joaat("brioso"):
...
BOOL func_212(Vehicle veParam0, int iParam1, int iParam2) // Position - 0xA583 (42371)
{
	if (!func_213() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(veParam0, iParam1, iParam2))
		return true;

	return false;
}

BOOL func_213() // Position - 0xA5A7 (42407)
{
	return true;
}

BOOL func_214(var uParam0, var uParam1) // Position - 0xA5B4 (42420)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_215(eCharacter echParam0, var uParam1, int iParam2) // Position - 0xA5F5 (42485)
{
	int num;
...
void func_216(eCharacter echParam0, int iParam1) // Position - 0xA851 (43089)
{
	int i;
	...
	for (i = 0; i < 9; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_99817[i]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_99817[i]) == func_217(echParam0, iParam1))
				{
...
Hash func_217(eCharacter echParam0, int iParam1) // Position - 0xA8EF (43247)
{
	int num;
	...
	if (func_14(echParam0))
	{
		...
		num.f_31 = 49;
		num.f_81 = 2;
		func_215(echParam0, &num, iParam1);
		return num;
	}
	else
	{
...
void func_218(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4) // Position - 0xA931 (43313)
{
	int i;

	for (i = 0; i < 68; i = i + 1)
	{
		if (func_226(&Global_79152.f_555[0 /*21*/], i))
...
void func_219(int iParam0) // Position - 0xA981 (43393)
{
	BOOL flag;
	...
	if (func_226(&Global_79152.f_555[0 /*21*/], iParam0))
	{
		...
		{
			if (iParam0 == 24 && func_225(iParam0, 0) && Global_80061.f_66 == 0 && Global_114990.f_32759.f_1958[Global_79152.f_555[0 /*21*/].f_14] != 0 && Global_114990.f_32759.f_1958[Global_79152.f_555[0 /*21*/].f_14] > 3 && !func_223(0, Global_79152.f_555[0 /*21*/].f_12) || !func_223(1, Global_79152.f_555[0 /*21*/].f_12))
			{
				func_222(&Global_114990.f_32759.f_69[Global_79152.f_555[0 /*21*/].f_14 /*78*/], &Global_80061);
...
void func_220(int iParam0, BOOL bParam1) // Position - 0xAAF0 (43760)
{
	if (iParam0 == -1)
		return;
	...
	if (bParam1)
	{
		...
		{
			func_221(iParam0, 1, false);
			func_221(iParam0, 2, false);
			func_221(iParam0, 3, false);
			func_221(iParam0, 4, false);
			func_221(iParam0, 0, true);
			Global_79152[iParam0] = 1;
		}
	}
	else
	{
		func_221(iParam0, 0, false);
	}

	return;
}

void func_221(int iParam0, int iParam1, BOOL bParam2) // Position - 0xAB4D (43853)
{
	if (iParam0 == -1)
		return;
...
void func_222(var uParam0, var uParam1) // Position - 0xAB88 (43912)
{
...
BOOL func_223(int iParam0, int iParam1) // Position - 0xAC54 (44116)
{
	int num;
	...
	if (iParam0 < 0 || iParam0 >= func_224(&Global_114990.f_32759.f_5038[num /*157*/]))
		return false;

	return func_184(Global_114990.f_32759.f_5038[num /*157*/][iParam0 /*78*/].f_66, false, -1);
}

int func_224(var uParam0) // Position - 0xACC7 (44231)
{
	return *uParam0;
}

BOOL func_225(int iParam0, int iParam1) // Position - 0xACD2 (44242)
{
	if (iParam0 == -1)
		return false;
...
BOOL func_226(var uParam0, int iParam1) // Position - 0xACF2 (44274)
{
	BOOL num;
	int num2;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	switch (iParam1)
	{
		case 0:
			*uParam0 = { -831.8538f, 172.1154f, 69.9058f };
			...
			uParam0->f_4 = func_217(CHAR_MICHAEL, 1);
			uParam0->f_12 = 0;
		...
		case 2:
			*uParam0 = { -22.6297f, -1439.1368f, 29.6549f };
			...
			uParam0->f_4 = func_217(CHAR_FRANKLIN, 1);
			uParam0->f_12 = 1;
			MISC::SET_BIT(&(uParam0->f_9), 20);
			MISC::SET_BIT(&(uParam0->f_9), 7);
			num = 1;
		...
		case 3:
			*uParam0 = { -22.5229f, -1434.6986f, 29.6552f };
			...
			uParam0->f_4 = func_217(CHAR_FRANKLIN, 2);
			uParam0->f_12 = 1;
		...
		case 6:
			*uParam0 = { 1981.4163f, 3808.1313f, 31.1384f };
			...
			uParam0->f_4 = func_217(CHAR_TREVOR, 1);
			uParam0->f_12 = 2;
			MISC::SET_BIT(&(uParam0->f_9), 20);
			MISC::SET_BIT(&(uParam0->f_9), 7);
			num = 1;
	...
	if (IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_227(Global_114990.f_32759.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, false))
	...
	{
		if (!func_227(Global_114990.f_2370.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
	...
	{
		if (!func_227(Global_114990.f_2370.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, false))
		{
...
BOOL func_227(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xC3E1 (50145)
{
	if (bParam6)
...
Vehicle func_228(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0xC428 (50216)
{
	return func_229(&(Global_108531.f_2890), uParam0, fParam3, false);
}

Vehicle func_229(var uParam0, float fParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xC442 (50242)
{
	Vehicle vehicle;
	...
	if (func_250(uParam0))
	{
		...
		if (func_249(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(vehicle))
			{
				...
				func_233(vehicle, &(uParam0->f_12), false, true);
				flag = true;
				...
				if (uParam0->f_7 == 1)
				{
					...
					func_201(vehicle, uParam0->f_11);
				}
				else if (!func_231(vehicle, uParam0->f_3, uParam0->f_8) && uParam0->f_10 && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					num = func_230(vehicle);
...
int func_230(Vehicle veParam0) // Position - 0xC6F4 (50932)
{
	int i;
	var colorPrimary;
	var colorSecondary;
...
BOOL func_231(Vehicle veParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xC7B7 (51127)
{
	Hash entityModel;
	var sizeAndVehs;
	...
	{
		case joaat("cargobob"):
			if (func_232(veParam0, Global_79152.f_139[38], false))
			{
				func_219(38);
				return true;
			}
		...
		case joaat("firetruk"):
			if (func_232(veParam0, Global_79152.f_139[43], true))
			{
				func_219(43);
				return true;
			}
		...
		case joaat("cuban800"):
			...
			{
				if (func_232(veParam0, sizeAndVehs[i], true) && func_101(ENTITY::GET_ENTITY_COORDS(sizeAndVehs[i], true), 2136.133f, 4780.5635f, 39.9702f, 5f, false))
				{
					if (!bParam4 || func_227(uParam1, 0f, 0f, 0f, false) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(veParam0, true), ENTITY::GET_ENTITY_COORDS(sizeAndVehs[i], true), true) < 10f)
					{
...
BOOL func_232(Vehicle veParam0, Vehicle veParam1, BOOL bParam2) // Position - 0xC9BF (51647)
{
	var colorPrimary;
	var colorSecondary;
	var colorPrimary2;
...
void func_233(Vehicle veParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xCA20 (51744)
{
	int num;
	int num2;
	int i;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (IS_BIT_SET(uParam1->f_77, 15) || func_242(veParam0) || uParam1->f_62 == 0 && uParam1->f_63 == 0 && uParam1->f_64 == 0 && uParam1->f_9[20] > 0 && func_241())
		{
			uParam1->f_62 = 0;
			uParam1->f_63 = 0;
			uParam1->f_64 = 0;
		...
		if (uParam1->f_69 > -1 && uParam1->f_69 < 255)
			if (!VEHICLE::IS_THIS_MODEL_A_BICYCLE(ENTITY::GET_ENTITY_MODEL(veParam0)))
				if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(veParam0)))
					if (uParam1->f_69 == 6)
						func_240(veParam0, uParam1->f_69);
				else
					func_240(veParam0, uParam1->f_69);
		...
		if (bParam3)
			func_204(&veParam0, &(uParam1->f_9), &(uParam1->f_59));
		...
		if (func_235() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(veParam0) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, joaat("avenger")) && !VEHICLE::IS_VEHICLE_MODEL(veParam0, func_137(true)))
			if (!IS_BIT_SET(uParam1->f_77, 23))
				if (!IS_BIT_SET(uParam1->f_77, 22) && func_234(veParam0, 5f))
...
BOOL func_234(Vehicle veParam0, float fParam1) // Position - 0xD141 (53569)
{
	float entityCoords;
	var groundZ;
...
BOOL func_235() // Position - 0xD1B2 (53682)
{
	...
	if (func_238(7))
		if (func_237(Global_2673276.f_4.f_16) || func_236(Global_2673276.f_4.f_16))
			return false;

	return true;
}

BOOL func_236(int iParam0) // Position - 0xD241 (53825)
{
	int num;
...
BOOL func_237(int iParam0) // Position - 0xD266 (53862)
{
	int num;
...
BOOL func_238(int iParam0) // Position - 0xD284 (53892)
{
	return func_239(&(Global_2673276.f_194), iParam0);
}

BOOL func_239(var uParam0, int iParam1) // Position - 0xD298 (53912)
{
	int num;
	int num2;
	int num3;
...
void func_240(Vehicle veParam0, int iParam1) // Position - 0xD2BB (53947)
{
	int vehicleMod;
...
BOOL func_241() // Position - 0xD333 (54067)
{
	return DLC::IS_DLC_PRESENT(joaat("mpindependence"));
}

BOOL func_242(Vehicle veParam0) // Position - 0xD344 (54084)
{
	int _int;
...
int func_243(var uParam0) // Position - 0xD38C (54156)
{
	if (!func_213() && func_244(uParam0))
		return 1;

	return 0;
}

BOOL func_244(int iParam0) // Position - 0xD3AC (54188)
{
	switch (iParam0)
	{
		case 161:
...
BOOL func_245(Vehicle veParam0) // Position - 0xD3FF (54271)
{
	...
	if (func_247(PLAYER::PLAYER_ID()) == 3)
		if (ENTITY::DOES_ENTITY_EXIST(veParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
			if (func_246(veParam0) != -1)
				return true;

	return false;
}

int func_246(Vehicle veParam0) // Position - 0xD486 (54406)
{
...
int func_247(Player plParam0) // Position - 0xD4B5 (54453)
{
	if (func_176(plParam0) == 233)
		return func_174(plParam0);

	return -1;
}

BOOL _IS_PLAYER_IN_VEHICLE_SEAT(Player plParam0, int iParam1) // Position - 0xD4D2 (54482)
{
...
BOOL func_249(var uParam0) // Position - 0xD51F (54559)
{
	if (func_250(uParam0))
	{
...
BOOL func_250(var uParam0) // Position - 0xD554 (54612)
{
	if (uParam0->f_12.f_66 == 0)
		return 0;

	if (!func_184(uParam0->f_12.f_66, false, -1))
		return 0;
...
BOOL func_251() // Position - 0xD5B4 (54708)
{
	return func_249(&(Global_108531.f_2890));
}

void func_252() // Position - 0xD5C7 (54727)
{
	func_253(&(Global_108531.f_2890));
	return;
}

void func_253(var uParam0) // Position - 0xD5DA (54746)
{
	if (func_250(uParam0))
...
BOOL func_254(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xD5F8 (54776)
{
	...
	if (iParam2 == 0 && func_256(Global_108531.f_2890.f_12.f_66))
		return false;
...
BOOL func_255() // Position - 0xD686 (54918)
{
...
BOOL func_256(Hash hParam0) // Position - 0xD6FB (55035)
{
	switch (hParam0)
	{
		case joaat("police"):
...
BOOL func_257() // Position - 0xD7BB (55227)
{
	return func_250(&(Global_108531.f_2890));
}

void func_258(int iParam0) // Position - 0xD7CE (55246)
{
	Global_98341 = 0;
...
void func_259(int iParam0) // Position - 0xD85C (55388)
{
	MISC::SET_BIT(&Global_98341, iParam0);
	return;
}

void func_260() // Position - 0xD86E (55406)
{
	if (!bLocal_45 && iLocal_97 != 3)
	{
		if (iLocal_97 > 0)
		{
			if (!bLocal_207)
			...
			if (!bLocal_207)
			{
				if (!func_96(PLAYER::PLAYER_PED_ID(), uLocal_214, 150f, true))
				{
					func_266(2);
				}
				else if (!func_96(PLAYER::PLAYER_PED_ID(), uLocal_214, 75f, true))
...
BOOL func_261() // Position - 0xD92B (55595)
{
	int num;
	...
	if (!func_262(bLocal_207, num) && !bLocal_207)
		return false;

	return true;
}

BOOL func_262(BOOL bParam0, int iParam1) // Position - 0xD967 (55655)
{
	int num;
...
int func_263(int iParam0, int iParam1) // Position - 0xD9B3 (55731)
{
	int num;

	num = func_264(iParam0) - iParam1;
	return num;
}

int func_264(int iParam0) // Position - 0xD9C8 (55752)
{
	return Global_62254[iParam0];
}

BOOL func_265(int iParam0) // Position - 0xD9D7 (55767)
{
	return func_90(iParam0, 1, true);
}

void func_266(int iParam0) // Position - 0xD9E7 (55783)
{
	HUD::CLEAR_PRINTS();
	func_267();
	...
	switch (iParam0)
	{
		...
		case 1:
			sLocal_204 = "PRD_FKICKOFF";
			break;
	
		case 2:
			sLocal_204 = "PRD_FLEFT";
			break;
...
void func_267() // Position - 0xDA49 (55881)
{
	Global_21906 = 0;
	func_75();
	return;
...
BOOL func_268() // Position - 0xDA59 (55897)
{
	func_269();
...
void func_269() // Position - 0xDA9E (55966)
{
	if (func_271())
	{
		switch (_GET_CURRENT_PLAYER_CHARACTER())
		{
			case CHAR_MICHAEL:
				if (Global_114990.f_2370.f_539.f_2395[0] == -99)
					func_270(uLocal_225[0], uLocal_225[1], uLocal_225[2]);
				else if (Global_114990.f_2370.f_539.f_2395[1] == -99)
					func_270(uLocal_225[1], uLocal_225[0], uLocal_225[2]);
				else if (Global_114990.f_2370.f_539.f_2395[2] == -99)
					func_270(uLocal_225[2], uLocal_225[1], uLocal_225[0]);
				break;
		
			case CHAR_FRANKLIN:
				if (Global_114990.f_2370.f_539.f_2395[1] == -99)
					func_270(uLocal_225[1], uLocal_225[0], uLocal_225[2]);
				else if (Global_114990.f_2370.f_539.f_2395[0] == -99)
					func_270(uLocal_225[0], uLocal_225[1], uLocal_225[2]);
				else if (Global_114990.f_2370.f_539.f_2395[2] == -99)
					func_270(uLocal_225[2], uLocal_225[1], uLocal_225[0]);
				break;
			...
			case CHAR_TREVOR:
				if (Global_114990.f_2370.f_539.f_2395[2] == -99)
					func_270(uLocal_225[2], uLocal_225[1], uLocal_225[0]);
				else if (Global_114990.f_2370.f_539.f_2395[0] == -99)
					func_270(uLocal_225[0], uLocal_225[1], uLocal_225[2]);
				else if (Global_114990.f_2370.f_539.f_2395[1] == -99)
...
void func_270(const char* sParam0, const char* sParam1, const char* sParam2) // Position - 0xDC54 (56404)
{
...
BOOL func_271() // Position - 0xDC90 (56464)
{
	return MISC::GET_GAME_TIMER() <= Global_24586.f_6481 + 100;
}

int func_272() // Position - 0xDCA5 (56485)
{
	int num;
	int i;
	...
	for (i = 0; i <= 2; i = i + 1)
	{
		if (Global_114990.f_2370.f_539.f_2395[i] != -99)
			num = num + 1;
	}
...
BOOL func_273(Ped pedParam0) // Position - 0xDCE1 (56545)
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
...
void func_274() // Position - 0xDD01 (56577)
{
	int num;
	...
	if (func_264(num) < 1500)
		func_275(_GET_CURRENT_PLAYER_CHARACTER(), 96, 1500, false, false);

	return;
}

void func_275(eCharacter echParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xDD51 (56657)
{
	int outValue;
	Hash statHash;

	if (func_310(echParam0) == 3)
		return;

	if (func_310(echParam0) == 4)
		return;

	func_276(func_310(echParam0), 1, iParam1, iParam2, false);
...
int func_276(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0xDE23 (56867)
{
	float num;
	int num2;
	int num3;
	...
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				case 0:
					func_308(99, 1);
					func_307(joaat("SP0_MONEY_TOTAL_SPENT"), iParam3);
					break;
			
				case 1:
					func_307(joaat("SP1_MONEY_TOTAL_SPENT"), iParam3);
					break;
			
				case 2:
					func_307(joaat("SP2_MONEY_TOTAL_SPENT"), iParam3);
					break;
			}
			...
			switch (iParam2)
			{
				...
				case 68:
					...
					{
						case 0:
							func_307(joaat("SP0_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
					
						case 1:
							func_307(joaat("SP1_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
					
						case 2:
							func_307(joaat("SP2_MONEY_SPENT_ON_TATTOOS"), iParam3);
							break;
					}
				...
				case 21:
					...
					{
						case 0:
							func_307(joaat("SP0_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
					
						case 1:
							func_307(joaat("SP1_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
					
						case 2:
							func_307(joaat("SP2_MONEY_SPENT_ON_TAXIS"), iParam3);
							break;
					}
					break;
				...
				case 25:
					...
					{
						case 0:
							func_307(joaat("SP0_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
					
						case 1:
							func_307(joaat("SP1_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
					
						case 2:
							func_307(joaat("SP2_MONEY_SPENT_IN_STRIP_CLUBS"), iParam3);
							break;
					}
					break;
				...
				case 113:
					...
					{
						case 0:
							func_307(joaat("SP0_MONEY_SPENT_PROPERTY"), iParam3);
							break;
					
						case 1:
							func_307(joaat("SP1_MONEY_SPENT_PROPERTY"), iParam3);
							break;
					
						case 2:
							func_307(joaat("SP2_MONEY_SPENT_PROPERTY"), iParam3);
							break;
					}
					break;
				...
				default:
					switch (SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME())
					{
						case joaat("clothes_shop_sp"):
							...
							{
								case 0:
									func_307(joaat("SP0_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
							
								case 1:
									func_307(joaat("SP1_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
							
								case 2:
									func_307(joaat("SP2_MONEY_SPENT_IN_CLOTHES"), iParam3);
									break;
							}
							break;
						...
						case joaat("hairdo_shop_sp"):
							...
							{
								case 0:
									func_307(joaat("SP0_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
							
								case 1:
									func_307(joaat("SP1_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
							
								case 2:
									func_307(joaat("SP2_MONEY_SPENT_ON_HAIRDOS"), iParam3);
									break;
							}
						...
						case joaat("gunclub_shop"):
							...
							{
								case 0:
									func_307(joaat("SP0_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
							
								case 1:
									func_307(joaat("SP1_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
							
								case 2:
									func_307(joaat("SP2_MONEY_SPENT_IN_BUYING_GUNS"), iParam3);
									break;
							}
							break;
						...
						case joaat("carmod_shop"):
							...
							{
								case 0:
									func_307(joaat("SP0_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
							
								case 1:
									func_307(joaat("SP1_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
							
								case 2:
									func_307(joaat("SP2_MONEY_SPENT_CAR_MODS"), iParam3);
									break;
							}
	...
	switch (iParam1)
	{
		case 1:
			...
			{
				case 0:
					func_307(joaat("SP0_TOTAL_CASH_EARNED"), iParam3);
					break;
			
				case 1:
					func_307(joaat("SP1_TOTAL_CASH_EARNED"), iParam3);
					break;
			
				case 2:
					func_307(joaat("SP2_TOTAL_CASH_EARNED"), iParam3);
					break;
			}
			break;
...
void func_277(BOOL bParam0) // Position - 0xE422 (58402)
{
	int i;
	int j;
...
void func_278(int iParam0) // Position - 0xE6A4 (59044)
{
	int value;
...
void func_279(int iParam0) // Position - 0xE6FE (59134)
{
	int num;
	BOOL flag;
	var txdName;
	...
	if (iParam0 == 12)
	{
		func_287(8272, 0, -1, true);
		return;
	}

	if (iParam0 == 13)
	{
		func_287(8273, 0, -1, true);
		return;
	}

	if (iParam0 == 14)
	{
		func_287(8274, 0, -1, true);
		return;
	}

	if (iParam0 == 15)
	{
		func_287(8275, 0, -1, true);
		return;
	}

	if (iParam0 == 16)
	{
		func_287(8276, 0, -1, true);
		return;
	}

	if (iParam0 == 17)
	{
		func_287(8277, 0, -1, true);
		return;
	}

	if (func_286(iParam0))
	{
		func_287(func_285(iParam0), 0, -1, true);
		return;
	}

	if (func_284(iParam0))
	{
		num = _MPPLY_STAT_GET_INT(func_283(iParam0));
		_MPPLY_STAT_SET_INT(func_283(iParam0), num - 1);
		return;
	}
	...
	else if (IS_BIT_SET(Global_114990.f_20573.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_160() /*5574*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_114990.f_20573.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_160() /*5574*/].f_681.f_10), iParam0);
	}
	...
	if (flag)
	{
		...
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_280(iParam0));
...
char* func_280(int iParam0) // Position - 0xE8C9 (59593)
{
	switch (iParam0)
	{
		case 0:
...
void _MPPLY_STAT_SET_INT(Hash hParam0, int iParam1) // Position - 0xE9FB (59899)
{
	Hash statName;
...
int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0xEA17 (59927)
{
	Hash statHash;
	int outValue;
...
Hash func_283(int iParam0) // Position - 0xEA35 (59957)
{
	switch (iParam0)
	{
		case 38:
...
BOOL func_284(int iParam0) // Position - 0xEA57 (59991)
{
	switch (iParam0)
	{
		case 38:
...
int func_285(int iParam0) // Position - 0xEA74 (60020)
{
	switch (iParam0)
	{
		case 18:
...
BOOL func_286(int iParam0) // Position - 0xEB79 (60281)
{
	switch (iParam0)
	{
		case 18:
...
void func_287(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xEC08 (60424)
{
	Hash statName;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0xEC36 (60470)
{
	if (iParam2 == -1)
		iParam2 = func_32();
...
void func_289(int iParam0) // Position - 0xEC54 (60500)
{
	func_308(93, iParam0);
	func_308(29, iParam0);
	func_308(30, iParam0);
...
BOOL func_290(int iParam0) // Position - 0xEC74 (60532)
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
	...
	if (func_286(iParam0))
	{
		...
		num7 = func_91(func_285(iParam0), -1);
	...
	if (func_284(iParam0))
	{
		num8 = _MPPLY_STAT_GET_INT(func_283(iParam0));
	...
	return IS_BIT_SET(Global_2359296[func_160() /*5574*/].f_681.f_10, iParam0);
}

BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0xEE7F (61055)
{
	if (iParam1 == -1)
		iParam1 = func_32();
...
int func_292(BOOL bParam0) // Position - 0xEE9B (61083)
{
	var outValue;
	int value;
	int outValue2;
...
int func_293(int iParam0, int iParam1) // Position - 0xEF52 (61266)
{
	if (iParam0 >= 78)
		return 0;
...
int func_294(int iParam0, int iParam1) // Position - 0xEF6D (61293)
{
	if (func_13(14) && !func_305(iParam0))
		return 0;
	...
	if (func_304(&Global_4525223))
	{
		if (func_302(&Global_4525223, iParam0))
			return 0;
	
		if (func_295(&Global_4525223, iParam0))
			return 1;
	}
	else
	{
...
BOOL func_295(var uParam0, int iParam1) // Position - 0xF00A (61450)
{
	int i;
	var unk;
	...
	if (func_13(14) && !func_305(iParam1))
		return false;

	if (func_302(uParam0, iParam1))
		return false;

	if (func_301(uParam0) < 0f)
		func_300(uParam0, 0);
...
int func_296(var uParam0, int iParam1) // Position - 0xF0BB (61627)
{
	int i;
...
BOOL func_297(var uParam0, int iParam1) // Position - 0xF136 (61750)
{
	return uParam0->[iParam1] == 78;
}

void func_298(var uParam0) // Position - 0xF147 (61767)
{
	int i;
	...
	func_300(uParam0, Global_4525222 - 0.5f);
	return;
}

void func_299(var uParam0, int iParam1) // Position - 0xF17B (61819)
{
	uParam0->[iParam1] = 78;
	return;
}

void func_300(var uParam0, int iParam1) // Position - 0xF18B (61835)
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_301(var uParam0) // Position - 0xF1A8 (61864)
{
	return uParam0->f_80;
}

BOOL func_302(var uParam0, int iParam1) // Position - 0xF1B4 (61876)
{
	return func_303(uParam0, iParam1) != -1;
}

int func_303(var uParam0, int iParam1) // Position - 0xF1C6 (61894)
{
	int i;
...
BOOL func_304(var uParam0) // Position - 0xF1F3 (61939)
{
	return uParam0->f_79 == 1;
}

BOOL func_305(int iParam0) // Position - 0xF201 (61953)
{
	switch (iParam0)
	{
		case 60:
...
BOOL func_306(int iParam0, int iParam1) // Position - 0xF251 (62033)
{
...
void func_307(Hash hParam0, int iParam1) // Position - 0xF2A2 (62114)
{
	int outValue;
...
void func_308(int iParam0, int iParam1) // Position - 0xF2C5 (62149)
{
	int outValue;
...
void func_309() // Position - 0xF322 (62242)
{
	int outValue;
...
int func_310(eCharacter echParam0) // Position - 0xF397 (62359)
{
	return Global_2349[echParam0 /*29*/].f_17;
}

BOOL func_311(BOOL bParam0) // Position - 0xF3A8 (62376)
{
...
void func_312(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5) // Position - 0xF3D0 (62416)
{
	if (func_313())
	{
...
BOOL func_313() // Position - 0xF465 (62565)
{
...
void func_314() // Position - 0xF489 (62601)
{
	func_315(joaat("Player_Zero"), 14, 31, true);
	func_315(joaat("Player_Zero"), 14, 32, true);
	func_315(joaat("Player_Zero"), 14, 33, true);
	func_315(joaat("Player_Zero"), 14, 34, true);
	func_315(joaat("Player_Zero"), 14, 35, true);
	func_315(joaat("Player_Zero"), 14, 36, true);
	func_315(joaat("Player_Zero"), 14, 37, true);
	func_315(joaat("Player_Zero"), 14, 38, true);
	func_315(joaat("Player_Zero"), 14, 39, true);
	func_315(joaat("Player_Zero"), 14, 40, true);
	func_315(joaat("Player_Zero"), 14, 41, true);
	func_315(joaat("Player_Zero"), 14, 42, true);
	func_315(joaat("Player_Zero"), 14, 43, true);
	func_315(joaat("Player_Zero"), 14, 44, true);
	func_315(joaat("Player_Zero"), 9, 9, true);
	func_315(joaat("Player_Zero"), 9, 10, true);
	func_315(joaat("Player_Zero"), 9, 11, true);
	func_315(joaat("Player_Zero"), 9, 12, true);
	func_315(joaat("Player_Zero"), 9, 13, true);
	func_315(joaat("Player_Zero"), 9, 14, true);
	func_315(joaat("Player_One"), 14, 26, true);
	func_315(joaat("Player_One"), 14, 27, true);
	func_315(joaat("Player_One"), 14, 28, true);
	func_315(joaat("Player_One"), 14, 29, true);
	func_315(joaat("Player_One"), 14, 30, true);
	func_315(joaat("Player_One"), 14, 31, true);
	func_315(joaat("Player_One"), 14, 32, true);
	func_315(joaat("Player_One"), 14, 33, true);
	func_315(joaat("Player_One"), 14, 34, true);
	func_315(joaat("Player_One"), 14, 35, true);
	func_315(joaat("Player_One"), 14, 36, true);
	func_315(joaat("Player_One"), 14, 37, true);
	func_315(joaat("Player_One"), 14, 38, true);
	func_315(joaat("Player_One"), 14, 39, true);
	func_315(joaat("Player_One"), 9, 5, true);
	func_315(joaat("Player_One"), 9, 6, true);
	func_315(joaat("Player_One"), 9, 7, true);
	func_315(joaat("Player_One"), 9, 8, true);
	func_315(joaat("Player_One"), 9, 9, true);
	func_315(joaat("Player_One"), 9, 10, true);
	func_315(joaat("Player_Two"), 14, 49, true);
	func_315(joaat("Player_Two"), 14, 50, true);
	func_315(joaat("Player_Two"), 14, 51, true);
	func_315(joaat("Player_Two"), 14, 52, true);
	func_315(joaat("Player_Two"), 14, 53, true);
	func_315(joaat("Player_Two"), 14, 54, true);
	func_315(joaat("Player_Two"), 14, 55, true);
	func_315(joaat("Player_Two"), 14, 56, true);
	func_315(joaat("Player_Two"), 14, 57, true);
	func_315(joaat("Player_Two"), 14, 58, true);
	func_315(joaat("Player_Two"), 14, 59, true);
	func_315(joaat("Player_Two"), 14, 60, true);
	func_315(joaat("Player_Two"), 9, 9, true);
	func_315(joaat("Player_Two"), 9, 10, true);
	func_315(joaat("Player_Two"), 9, 11, true);
	func_315(joaat("Player_Two"), 9, 12, true);
	func_315(joaat("Player_Two"), 9, 13, true);
	func_315(joaat("Player_Two"), 9, 14, true);
	func_315(joaat("Player_Two"), 9, 15, true);
	func_315(joaat("Player_Two"), 9, 16, true);
	return;
}

int func_315(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xF7D9 (63449)
{
	Global_80145[1 /*14*/] = { func_317(iParam0, iParam1, iParam2, -1) };

	if (IS_BIT_SET(Global_80145[1 /*14*/].f_6, 0) && !IS_BIT_SET(Global_80145[1 /*14*/].f_6, 6))
	{
		if (bParam3)
			func_316(iParam1, Global_80145[1 /*14*/].f_5, Global_80145[1 /*14*/].f_2, 0, Global_80145[1 /*14*/].f_1, 1, 0);
		else
			func_316(iParam1, Global_80145[1 /*14*/].f_5, Global_80145[1 /*14*/].f_2, 0, Global_80145[1 /*14*/].f_1, 0, 1);
...
BOOL func_316(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xF86F (63599)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_317(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10713 (67347)
{
	func_382();
...
void func_318(int iParam0, int iParam1) // Position - 0x10765 (67429)
{
	switch (iParam0)
	{
		case 0:
...
void func_319(int iParam0) // Position - 0x10855 (67669)
{
	BOOL flag;
	int num;
	var unk;
	...
	switch (iParam0)
	{
		...
		default:
			func_327(num6, iParam0, 155, -1);
			return;
	}

	func_320(&Global_80145[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_320(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x11ACC (72396)
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_324(Global_2883588, 1, true, true, -1))
				MISC::CLEAR_BIT(&(iParam0->f_6), 2);
		
			if (!func_324(Global_2883588, 2, true, true, -1))
	...
	else if (iParam0->f_5 >= 0 && iParam0->f_5 < 3)
	{
		...
		if (func_316(iParam1, iParam0->f_5, iParam0->f_2, 0, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 1);
	
		if (func_316(iParam1, iParam0->f_5, iParam0->f_2, 1, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 2);
	
		if (!func_316(iParam1, iParam0->f_5, iParam0->f_2, 2, iParam0->f_1, 0, 0))
			MISC::SET_BIT(&(iParam0->f_6), 4);
	}
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_91(func_323(iParam1, iParam0->f_2), Global_80142);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_91(func_322(iParam1, iParam0->f_2), Global_80142);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 2);
		
			if (func_321(iParam1, iParam0->f_2, &num2))
			{
...
BOOL func_321(int iParam0, int iParam1, var uParam2) // Position - 0x11E6E (73326)
{
	*uParam2 = 979;
...
int func_322(int iParam0, int iParam1) // Position - 0x12273 (74355)
{
	switch (iParam1)
	{
		case 0:
...
int func_323(int iParam0, int iParam1) // Position - 0x1266E (75374)
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_324(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x12A69 (76393)
{
	int num;
	int num2;
	int num3;
...
BOOL func_325(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x12AA7 (76455)
{
...
int func_326(int iParam0) // Position - 0x157B1 (87985)
{
	switch (iParam0)
	{
		case -1:
...
void func_327(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x15885 (88197)
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_320(&Global_80145[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_320(&Global_80145[0 /*14*/], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_320(&Global_80145[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_80343)
		{
			...
			func_320(&Global_80145[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
		...
		if (componentId2 >= 0)
		{
			num6 = EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(num2, 11, -1, false, -1, func_328(iParam0));
...
int func_328(int iParam0) // Position - 0x15B0C (88844)
{
	switch (iParam0)
	{
		case 0:
...
void func_329(int iParam0) // Position - 0x15BBC (89020)
{
	BOOL flag;
	int num;
	var unk;
...
void func_330(int iParam0) // Position - 0x15D13 (89363)
{
	BOOL flag;
	int num;
	var unk;
...
void func_331(int iParam0) // Position - 0x16221 (90657)
{
	BOOL flag;
	int num;
	var unk;
...
void func_332(int iParam0) // Position - 0x16296 (90774)
{
	BOOL flag;
	int num;
	var unk;
...
void func_333(int iParam0) // Position - 0x1630A (90890)
{
	BOOL flag;
	int num;
	var unk;
...
void func_334(int iParam0) // Position - 0x163F1 (91121)
{
	BOOL flag;
	int num;
	var unk;
...
void func_335(int iParam0) // Position - 0x16754 (91988)
{
	BOOL flag;
	int num;
	var unk;
...
void func_336(int iParam0) // Position - 0x16965 (92517)
{
	BOOL flag;
	int num;
	var unk;
...
void func_337(int iParam0) // Position - 0x16B95 (93077)
{
	BOOL flag;
	int num;
	var unk;
...
void func_338(int iParam0) // Position - 0x16CA5 (93349)
{
	BOOL flag;
	int num;
	var unk;
...
void func_339(int iParam0) // Position - 0x17644 (95812)
{
	BOOL flag;
	int num;
	var unk;
...
void func_340(int iParam0) // Position - 0x181B9 (98745)
{
	if (iParam0 < 136)
		func_342(iParam0);
	else
...
void func_341(int iParam0) // Position - 0x181EE (98798)
{
	BOOL flag;
	int num;
	var unk;
...
void func_342(int iParam0) // Position - 0x18DF2 (101874)
{
	BOOL flag;
	int num;
	var unk;
...
void func_343(int iParam0) // Position - 0x19D00 (105728)
{
	BOOL flag;
	int num;
	var unk;
...
void func_344(int iParam0) // Position - 0x19E2D (106029)
{
	BOOL flag;
	int num;
	var unk;
...
void func_345(int iParam0, int iParam1) // Position - 0x19F2B (106283)
{
	switch (iParam0)
	{
		case 0:
...
void func_346(int iParam0) // Position - 0x1A01B (106523)
{
	BOOL flag;
	int num;
	var unk;
...
void func_347(int iParam0) // Position - 0x1B50C (111884)
{
	BOOL flag;
	int num;
	var unk;
...
void func_348(int iParam0) // Position - 0x1B65D (112221)
{
	BOOL flag;
	int num;
	var unk;
...
void func_349(int iParam0) // Position - 0x1BB68 (113512)
{
	BOOL flag;
	int num;
	var unk;
...
void func_350(int iParam0) // Position - 0x1C1D8 (115160)
{
	BOOL flag;
	int num;
	var unk;
...
void func_351(int iParam0) // Position - 0x1C24C (115276)
{
	BOOL flag;
	int num;
	var unk;
...
void func_352(int iParam0) // Position - 0x1C31C (115484)
{
	BOOL flag;
	int num;
	var unk;
...
void func_353(int iParam0) // Position - 0x1C84C (116812)
{
	BOOL flag;
	int num;
	var unk;
...
void func_354(int iParam0) // Position - 0x1C9E3 (117219)
{
	BOOL flag;
	int num;
	var unk;
...
void func_355(int iParam0) // Position - 0x1D1E1 (119265)
{
	BOOL flag;
	int num;
	var unk;
...
void func_356(int iParam0) // Position - 0x1D2F1 (119537)
{
	BOOL flag;
	int num;
	var unk;
...
void func_357(int iParam0) // Position - 0x1E21C (123420)
{
	BOOL flag;
	int num;
	var unk;
...
void func_358(int iParam0) // Position - 0x1EED9 (126681)
{
	if (iParam0 < 107)
		func_361(iParam0);
	else if (iParam0 < 227)
...
void func_359(int iParam0) // Position - 0x1EF1F (126751)
{
	BOOL flag;
	int num;
	var unk;
...
void func_360(int iParam0) // Position - 0x1F9C4 (129476)
{
	BOOL flag;
	int num;
	var unk;
...
void func_361(int iParam0) // Position - 0x207B5 (133045)
{
	BOOL flag;
	int num;
	var unk;
...
void func_362(int iParam0) // Position - 0x213FE (136190)
{
	BOOL flag;
	int num;
	var unk;
...
void func_363(int iParam0) // Position - 0x21677 (136823)
{
	BOOL flag;
	int num;
	var unk;
...
void func_364(int iParam0, int iParam1) // Position - 0x217BD (137149)
{
	switch (iParam0)
	{
		case 0:
...
void func_365(int iParam0) // Position - 0x218AD (137389)
{
	BOOL flag;
	int num;
	var unk;
...
void func_366(int iParam0) // Position - 0x22637 (140855)
{
	BOOL flag;
	int num;
	var unk;
...
void func_367(int iParam0) // Position - 0x227B1 (141233)
{
	BOOL flag;
	int num;
	var unk;
...
void func_368(int iParam0) // Position - 0x22D28 (142632)
{
	BOOL flag;
	int num;
	var unk;
...
void func_369(int iParam0) // Position - 0x23252 (143954)
{
	BOOL flag;
	int num;
	var unk;
...
void func_370(int iParam0) // Position - 0x232C6 (144070)
{
	BOOL flag;
	int num;
	var unk;
...
void func_371(int iParam0) // Position - 0x23396 (144278)
{
	BOOL flag;
	int num;
	var unk;
...
void func_372(int iParam0) // Position - 0x2386E (145518)
{
	BOOL flag;
	int num;
	var unk;
...
void func_373(int iParam0) // Position - 0x23AD7 (146135)
{
	BOOL flag;
	int num;
	var unk;
...
void func_374(int iParam0) // Position - 0x23DAD (146861)
{
	BOOL flag;
	int num;
	var unk;
...
void func_375(int iParam0) // Position - 0x23F76 (147318)
{
	BOOL flag;
	int num;
	var unk;
...
void func_376(int iParam0) // Position - 0x24B2D (150317)
{
	BOOL flag;
	int num;
	var unk;
...
void func_377(int iParam0) // Position - 0x25777 (153463)
{
	if (iParam0 < 60)
		func_379(iParam0);
	else
...
void func_378(int iParam0) // Position - 0x257AC (153516)
{
	BOOL flag;
	int num;
	var unk;
...
void func_379(int iParam0) // Position - 0x2654C (157004)
{
	BOOL flag;
	int num;
	var unk;
...
void func_380(int iParam0) // Position - 0x26BD8 (158680)
{
	BOOL flag;
	int num;
	var unk;
...
void func_381(int iParam0) // Position - 0x26CBF (158911)
{
	BOOL flag;
	int num;
	var unk;
...
void func_382() // Position - 0x26DBD (159165)
{
...
void func_383() // Position - 0x26E36 (159286)
{
	func_392();
	func_391();
	func_384();
...
void func_384() // Position - 0x26E4A (159306)
{
	var unk;
...
void func_385(var uParam0, int iParam1) // Position - 0x26EB7 (159415)
{
	int i;
	...
	{
		func_389(&uLocal_99, uParam0->[i /*3*/]);
	}

	func_388(&uLocal_99);
	func_386(&uLocal_151, &uLocal_99, 50f);
	return;
}

void func_386(var uParam0, var uParam1, float fParam2) // Position - 0x26EFB (159483)
{
	int num;
	int num2;
	int num3;
	...
	while (num2 < uParam1->f_46)
	{
		...
		if (func_387(uParam1, uParam1->[num2 /*3*/] + num6))
			num6 = { -num6 };
...
BOOL func_387(var uParam0, float fParam1, var uParam2, var uParam3) // Position - 0x27008 (159752)
{
	BOOL flag;
	int num;
	int num2;
...
void func_388(var uParam0) // Position - 0x270C4 (159940)
{
	int i;
	float num;
...
void func_389(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x27164 (160100)
{
	uParam0->f_51 == 0;
	uParam0->f_46 >= 15;
...
void func_390(var uParam0) // Position - 0x27195 (160149)
{
	uParam0->f_51;
	uParam0->f_46 = 0;
...
void func_391() // Position - 0x271BC (160188)
{
	uLocal_225[0] = "PRD_BUYM";
	uLocal_225[1] = "PRD_BUYF";
	uLocal_225[2] = "PRD_BUYT";
	return;
}

void func_392() // Position - 0x271DC (160220)
{
	return;
}

void func_393() // Position - 0x271E4 (160228)
{
	func_404(true);
	func_403();
	func_394(false);
...
void func_394(BOOL bParam0) // Position - 0x271FE (160254)
{
	bParam0;
	func_402(true, 1, 1);
	PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
	...
	if (CAM::DOES_CAM_EXIST(caLocal_210))
	{
...
void func_395() // Position - 0x27269 (160361)
{
	return;
}

void func_396() // Position - 0x27271 (160369)
{
	Global_21906 = 0;
	func_397();
	return;
...
void func_397() // Position - 0x27281 (160385)
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_24051 = 0;
...
void func_398() // Position - 0x272A2 (160418)
{
	return;
}

void func_399() // Position - 0x272AA (160426)
{
	return;
}

void func_400() // Position - 0x272B2 (160434)
{
	return;
}

void func_401() // Position - 0x272BA (160442)
{
	return;
}

void func_402(BOOL bParam0, int iParam1, int iParam2) // Position - 0x272C2 (160450)
{
...
void func_403() // Position - 0x27321 (160545)
{
	Global_98341 = 0;
	return;
}

void func_404(BOOL bParam0) // Position - 0x2732E (160558)
{
...
void func_405() // Position - 0x27375 (160629)
{
	int num;
...
BOOL func_406() // Position - 0x273E6 (160742)
{
	if (Global_102511 == 13 || Global_102511 == 10 || Global_102511 == 11 || Global_102511 == 12)
		return false;
...
void func_407() // Position - 0x27424 (160804)
{
	Global_114990.f_2370.f_539.f_2395[0] = -99;
	Global_114990.f_2370.f_539.f_2395[1] = -99;
	Global_114990.f_2370.f_539.f_2395[2] = -99;
