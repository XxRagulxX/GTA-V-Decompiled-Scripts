...
int func_4(var uParam0) // Position - 0x39F (927)
{
	int i;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (func_5(uParam0, &Global_2652584.f_2452[i /*16*/]))
			return i;
	}
...
BOOL func_5(var uParam0, var uParam1) // Position - 0x3E2 (994)
{
...
BOOL func_7(var uParam0) // Position - 0x464 (1124)
{
...
int func_11(int iParam0) // Position - 0x557 (1367)
{
	switch (iParam0)
	{
...
int func_12() // Position - 0x5A7 (1447)
{
...
BOOL func_23(int iParam0) // Position - 0x834 (2100)
{
