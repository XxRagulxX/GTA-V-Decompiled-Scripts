...
int func_164(var uParam0, int iParam1, int iParam2) // Position - 0x7CB5 (31925)
{
	...
	{
		if (!func_180(Global_100950[iParam2 /*3*/], 0f, 0f, 0f, false))
		{
			unk.f_11 = 12;
			unk.f_31 = 49;
			unk.f_81 = 2;
...
BOOL func_181(int iParam0, var uParam1, var uParam2) // Position - 0xC0DF (49375)
{
	switch (iParam0)
	{
		case 11:
...
void func_193(var uParam0, int iParam1) // Position - 0xCD37 (52535)
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_181(Global_114990.f_18542[i], &unk, &num2))
			{
...
BOOL func_232(int iParam0) // Position - 0xE8A9 (59561)
{
	int i;
...
void func_235(var uParam0, var uParam1) // Position - 0xEA0A (59914)
{
...
void func_244(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, var uParam10, float fParam11, float fParam12, float fParam13, float fParam14, float fParam15, float fParam16) // Position - 0xF033 (61491)
{
	uParam0->f_1 = iParam1;
...
var func_245(var uParam0, var uParam1) // Position - 0xF09F (61599)
{
	if (uParam0 > uParam1)
		return uParam0;
