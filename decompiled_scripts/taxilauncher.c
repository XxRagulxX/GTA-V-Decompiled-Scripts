			...
			if (func_44())
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(&uLocal_287))
				{
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &uLocal_287, "HAIL_TAXI", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &uLocal_287, "FP_HAIL_TAXI", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &uLocal_287, "FUCK_U", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &uLocal_287, "FORGET_IT", 3))
					{
						...
						if (iLocal_112 == -1)
							_CONTEXT_ADD_HELP_TEXT(&iLocal_112, 0, "TXM_H01" /*Press ~INPUT_CONTEXT~ to hail a taxi.*/, 1, 0, 0, 0);
	...
	if (iLocal_69 == 0)
	{
		if (func_143(131))
		{
			if (func_141(_GET_CURRENT_PLAYER_CHARACTER()))
			{
				...
				else if (func_118(&uLocal_118, 131, "TAXISAU", sLocal_284, sLocal_284, "TX_2A", "TX_2A", 2, 1, 0, 0, false))
				{
					iLocal_69 = 1;
				}
			}
...
BOOL func_118(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, BOOL bParam11) // Position - 0x7FEE (32750)
{
	var unk;
	var unk12;
...
void func_131(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x8799 (34713)
{
...
BOOL func_143(int iParam0) // Position - 0x8C74 (35956)
{
