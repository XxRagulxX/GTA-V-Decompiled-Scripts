...
void func_8() // Position - 0x331 (817)
{
	...
	if (!IS_BIT_SET(iLocal_129, 1) || PAD::HAVE_CONTROLS_CHANGED(FRONTEND_CONTROL) || Global_1949240)
	{
		...
		_STOPWATCH_DESTROY(&(iLocal_144.f_5));
	}
	else
	{
		if (func_58(&(iLocal_144.f_5), 5000, true))
			Global_1949240 = true;
	
		if (bLocal_141 && func_58(&(iLocal_144.f_5), 2000, true))
		{
			bLocal_141 = false;
			Global_1949240 = true;
		}
...
void func_9(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x430 (1072)
{
	...
	if (bParam3)
	{
		...
		{
			func_46(Global_24546.f_5821 + 1, "DFLT_MNU_OPT" /*Exit*/, 0, true, 0, false, 0);
		...
		if (i == 1 || !Global_24546.f_6331)
		{
			...
			for (j = 0; j <= num43; j = j + 1)
			{
				...
				if (flag && i == 1 && flag2)
				{
					...
					func_40("CommonMenu", "Gradient_Nav", Global_24543 + (iParam5 * 0.5f), num40 + num45 + (0.00277776f * (float)num5) + (num37 * 0.5f), iParam5, num37, 0f, r2, g2, b2, a2, false, 0);
								...
								if (flag2)
								{
									if (!Global_24546.f_6332)
									{
										...
										if (MISC::GET_HASH_KEY(&Global_24546.f_79[num16 /*6*/]) != 0)
										{
											...
											func_22(flag, Global_24546.f_1616[num16], Global_24546.f_1873[num16], flag7, num46, flag5, flag4);
...
BOOL func_54(BOOL bParam0, BOOL bParam1) // Position - 0x5091 (20625)
{
	...
	if (!CAM::IS_SCREEN_FADED_IN() || func_56(8, -1) && func_55() != 65 || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_80566 || Global_24546.f_9243 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_102506.f_1514)
		return false;
...
BOOL func_58(var uParam0, int iParam1, BOOL bParam2) // Position - 0x520F (21007)
{
	...
	func_446(uParam0, bParam2, false);
...
void func_61() // Position - 0x528A (21130)
{
	...
	if (iLocal_130 == 0)
	{
		...
		{
			switch (uLocal_124[iLocal_144.f_1])
			{
				case 1:
					if (func_65())
...
void func_75() // Position - 0x5B35 (23349)
{
	...
	else if (iLocal_130 == 1)
	{
		...
		if (Global_1989865.f_3 == 173)
			iLocal_144 = func_209(true, false);
		else if (Global_1989865.f_3 == 176)
			iLocal_144 = func_209(false, true);
	}
	else if (iLocal_130 == 2)
	{
		...
		if (Global_1989865.f_3 == 173)
			iLocal_144 = func_76(true, false);
		else if (Global_1989865.f_3 == 176)
			iLocal_144 = func_76(false, true);
	}
...
BOOL func_95(int iParam0) // Position - 0x7BCD (31693)
{
	if (!Global_80305)
		return false;
...
int func_102(int iParam0) // Position - 0x7E1C (32284)
{
	switch (iParam0)
	{
		case 287906327:
...
BOOL func_103(int iParam0) // Position - 0x7E4A (32330)
{
	int num;
...
int func_104(int iParam0) // Position - 0x7F38 (32568)
{
	switch (iParam0)
	{
		case joaat("POLICEB2"):
...
BOOL func_105(int iParam0) // Position - 0x7F66 (32614)
{
	if (!Global_80305)
		return false;
...
int func_109(int iParam0) // Position - 0x8189 (33161)
{
	switch (iParam0)
	{
		case joaat("taco"):
...
BOOL func_110(int iParam0) // Position - 0x81FF (33279)
{
	if (!Global_80305)
		return false;
...
int func_111(int iParam0) // Position - 0x82D6 (33494)
{
	switch (iParam0)
	{
		case -773802025:
...
int func_112(int iParam0) // Position - 0x8322 (33570)
{
	switch (iParam0)
	{
		case -1233767450:
...
BOOL func_113(int iParam0) // Position - 0x8378 (33656)
{
	if (!Global_80305)
		return false;
...
BOOL func_120(int iParam0) // Position - 0x85D8 (34264)
{
	if (!Global_80305)
		return false;
...
int func_124(int iParam0) // Position - 0x873E (34622)
{
	switch (iParam0)
	{
		case 239897677:
...
BOOL func_125(int iParam0) // Position - 0x876C (34668)
{
	if (!Global_80305)
		return false;
...
int func_133(int iParam0) // Position - 0x8A25 (35365)
{
	switch (iParam0)
	{
		case -1627077503:
...
BOOL func_134(int iParam0) // Position - 0x8A7B (35451)
{
	if (!Global_80305)
		return false;
...
int func_137(int iParam0) // Position - 0x8BEA (35818)
{
	switch (iParam0)
	{
		case joaat("kanjosj"):
...
BOOL func_138(int iParam0) // Position - 0x8C2C (35884)
{
	if (!Global_80305)
		return false;
...
int func_143(BOOL bParam0) // Position - 0x8D9F (36255)
{
	if (bParam0)
...
int func_144(Player plParam0) // Position - 0x8DBF (36287)
{
	if (plParam0 != -1)
...
int func_146(int iParam0) // Position - 0x8DF3 (36339)
{
	switch (iParam0)
	{
		case joaat("baller7"):
...
BOOL func_147(int iParam0) // Position - 0x8E5E (36446)
{
	if (!Global_80305)
		return false;
...
int func_151(int iParam0) // Position - 0x912E (37166)
{
	switch (iParam0)
	{
		case joaat("zr350"):
...
BOOL func_152(int iParam0) // Position - 0x91F1 (37361)
{
	if (!Global_80305)
		return false;
...
int func_162(int iParam0) // Position - 0x9535 (38197)
{
	switch (iParam0)
	{
		case joaat("vetir"):
...
int func_163(int iParam0) // Position - 0x95BB (38331)
{
	switch (iParam0)
	{
		case joaat("firetruk"):
...
BOOL func_164(int iParam0) // Position - 0x9705 (38661)
{
	int num;
...
BOOL func_165(int iParam0) // Position - 0x9AF1 (39665)
{
	if (!Global_80305)
		return false;
...
int func_168(int iParam0) // Position - 0xB4D5 (46293)
{
	switch (iParam0)
	{
		case joaat("cerberus"):
...
int func_169(int iParam0) // Position - 0xB619 (46617)
{
	switch (iParam0)
	{
		case joaat("cerberus"):
...
BOOL func_170(int iParam0) // Position - 0xB713 (46867)
{
	if (!Global_80305)
		return false;
	...
	{
		case joaat("mule4"):
			if (func_83(7233, -1) >= func_171(iParam0) || Global_262145.f_24345)
				return true;
			else
				return false;
			break;
		...
		case joaat("pounder2"):
			if (func_83(7233, -1) >= func_171(iParam0) || Global_262145.f_24346)
				return true;
			else
				return false;
			break;
		...
		case joaat("oppressor2"):
			if (_STAT_GET_PACKED_INT(22050, -1) >= func_171(iParam0) || Global_262145.f_24347)
				return true;
			else
				return false;
			break;
		...
		case joaat("patriot2"):
			if (func_83(7231, -1) >= func_171(iParam0) || Global_262145.f_24350)
				return true;
			else
				return false;
			break;
		...
		case joaat("blimp3"):
			if (func_83(7231, -1) >= func_171(iParam0) || Global_262145.f_24351)
				return true;
			else
				return false;
			break;
...
int func_171(int iParam0) // Position - 0xB867 (47207)
{
	switch (iParam0)
	{
		case joaat("mule4"):
...
int func_172(int iParam0) // Position - 0xB8D6 (47318)
{
	switch (iParam0)
	{
		case joaat("mule4"):
...
BOOL func_173(int iParam0) // Position - 0xB934 (47412)
{
	int num;
...
int func_175(int iParam0) // Position - 0xBAB0 (47792)
{
	switch (iParam0)
	{
		case joaat("deluxo"):
...
BOOL func_176(int iParam0) // Position - 0xBB36 (47926)
{
	int num;
	int num2;
...
int func_178(int iParam0) // Position - 0xBB74 (47988)
{
	switch (iParam0)
	{
		case joaat("microlight"):
...
int func_180(int iParam0) // Position - 0xBC83 (48259)
{
	switch (iParam0)
	{
		case joaat("dune3"):
...
int func_181(int iParam0) // Position - 0xBCCF (48335)
{
	switch (iParam0)
	{
		case joaat("dune3"):
...
int func_193(int iParam0) // Position - 0xC049 (49225)
{
	switch (iParam0)
	{
		case joaat("dune4"):
...
int func_194(int iParam0) // Position - 0xC0B3 (49331)
{
	int num;
...
int func_203() // Position - 0xC597 (50583)
{
	return -1576586413;
}
...
int func_206() // Position - 0xECA3 (60579)
{
...
int func_209(BOOL bParam0, BOOL bParam1) // Position - 0xF22A (61994)
{
	int num;
	int num2;
	Hash model;
...
void func_215(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1C50B (115979)
{
	Hash statName;
...
void func_253(int iParam0, int iParam1, int iParam2) // Position - 0x1FE52 (130642)
{
	Player player;
	...
	iParam1 = iParam1 + 1;
	func_254(iParam0, iParam1, iParam2);
...
void func_258(int iParam0, var uParam1) // Position - 0x20311 (131857)
{
...
int func_261(Hash hParam0, BOOL bParam1) // Position - 0x20442 (132162)
{
	switch (hParam0)
	{
		case joaat("apc"):
...
int func_262() // Position - 0x204AD (132269)
{
...
void func_296() // Position - 0x21483 (136323)
{
	...
	if (!bLocal_135)
	{
		...
		if (func_419() > 0)
		{
			...
			{
				iLocal_144.f_1 = iLocal_144.f_1 + 1;
			
				if (iLocal_144.f_1 > func_419() - 1)
					iLocal_144.f_1 = 0;
...
BOOL func_313() // Position - 0x21E64 (138852)
{
	...
	if (_NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), true, true) && uLocal_192[iLocal_144.f_1] >= 0)
	{
		flag = true;
...
int func_318(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x222A7 (139943)
{
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x22304 (140036)
{
	return uParam0->f_1;
}
...
BOOL func_349() // Position - 0x23E0F (146959)
{
	...
	if (_NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), true, true) && uLocal_151[iLocal_144.f_1] >= 0)
	{
		flag = true;
	
		if (!func_355(uLocal_151[iLocal_144.f_1]))
			flag = false;
	}

	if (flag)
	{
		Global_2733138.f_639 = uLocal_151[iLocal_144.f_1];
...
int func_351(int iParam0) // Position - 0x23F50 (147280)
{
	switch (iParam0)
	{
		...
		case 48:
			...
			else if (Global_2733138.f_590 == 1)
...
void func_354(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x244B6 (148662)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
		if (!bParam2)
...
int func_409(int iParam0) // Position - 0x2624D (156237)
{
	switch (iParam0)
	{
		case joaat("apc"):
...
int func_410(int iParam0) // Position - 0x26437 (156727)
{
	switch (iParam0)
	{
		case joaat("apc"):
...
BOOL func_411(int iParam0) // Position - 0x2651E (156958)
{
	switch (iParam0)
	{
		case joaat("scarab"):
...
BOOL func_412(int iParam0) // Position - 0x2660A (157194)
{
	switch (iParam0)
	{
		case joaat("voltic2"):
...
int func_419() // Position - 0x269CF (158159)
{
	return iLocal_144;
}
...
void func_420() // Position - 0x269D9 (158169)
{
	...
	if (Global_4521271 > -1)
	{
		...
		{
			if (Global_4521271 == iLocal_144.f_1)
			{
				iLocal_131 = 1;
			}
			else
			{
				iLocal_144.f_1 = Global_4521271;
				func_74(iLocal_144.f_1, true, 1);
				Global_1949240 = true;
				AUDIO::PLAY_SOUND_FRONTEND(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
			}
