...
void func_15(Player plParam0) // Position - 0x4DD (1245)
{
	...
	if (_NETWORK_IS_PLAYER_VALID(plParam0, false, true))
	{
		if (HUD::DOES_BLIP_EXIST(Global_2647287[player]))
		{
			Global_2647287.f_1504[player] = func_16(plParam0);
			HUD::SET_BLIP_PRIORITY(Global_2647287[player], Global_2647287.f_1504[player]);
		}
	}
...
int func_16(Player plParam0) // Position - 0x52B (1323)
{
	...
	if (_NETWORK_IS_PLAYER_VALID(plParam0, false, true))
	{
		if (HUD::DOES_BLIP_EXIST(Global_2647287[player]))
		{
			blipSprite = HUD::GET_BLIP_SPRITE(Global_2647287[player]);
		
			if (IS_BIT_SET(Global_2647287.f_386, player) || IS_BIT_SET(Global_2647287.f_385, player))
			{
				return 1;
			}
			else if (IS_BIT_SET(Global_2647287.f_371, player) || IS_BIT_SET(Global_2647287.f_370, player) || IS_BIT_SET(Global_2647287.f_388, player))
			{
				return func_79(10);
			}
			else
			{
				switch (blipSprite)
				{
					...
					case BLIP_PLAYERSTATE_DRIVING:
						if (PLAYER::GET_PLAYER_TEAM(plParam0) == PLAYER::GET_PLAYER_TEAM(Global_2673276))
							return func_79(6);
						else
							return func_79(5);
						break;
					...
					case BLIP_PASSIVE:
					case BLIP_USINGMENU:
						if (func_78(Global_2673276, plParam0, -2, 0))
							return func_79(6);
						else
							return func_79(5);
						break;
					...
					case BLIP_INCAPACITATED:
						if (func_21(Global_2673276, plParam0, true))
							return func_79(10);
						else
							return func_79(5);
						break;
					...
					case BLIP_LEVEL_INSIDE:
						if (func_20(plParam0) || func_19(plParam0) || func_17(plParam0))
							if (func_21(Global_2673276, plParam0, true))
								...
								return 4;
						else if (func_21(Global_2673276, plParam0, true))
							return func_79(6);
						else
							return func_79(5);
						break;
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658296[plParam0 /*468*/].f_325.f_8 != -1)
				return func_18(Global_2658296[plParam0 /*468*/].f_325.f_8) == 16;
...
BOOL func_19(Player plParam0) // Position - 0xD46 (3398)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658296[plParam0 /*468*/].f_325.f_8 != -1)
				return func_18(Global_2658296[plParam0 /*468*/].f_325.f_8) == 15;
...
BOOL func_20(Player plParam0) // Position - 0xD8D (3469)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658296[plParam0 /*468*/].f_325.f_8 != -1)
				return func_18(Global_2658296[plParam0 /*468*/].f_325.f_8) == 14;
					...
					if (_NETWORK_IS_PLAYER_VALID(NETWORK::NETWORK_GET_PLAYER_INDEX_FROM_PED(ped), false, true))
						if (iParam1 > -1 && NETWORK::NETWORK_IS_ACTIVITY_SESSION() && iParam1 < 4)
							if (Global_4718592.f_133684[iParam1] != -1)
								return func_71(iParam1, plParam0, false);
							else
...
BOOL func_32(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x16CC (5836)
{
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		if (!_NETWORK_IS_PLAYER_VALID(player, true, true) || func_34(player, 0) || IS_BIT_SET(Global_2658296[player /*468*/].f_203, 2) || func_33(player))
		{
		}
...
int func_43(Player plParam0, Player plParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x19A9 (6569)
{
	...
	if (!flag)
	{
		if (playerTeam != -1)
		{
			...
			if (func_78(plParam1, plParam0, playerTeam, 0) && !IS_BIT_SET(Global_4718592.f_16, 18) || func_31(PLAYER::GET_PLAYER_TEAM(plParam1), PLAYER::GET_PLAYER_TEAM(plParam0), 0, -1) && IS_BIT_SET(Global_4718592.f_16, 23) && !IS_BIT_SET(Global_4718592.f_16, 18))
				return func_23(true);
...
int func_47(Player plParam0) // Position - 0x1C32 (7218)
{
	if (func_11(plParam0))
		if (func_49(plParam0, true))
			return Global_2649164.f_818.f_11[func_48(plParam0)];
...
BOOL func_63(int iParam0) // Position - 0x204B (8267)
{
	int i;
...
BOOL func_65(int iParam0) // Position - 0x209A (8346)
{
	int i;
...
var func_69() // Position - 0x20FE (8446)
{
	return Global_2685155.f_19;
}

var func_70() // Position - 0x210C (8460)
{
	return Global_2685155.f_18;
}

int func_71(int iParam0, Player plParam1, BOOL bParam2) // Position - 0x211A (8474)
{
	int num;
	int num2;
	int num3;
...
int func_72(int iParam0) // Position - 0x229A (8858)
{
	int num;
...
BOOL func_76(Player plParam0) // Position - 0x23A5 (9125)
{
...
BOOL func_78(Player plParam0, Player plParam1, int iParam2, int iParam3) // Position - 0x23F2 (9202)
{
	if (iParam2 == -2)
	{
		if (iParam3 == 0)
...
BOOL func_83(var uParam0, var uParam1, int* piParam2, BOOL bParam3, Player plParam4, BOOL bParam5, var uParam6) // Position - 0x25A4 (9636)
{
	if (bParam5)
	{
...
BOOL func_91(var uParam0) // Position - 0x27A8 (10152)
{
...
int func_94(Player plParam0) // Position - 0x2A85 (10885)
{
	int num;
...
void func_96(Player plParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2ABC (10940)
{
	BOOL flag;
