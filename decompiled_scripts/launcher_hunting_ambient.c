#region Local Var
	...
	float fLocal_134 = 0f;
	BOOL bLocal_135 = 0;
	eCharacter echLocal_136 = CHAR_MICHAEL;
	int iLocal_137 = 0;
	int iLocal_138 = 0;
	Vehicle veLocal_139 = 0;
...
void main() // Position - 0x0 (0)
{
	...
	iLocal_112 = 0;
	func_93(&Global_113636, 0);
	func_90();

	if (func_89(iLocal_111, 1))
		iLocal_117 = 10;
	else
		iLocal_117 = 9;
	...
	if (func_89(iLocal_111, 8388608))
		func_95(true);

	if (func_89(iLocal_111, 524288) && func_85() && !func_84())
		func_95(true);

	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_89(iLocal_111, 4194304))
	{
		if (iLocal_122 != 263)
		{
			func_83(iLocal_122, true, false);
			iLocal_122 = 263;
		}
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(pedLocal_102) && !ENTITY::IS_ENTITY_DEAD(pedLocal_102, false))
		{
			...
			{
				case 0:
					if (_CAN_ENTER_FREEROAM_STATE(iLocal_117) || func_89(iLocal_111, 16) && !func_89(iLocal_111, 524288))
					{
						iLocal_115 = -1;
						func_81();
						func_82(1);
				...
				case 3:
					...
					{
						uLocal_86 = { uLocal_70 };
						flag3 = !func_89(iLocal_111, 64);
						func_93(&iLocal_111, 128);
					
						if (!func_75(3) && !Global_102545)
						{
							if (func_89(iLocal_111, 2097152))
							{
								if (!func_89(iLocal_111, 1) || !ENTITY::DOES_ENTITY_EXIST(func_74()) && !Global_102545)
								{
									func_82(10);
									break;
								}
						...
						if (!func_64(6) || Global_114037 || func_63())
							flag3 = false;
					
						if (!bLocal_135)
						{
							func_61(&iLocal_111, 128);
							flag3 = false;
						}
						...
						if (flag3)
						{
							...
							{
								if (clockHours < iLocal_137 && clockHours >= iLocal_138)
								{
									func_61(&iLocal_111, 128);
									flag3 = false;
									...
									{
										if (!func_89(iLocal_111, 134217728))
										{
											func_47("MG_NA_TIME" /*This activity is not available at this time of day. Come back between ~1~:00 and ~1~:00 to participate in this activity.*/, iLocal_137, iLocal_138);
											func_61(&iLocal_111, 134217728);
										}
									}
									else
									{
										func_93(&iLocal_111, 134217728);
									}
								}
							}
							else if (clockHours < iLocal_137 || clockHours >= iLocal_138)
							{
								func_61(&iLocal_111, 128);
								flag3 = false;
							...
							if (flag3)
							{
								...
								if (func_46(uLocal_103))
								{
									if (iLocal_113 == -1)
									{
										...
										func_61(&iLocal_111, 2048);
									}
									else if (!func_89(iLocal_111, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_44(&iLocal_113);
										func_93(&iLocal_111, 2048);
									}
								
									if (func_42(iLocal_113, true))
									{
				...
				case 5:
					...
					if (SCRIPT::HAS_SCRIPT_LOADED(&uLocal_86))
					{
						...
						if (num == 1)
						{
							...
							iLocal_69 = func_26();
							func_93(&iLocal_111, 4);
							func_25();
							func_61(&iLocal_111, 2);
							func_82(6);
							func_21(&uLocal_124);
				...
				case 6:
					if (!func_89(iLocal_111, 256))
						if (CAM::IS_SCREEN_FADING_OUT() || CAM::IS_SCREEN_FADED_IN())
							PAD::SET_INPUT_EXCLUSIVE(PLAYER_CONTROL, INPUT_CONTEXT);
						else if (CAM::IS_SCREEN_FADED_OUT())
							func_61(&iLocal_111, 256);
				
					if (func_89(Global_113636, 262144))
					{
						func_93(&Global_113636, 262144);
						func_15();
					}
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_69))
					{
						...
						else if (func_89(iLocal_111, 2))
						{
							if (func_89(Global_113636, 0))
							{
								func_6(&iLocal_115);
								iLocal_115 = -1;
								func_93(&iLocal_111, 2);
						...
						if (func_89(iLocal_111, 16777216))
							func_95(true);
				...
				case 7:
					...
					if (iLocal_122 != 263)
						func_83(iLocal_122, false, false);
					...
					if (iLocal_121 % 150 == 0)
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (iLocal_123 == 2)
							{
								if (iLocal_123 == 2)
								{
									if (_CAN_ENTER_FREEROAM_STATE(iLocal_117) && func_86(0, iLocal_116))
									{
										func_90();
...
void func_25() // Position - 0xFAC (4012)
{
	if (bLocal_142)
	{
		if (bLocal_143)
		{
			if (ENTITY::DOES_ENTITY_EXIST(veLocal_140))
				ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&veLocal_140);
...
int func_26() // Position - 0xFDC (4060)
{
	...
	args = -1;
	args.f_1 = veLocal_141;
	args.f_2 = veLocal_140;
	num = BUILTIN::START_NEW_SCRIPT_WITH_ARGS(&uLocal_70, &args, 3, essLocal_114);
...
void func_40() // Position - 0x14B6 (5302)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(veLocal_141) && !ENTITY::IS_ENTITY_DEAD(veLocal_141, false) && !FIRE::IS_ENTITY_ON_FIRE(veLocal_141))
	{
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(veLocal_141, 2);
		VEHICLE::SET_VEHICLE_UNDRIVEABLE(veLocal_141, true);
		VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(veLocal_141, false, 0);
		VEHICLE::SET_VEHICLE_DISABLE_TOWING(veLocal_141, true);
		veLocal_139 = veLocal_141;
	
		if (ENTITY::DOES_ENTITY_EXIST(veLocal_140) && !ENTITY::IS_ENTITY_DEAD(veLocal_140, false))
		{
			VEHICLE::SET_VEHICLE_UNDRIVEABLE(veLocal_140, true);
			VEHICLE::SET_VEHICLE_DISABLE_TOWING(veLocal_140, true);
			VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(veLocal_140, false, 0);
			VEHICLE::SET_VEHICLE_LIGHTS(veLocal_140, 1);
		}
	}
	else
	{
		if (ENTITY::DOES_ENTITY_EXIST(veLocal_141) && ENTITY::IS_ENTITY_DEAD(veLocal_141, false) || !ENTITY::DOES_ENTITY_EXIST(veLocal_141))
			func_41(0);
	
		if (ENTITY::DOES_ENTITY_EXIST(veLocal_140) && ENTITY::IS_ENTITY_DEAD(veLocal_140, false) || !ENTITY::DOES_ENTITY_EXIST(veLocal_140))
			func_41(0);
	
		if (bLocal_145 && STREAMING::HAS_ANIM_DICT_LOADED("oddjobs@hunterIntro") && STREAMING::HAS_ANIM_DICT_LOADED("oddjobs@hunterOutro"))
		{
	...
	else if (bLocal_145 && STREAMING::HAS_ANIM_DICT_LOADED("oddjobs@hunterIntro") && STREAMING::HAS_ANIM_DICT_LOADED("oddjobs@hunterOutro"))
	{
		STREAMING::REMOVE_ANIM_DICT("oddjobs@hunterIntro");
		STREAMING::REMOVE_ANIM_DICT("oddjobs@hunterOutro");
		bLocal_145 = false;
...
void func_49() // Position - 0x1946 (6470)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114990.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_50(character) && !func_77(14) || Global_113936)
			{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_71() || Global_114037 || Global_33835 || func_70() || func_56(8, -1) || func_69() || func_68() || func_67() || func_58() || Global_114990.f_7697.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_71() || Global_33835 || func_70() || func_56(8, -1) || func_67() || func_69() || func_68() || func_58() || Global_114990.f_7697.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_71() || Global_114037 || Global_33835 || func_70() || func_56(8, -1) || func_67() || func_69() || func_68() || func_58() || Global_114990.f_7697.f_919[character] == 5 || Global_45485 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_71() || Global_114037 || Global_33835 || func_70() || func_56(8, -1) || func_69() || func_68() || func_58() || Global_114990.f_7697.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_71() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_56(8, -1) || func_58() || func_66() || Global_114990.f_7697.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_71() || Global_33835 || func_70() || func_56(8, -1) || func_68() || func_67() || func_58() || Global_114990.f_7697.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_71() || func_68() || Global_114037 || Global_33835 || func_70() || Global_46164 || func_56(8, -1) || func_67() || func_66() || func_58() || Global_114990.f_7697.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_71() || Global_114037 || Global_33835 || func_70() || func_56(8, -1) || func_67() || func_66() || func_69() || func_68() || func_58())
							return false;
						break;
				}
			}
...
void func_79() // Position - 0x25B5 (9653)
{
	if (bLocal_142)
	{
		...
		if (!bLocal_144)
		{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(veLocal_140))
				veLocal_140 = VEHICLE::CREATE_VEHICLE(joaat("blazer"), -1707.4337f, 4666.5625f, 22.1095f, 323.2491f, true, true, false);
		
			if (!ENTITY::DOES_ENTITY_EXIST(veLocal_141))
			{
				veLocal_141 = VEHICLE::CREATE_VEHICLE(joaat("journey"), -1702.6951f, 4666.9414f, 22.7091f, 80.03f, true, true, false);
				VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(veLocal_141, true);
			}
...
{
	return func_88(iParam0, Global_44938);
}
...
{
	TEXT_LABEL_ASSIGN_STRING(&uLocal_70, "hunting_ambient", 64);
	iLocal_116 = 3;
	echLocal_136 = CHAR_TREVOR;
	sLocal_118 = "PLAY_HUNT" /*Press ~INPUT_CONTEXT~ to start hunting.*/;
	iLocal_137 = 5;
	iLocal_138 = 19;
	fLocal_134 = 2f;
	iLocal_122 = 69;
	fLocal_119 = BUILTIN::TO_FLOAT(func_92(iLocal_122)) + 5f;
...
void func_95(BOOL bParam0) // Position - 0x2BF9 (11257)
{
	if (bParam0)
		if (iLocal_122 != 263)
			func_83(iLocal_122, 0, false);

	func_44(&iLocal_113);

	if (func_89(iLocal_111, 2))
	{
		func_4();
		func_93(&iLocal_111, 2);
		func_6(&iLocal_115);
