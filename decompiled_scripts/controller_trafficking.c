...
int func_122() // Position - 0x87E7 (34791)
{
...
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false) || func_20(veParam0, 0, false) || func_20(veParam0, 1, false) || func_20(veParam0, 2, false) || func_9(veParam0) != 145 || func_161(veParam0) || func_160(veParam0) || func_159(veParam0) || func_158(veParam0) || !func_148(ENTITY::GET_ENTITY_MODEL(veParam0)))
	{
		func_160(veParam0);
		func_160(veParam0);
...
BOOL func_152(Hash hParam0, int iParam1) // Position - 0xAA88 (43656)
{
	int cloudTimeAsInt;
	int num;
	int i;
...
void func_164(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6) // Position - 0xC61C (50716)
{
	if (func_163(&Global_79152.f_555[0 /*21*/], iParam0))
	{
